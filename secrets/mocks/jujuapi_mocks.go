...
// Source: github.com/juju/juju/secrets (interfaces: JujuAPIClient,SecretsState)
//
// Generated by this command:
//
//	mockgen -package mocks -destination mocks/jujuapi_mocks.go github.com/juju/juju/secrets JujuAPIClient,SecretsState
//
