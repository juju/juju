...
func (s secretDeletionAPIClient) GetRevisionContentInfo(uri *secrets.URI, rev int, _ bool) (*ContentParams, *provider.ModelBackendConfig, bool, error) {
...
func (s secretDeletionAPIClient) GetContentInfo(*secrets.URI, string, bool, bool) (*ContentParams, *provider.ModelBackendConfig, bool, error) {
	return nil, nil, false, errors.NotSupportedf("GetContentInfo")
}

func (s secretDeletionAPIClient) GetSecretBackendConfig(*string) (*provider.ModelBackendConfigInfo, error) {
	return nil, errors.NotSupportedf("GetContentInfo")
}

func (s secretDeletionAPIClient) GetBackendConfigForDrain(*string) (*provider.ModelBackendConfig, string, error) {
	return nil, "", errors.NotSupportedf("GetBackendConfigForDrain")
}

func (c *deleteContentClient) GetRevisionContent(*secrets.URI, int) (secrets.SecretValue, error) {
	return nil, errors.NotSupportedf("GetRevisionContent")
}

func (c *deleteContentClient) GetBackend(*string, bool) (provider.SecretsBackend, string, error) {
