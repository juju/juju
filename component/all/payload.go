...
func (payloads) registerHookContextCommands() {
	...
	jujuc.RegisterCommand(context.RegisterCmdName, func(ctx hooks.Context) (cmd.Command, error) {
	...
	jujuc.RegisterCommand(context.StatusSetCmdName, func(ctx hooks.Context) (cmd.Command, error) {
		compCtx := payloadsHookContext{ctx}
	...
	jujuc.RegisterCommand(context.UnregisterCmdName, func(ctx hooks.Context) (cmd.Command, error) {
		compCtx := payloadsHookContext{ctx}
