...
// Source: github.com/juju/juju/core/charm (interfaces: StateCharm,State,StoreCharm,Store,VersionValidator)
...
// MockVersionValidator is a mock of VersionValidator interface
type MockVersionValidator struct {
	ctrl     *gomock.Controller
	recorder *MockVersionValidatorMockRecorder
}

// MockVersionValidatorMockRecorder is the mock recorder for MockVersionValidator
type MockVersionValidatorMockRecorder struct {
	mock *MockVersionValidator
}

// NewMockVersionValidator creates a new mock instance
func NewMockVersionValidator(ctrl *gomock.Controller) *MockVersionValidator {
	mock := &MockVersionValidator{ctrl: ctrl}
	mock.recorder = &MockVersionValidatorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockVersionValidator) EXPECT() *MockVersionValidatorMockRecorder {
	return m.recorder
}

// Validate mocks base method
func (m *MockVersionValidator) Validate(arg0 *charm.Meta) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Validate", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// Validate indicates an expected call of Validate
func (mr *MockVersionValidatorMockRecorder) Validate(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Validate", reflect.TypeOf((*MockVersionValidator)(nil).Validate), arg0)
}
