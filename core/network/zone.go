...
//
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination ../../provider/common/mocks/availability_zone.go github.com/juju/juju/core/network AvailabilityZone
