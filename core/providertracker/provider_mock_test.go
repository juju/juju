...
// Source: github.com/juju/juju/core/providertracker (interfaces: ProviderFactory,Provider,NonTrackedProvider)
//
// Generated by this command:
//
//	mockgen -typed -package providertracker -destination provider_mock_test.go github.com/juju/juju/core/providertracker ProviderFactory,Provider,NonTrackedProvider
//
...
func (m *MockProviderFactory) ProviderFromConfig(arg0 context.Context, arg1 NonTrackedProviderConfig) (NonTrackedProvider, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProviderFromConfig", arg0, arg1)
	ret0, _ := ret[0].(NonTrackedProvider)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Return rewrite *gomock.Call.Return
func (c *MockProviderFactoryProviderFromConfigCall) Return(arg0 NonTrackedProvider, arg1 error) *MockProviderFactoryProviderFromConfigCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockProviderFactoryProviderFromConfigCall) Do(f func(context.Context, NonTrackedProviderConfig) (NonTrackedProvider, error)) *MockProviderFactoryProviderFromConfigCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockProviderFactoryProviderFromConfigCall) DoAndReturn(f func(context.Context, NonTrackedProviderConfig) (NonTrackedProvider, error)) *MockProviderFactoryProviderFromConfigCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// MockNonTrackedProvider is a mock of NonTrackedProvider interface.
type MockNonTrackedProvider struct {
	ctrl     *gomock.Controller
	recorder *MockNonTrackedProviderMockRecorder
}

// MockNonTrackedProviderMockRecorder is the mock recorder for MockNonTrackedProvider.
type MockNonTrackedProviderMockRecorder struct {
	mock *MockNonTrackedProvider
}

// NewMockNonTrackedProvider creates a new mock instance.
func NewMockNonTrackedProvider(ctrl *gomock.Controller) *MockNonTrackedProvider {
	mock := &MockNonTrackedProvider{ctrl: ctrl}
	mock.recorder = &MockNonTrackedProviderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockNonTrackedProvider) EXPECT() *MockNonTrackedProviderMockRecorder {
	return m.recorder
}

// Kill mocks base method.
func (m *MockNonTrackedProvider) Kill() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Kill")
}

// Kill indicates an expected call of Kill.
func (mr *MockNonTrackedProviderMockRecorder) Kill() *MockNonTrackedProviderKillCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Kill", reflect.TypeOf((*MockNonTrackedProvider)(nil).Kill))
	return &MockNonTrackedProviderKillCall{Call: call}
}

// MockNonTrackedProviderKillCall wrap *gomock.Call
type MockNonTrackedProviderKillCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockNonTrackedProviderKillCall) Return() *MockNonTrackedProviderKillCall {
	c.Call = c.Call.Return()
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockNonTrackedProviderKillCall) Do(f func()) *MockNonTrackedProviderKillCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockNonTrackedProviderKillCall) DoAndReturn(f func()) *MockNonTrackedProviderKillCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Provider mocks base method.
func (m *MockNonTrackedProvider) Provider() (Provider, error) {
	m.ctrl.T.Helper()
...
func (mr *MockNonTrackedProviderMockRecorder) Provider() *MockNonTrackedProviderProviderCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Provider", reflect.TypeOf((*MockNonTrackedProvider)(nil).Provider))
	return &MockNonTrackedProviderProviderCall{Call: call}
}

// MockNonTrackedProviderProviderCall wrap *gomock.Call
type MockNonTrackedProviderProviderCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockNonTrackedProviderProviderCall) Return(arg0 Provider, arg1 error) *MockNonTrackedProviderProviderCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockNonTrackedProviderProviderCall) Do(f func() (Provider, error)) *MockNonTrackedProviderProviderCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockNonTrackedProviderProviderCall) DoAndReturn(f func() (Provider, error)) *MockNonTrackedProviderProviderCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
