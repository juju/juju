...
// NewRegistry returns a new Registry that uses the given clock and configurable
// options.
...
func (l *LogWatcher) Wait() error {
	...
	fmt.Printf("worker %T finished with error %v\n", l.worker, err)
	return errors.Trace(err)
}
