...
func (m *MockWatchableDB) Subscribe(arg0 string, arg1 ...changestream.SubscriptionOption) (changestream.Subscription, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0}
	for _, a := range arg1 {
...
func (mr *MockWatchableDBMockRecorder) Subscribe(arg0 any, arg1 ...any) *MockWatchableDBSubscribeCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{arg0}, arg1...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Subscribe", reflect.TypeOf((*MockWatchableDB)(nil).Subscribe), varargs...)
...
// Do rewrite *gomock.Call.Do
func (c *MockWatchableDBSubscribeCall) Do(f func(string, ...changestream.SubscriptionOption) (changestream.Subscription, error)) *MockWatchableDBSubscribeCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockWatchableDBSubscribeCall) DoAndReturn(f func(string, ...changestream.SubscriptionOption) (changestream.Subscription, error)) *MockWatchableDBSubscribeCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
