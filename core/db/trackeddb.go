...
// TrackedRawDB defines an interface for keeping track of a raw *sql.DB. This
// is useful knowing if the underlying DB can be reused after an error has
// occurred.
// This differs from a TrackedDB as it exposes the raw DB directly.
type TrackedRawDB interface {
