...
# Staff notice to be added to every autogenerated doc
STAFF_NOTICE = ("This doc was automatically generated from Juju code. Please "
"do not try to edit it - instead, report any problems by leaving a reply "
"below, and the Juju team will try to fix them as soon as possible.")
...
def sync():
    ...
    for root, dirs, files in os.walk(DOCS_DIR):
        ...
        for name in files:
            ...
            doc_name = removesuffix(fullname, ".md")
            filepath = os.path.join(DOCS_DIR, fullname)
