...
# install gometalinter from the source repo, as godep doesn't do this
# automatically and we force it to do so.
if [ ! -d "$GOPATH/src/github.com/alecthomas/gometalinter" ]; then
    (>&2 echo "Error: expected gometalinter repo to be in GOPATH.")
    exit 1
fi
