...
run_add_remove_credential() {
	...
	JUJU_DATA="${TEST_DIR}/juju" juju credentials aws --format=json | yq -r '."client-credentials"."aws"."cloud-credentials"."fake-credential-name"."details"."access-key"' | check "fake-access-key"
