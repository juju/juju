...
class TestEnvJujuClient(ClientTest):
    ...
    def test_full_args(self):
        ...
        self.assertEqual((
            'juju', '--show-log', 'bar', '-m', 'foo:foo', 'baz', 'qux'), full)
        client.env = None
        full = client._full_args('bar', False, ('baz', 'qux'))
    ...
    def test_full_args_debug(self):
        ...
        full = client._full_args('bar', False, ('baz', 'qux'))
        self.assertEqual((
            'juju', '--debug', 'bar', '-m', 'foo:foo', 'baz', 'qux'), full)
    ...
    def test_full_args_action(self):
        ...
        self.assertEqual(
            ('juju', '--show-log', 'action', 'bar', '-m', 'foo:foo',
             'baz', 'qux'),
            full)
    ...
    def test_juju_async_failure(self):
        ...
        self.assertEqual(err_cxt.exception.cmd, (
            'juju', '--show-log', 'foo', '-m', 'qux:qux', 'bar', 'baz'))
