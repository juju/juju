...
- `state/`: Business logic related to managing the Juju model.
- `apiserver/`: RPC facade implementations.
...
- Facades handle auth, wire encoding/decoding, and state calls.
- Where possible do not place business logic in facades.
