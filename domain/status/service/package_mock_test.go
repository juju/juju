...
func (m *MockModelState) ImportRelationStatus(ctx context.Context, relationID int, sts status.StatusInfo[status.RelationStatusType]) error {
	m.ctrl.T.Helper()
...
func (mr *MockModelStateMockRecorder) ImportRelationStatus(ctx, relationID, sts any) *MockModelStateImportRelationStatusCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ImportRelationStatus", reflect.TypeOf((*MockModelState)(nil).ImportRelationStatus), ctx, relationID, sts)
...
// Do rewrite *gomock.Call.Do
func (c *MockModelStateImportRelationStatusCall) Do(f func(context.Context, int, status.StatusInfo[status.RelationStatusType]) error) *MockModelStateImportRelationStatusCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelStateImportRelationStatusCall) DoAndReturn(f func(context.Context, int, status.StatusInfo[status.RelationStatusType]) error) *MockModelStateImportRelationStatusCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
