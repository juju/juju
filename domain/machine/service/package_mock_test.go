...
func (m *MockState) SetRunningAgentBinaryVersion(arg0 context.Context, arg1 machine.Name, arg2 agentbinary.Version) error {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockStateSetRunningAgentBinaryVersionCall) Do(f func(context.Context, machine.Name, agentbinary.Version) error) *MockStateSetRunningAgentBinaryVersionCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateSetRunningAgentBinaryVersionCall) DoAndReturn(f func(context.Context, machine.Name, agentbinary.Version) error) *MockStateSetRunningAgentBinaryVersionCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
