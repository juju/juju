...
// GetUserAuthorizedKeysQueryForModel mocks base method.
func (m *MockControllerState) GetUserAuthorizedKeysQueryForModel(arg0 model.UUID) string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserAuthorizedKeysQueryForModel", arg0)
	ret0, _ := ret[0].(string)
	return ret0
}

// GetUserAuthorizedKeysQueryForModel indicates an expected call of GetUserAuthorizedKeysQueryForModel.
func (mr *MockControllerStateMockRecorder) GetUserAuthorizedKeysQueryForModel(arg0 any) *MockControllerStateGetUserAuthorizedKeysQueryForModelCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserAuthorizedKeysQueryForModel", reflect.TypeOf((*MockControllerState)(nil).GetUserAuthorizedKeysQueryForModel), arg0)
	return &MockControllerStateGetUserAuthorizedKeysQueryForModelCall{Call: call}
}

// MockControllerStateGetUserAuthorizedKeysQueryForModelCall wrap *gomock.Call
type MockControllerStateGetUserAuthorizedKeysQueryForModelCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockControllerStateGetUserAuthorizedKeysQueryForModelCall) Return(arg0 string) *MockControllerStateGetUserAuthorizedKeysQueryForModelCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockControllerStateGetUserAuthorizedKeysQueryForModelCall) Do(f func(model.UUID) string) *MockControllerStateGetUserAuthorizedKeysQueryForModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockControllerStateGetUserAuthorizedKeysQueryForModelCall) DoAndReturn(f func(model.UUID) string) *MockControllerStateGetUserAuthorizedKeysQueryForModelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
