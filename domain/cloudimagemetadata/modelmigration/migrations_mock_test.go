...
// Source: github.com/juju/juju/domain/cloudimagemetadata/modelmigration (interfaces: Coordinator,ImportService,ExportService)
//
// Generated by this command:
//
//	mockgen -typed -package modelmigration -destination migrations_mock_test.go github.com/juju/juju/domain/cloudimagemetadata/modelmigration Coordinator,ImportService,ExportService
//
...
// MockExportServiceAllCloudImageMetadataCall wrap *gomock.Call
type MockExportServiceAllCloudImageMetadataCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockExportServiceAllCloudImageMetadataCall) Return(arg0 []cloudimagemetadata.Metadata, arg1 error) *MockExportServiceAllCloudImageMetadataCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockExportServiceAllCloudImageMetadataCall) Do(f func(context.Context) ([]cloudimagemetadata.Metadata, error)) *MockExportServiceAllCloudImageMetadataCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockExportServiceAllCloudImageMetadataCall) DoAndReturn(f func(context.Context) ([]cloudimagemetadata.Metadata, error)) *MockExportServiceAllCloudImageMetadataCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
