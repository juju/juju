...
const (
	...
	// does not have it's agent version set.
	...
	// are missing for a given entity that runs agent binaries with in the
	// model. For example units and machines. When agent binaries are missing it
