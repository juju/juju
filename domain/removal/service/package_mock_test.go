...
func (m *MockModelDBState) EnsureApplicationNotAliveCascade(arg0 context.Context, arg1 string) (removal.ApplicationArtifacts, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockModelDBStateEnsureApplicationNotAliveCascadeCall) Do(f func(context.Context, string) (removal.ApplicationArtifacts, error)) *MockModelDBStateEnsureApplicationNotAliveCascadeCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelDBStateEnsureApplicationNotAliveCascadeCall) DoAndReturn(f func(context.Context, string) (removal.ApplicationArtifacts, error)) *MockModelDBStateEnsureApplicationNotAliveCascadeCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockModelDBState) EnsureUnitNotAliveCascade(arg0 context.Context, arg1 string) (internal.CascadedUnitLives, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockModelDBStateEnsureUnitNotAliveCascadeCall) Do(f func(context.Context, string) (internal.CascadedUnitLives, error)) *MockModelDBStateEnsureUnitNotAliveCascadeCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelDBStateEnsureUnitNotAliveCascadeCall) DoAndReturn(f func(context.Context, string) (internal.CascadedUnitLives, error)) *MockModelDBStateEnsureUnitNotAliveCascadeCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
