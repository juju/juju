...
//go:generate go run github.com/canonical/gomock/mockgen -package service -destination service_mock_test.go github.com/juju/juju/domain/provisioner/service ModelState,ControllerState,ImageMetadataFetcher,CompletionState
