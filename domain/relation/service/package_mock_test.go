...
// MockMigrationStateImportPeerRelationCall wrap *gomock.Call
type MockMigrationStateImportPeerRelationCall struct {
	*gomock.Call
}
...
func (m *MockState) SetRelationUnitSettings(arg0 context.Context, arg1 relation.UnitUUID, arg2 map[string]string, arg3 []string) error {
	m.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) SetRelationUnitSettings(arg0, arg1, arg2, arg3 any) *MockStateSetRelationUnitSettingsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetRelationUnitSettings", reflect.TypeOf((*MockState)(nil).SetRelationUnitSettings), arg0, arg1, arg2, arg3)
...
// Do rewrite *gomock.Call.Do
func (c *MockStateSetRelationUnitSettingsCall) Do(f func(context.Context, relation.UnitUUID, map[string]string, []string) error) *MockStateSetRelationUnitSettingsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateSetRelationUnitSettingsCall) DoAndReturn(f func(context.Context, relation.UnitUUID, map[string]string, []string) error) *MockStateSetRelationUnitSettingsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
