...
func (m *MockState) AddRelation(arg0 context.Context, arg1, arg2 relation0.EndpointIdentifier) (relation0.Endpoint, relation0.Endpoint, error) {
	m.ctrl.T.Helper()
...
func (c *MockStateAddRelationCall) Do(f func(context.Context, relation0.EndpointIdentifier, relation0.EndpointIdentifier) (relation0.Endpoint, relation0.Endpoint, error)) *MockStateAddRelationCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateAddRelationCall) DoAndReturn(f func(context.Context, relation0.EndpointIdentifier, relation0.EndpointIdentifier) (relation0.Endpoint, relation0.Endpoint, error)) *MockStateAddRelationCall {
