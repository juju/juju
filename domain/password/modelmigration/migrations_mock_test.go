...
// Source: github.com/juju/juju/domain/password/modelmigration (interfaces: ExportService,ImportService)
//
// Generated by this command:
//
//	mockgen -typed -package modelmigration -destination migrations_mock_test.go github.com/juju/juju/domain/password/modelmigration ExportService,ImportService
//
...
func (m *MockImportService) SetUnitPasswordHash(arg0 context.Context, arg1 unit.Name, arg2 password.PasswordHash) error {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockImportServiceSetUnitPasswordHashCall) Do(f func(context.Context, unit.Name, password.PasswordHash) error) *MockImportServiceSetUnitPasswordHashCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockImportServiceSetUnitPasswordHashCall) DoAndReturn(f func(context.Context, unit.Name, password.PasswordHash) error) *MockImportServiceSetUnitPasswordHashCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
