...
//
//	mockgen -typed -package service -destination internal_storage_mock_test.go -mock_names Provider=MockStorageProvider github.com/juju/juju/internal/storage ProviderRegistry,Provider
//
