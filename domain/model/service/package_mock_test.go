...
// Source: github.com/juju/juju/domain/model/service (interfaces: CloudInfoProvider,ControllerState,EnvironVersionProvider,ModelDeleter,ModelState,ModelResourcesProvider,RegionProvider,State,StorageProviderRegistryGetter,WatcherFactory)
//
// Generated by this command:
//
//	mockgen -typed -package service -destination package_mock_test.go github.com/juju/juju/domain/model/service CloudInfoProvider,ControllerState,EnvironVersionProvider,ModelDeleter,ModelState,ModelResourcesProvider,RegionProvider,State,StorageProviderRegistryGetter,WatcherFactory
//
...
func NewMockStorageProviderRegistryGetter(ctrl *gomock.Controller) *MockStorageProviderRegistryGetter {
	...
	mock.recorder = &MockStorageProviderRegistryGetterMockRecorder{mock}
	return mock
}
...
func (mr *MockStorageProviderRegistryGetterMockRecorder) GetStorageRegistry(arg0 any) *MockStorageProviderRegistryGetterGetStorageRegistryCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStorageRegistry", reflect.TypeOf((*MockStorageProviderRegistryGetter)(nil).GetStorageRegistry), arg0)
	return &MockStorageProviderRegistryGetterGetStorageRegistryCall{Call: call}
}

// MockStorageProviderRegistryGetterGetStorageRegistryCall wrap *gomock.Call
type MockStorageProviderRegistryGetterGetStorageRegistryCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockStorageProviderRegistryGetterGetStorageRegistryCall) Return(arg0 storage.ProviderRegistry, arg1 error) *MockStorageProviderRegistryGetterGetStorageRegistryCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStorageProviderRegistryGetterGetStorageRegistryCall) Do(f func(context.Context) (storage.ProviderRegistry, error)) *MockStorageProviderRegistryGetterGetStorageRegistryCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStorageProviderRegistryGetterGetStorageRegistryCall) DoAndReturn(f func(context.Context) (storage.ProviderRegistry, error)) *MockStorageProviderRegistryGetterGetStorageRegistryCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
