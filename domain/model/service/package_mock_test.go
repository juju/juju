...
// Source: github.com/juju/juju/domain/model/service (interfaces: ControllerState,EnvironVersionProvider,ModelDeleter,ModelState,State,ResourceCreationProvider,WatcherFactoryGetter,WatcherFactory)
//
// Generated by this command:
//
//	mockgen -typed -package service -destination package_mock_test.go github.com/juju/juju/domain/model/service ControllerState,EnvironVersionProvider,ModelDeleter,ModelState,State,ResourceCreationProvider,WatcherFactoryGetter,WatcherFactory
//
...
// MockResourceCreationProvider is a mock of ResourceCreationProvider interface.
...
type MockResourceCreationProviderMockRecorder struct {
	mock *MockResourceCreationProvider
}

// NewMockResourceCreationProvider creates a new mock instance.
func NewMockResourceCreationProvider(ctrl *gomock.Controller) *MockResourceCreationProvider {
	mock := &MockResourceCreationProvider{ctrl: ctrl}
	mock.recorder = &MockResourceCreationProviderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockResourceCreationProvider) EXPECT() *MockResourceCreationProviderMockRecorder {
	return m.recorder
}
...
// Create indicates an expected call of Create.
func (mr *MockResourceCreationProviderMockRecorder) Create(arg0, arg1 any) *MockResourceCreationProviderCreateCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockResourceCreationProvider)(nil).Create), arg0, arg1)
	return &MockResourceCreationProviderCreateCall{Call: call}
}

// MockResourceCreationProviderCreateCall wrap *gomock.Call
type MockResourceCreationProviderCreateCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockResourceCreationProviderCreateCall) Return(arg0 error) *MockResourceCreationProviderCreateCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockResourceCreationProviderCreateCall) Do(f func(envcontext.ProviderCallContext, environs.CreateParams) error) *MockResourceCreationProviderCreateCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockResourceCreationProviderCreateCall) DoAndReturn(f func(envcontext.ProviderCallContext, environs.CreateParams) error) *MockResourceCreationProviderCreateCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// MockWatcherFactoryGetter is a mock of WatcherFactoryGetter interface.
...
type MockWatcherFactoryGetterMockRecorder struct {
	mock *MockWatcherFactoryGetter
}

// NewMockWatcherFactoryGetter creates a new mock instance.
func NewMockWatcherFactoryGetter(ctrl *gomock.Controller) *MockWatcherFactoryGetter {
	mock := &MockWatcherFactoryGetter{ctrl: ctrl}
	mock.recorder = &MockWatcherFactoryGetterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockWatcherFactoryGetter) EXPECT() *MockWatcherFactoryGetterMockRecorder {
	return m.recorder
}

// GetWatcherFactory mocks base method.
func (m *MockWatcherFactoryGetter) GetWatcherFactory() WatcherFactory {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWatcherFactory")
	ret0, _ := ret[0].(WatcherFactory)
	return ret0
}

// GetWatcherFactory indicates an expected call of GetWatcherFactory.
func (mr *MockWatcherFactoryGetterMockRecorder) GetWatcherFactory() *MockWatcherFactoryGetterGetWatcherFactoryCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWatcherFactory", reflect.TypeOf((*MockWatcherFactoryGetter)(nil).GetWatcherFactory))
	return &MockWatcherFactoryGetterGetWatcherFactoryCall{Call: call}
}

// MockWatcherFactoryGetterGetWatcherFactoryCall wrap *gomock.Call
type MockWatcherFactoryGetterGetWatcherFactoryCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockWatcherFactoryGetterGetWatcherFactoryCall) Return(arg0 WatcherFactory) *MockWatcherFactoryGetterGetWatcherFactoryCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockWatcherFactoryGetterGetWatcherFactoryCall) Do(f func() WatcherFactory) *MockWatcherFactoryGetterGetWatcherFactoryCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockWatcherFactoryGetterGetWatcherFactoryCall) DoAndReturn(f func() WatcherFactory) *MockWatcherFactoryGetterGetWatcherFactoryCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
