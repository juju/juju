...
func (s *serviceSuite) TestCreateModelInvalidArgs(c *gc.C) {
	...
	_, _, err := svc.CreateModel(context.Background(), model.ControllerDBModelCreationArgs{})
...
func (s *serviceSuite) TestModelCreation(c *gc.C) {
	...
	svc := NewService(s.state, s.deleter, DefaultAgentBinaryFinder(), loggertesting.WrapCheckLog(c))
	id, activator, err := svc.CreateModel(context.Background(), model.ControllerDBModelCreationArgs{
		Cloud:       "aws",
...
func (s *serviceSuite) TestModelCreationNameOwnerConflict(c *gc.C) {
	...
	svc := NewService(s.state, s.deleter, DefaultAgentBinaryFinder(), loggertesting.WrapCheckLog(c))
	_, activator, err := svc.CreateModel(context.Background(), model.ControllerDBModelCreationArgs{
		Cloud:       "aws",
		CloudRegion: "myregion",
		Owner:       s.userUUID,
		Name:        "my-awesome-model",
...
func (s *serviceSuite) TestAgentVersionUnsupportedGreater(c *gc.C) {
	...
	svc := NewService(s.state, s.deleter, DefaultAgentBinaryFinder(), loggertesting.WrapCheckLog(c))
	id, _, err := svc.CreateModel(context.Background(), model.ControllerDBModelCreationArgs{
...
func (s *serviceSuite) TestListAllModels(c *gc.C) {
	...
	svc := NewService(s.state, s.deleter, DefaultAgentBinaryFinder(), loggertesting.WrapCheckLog(c))
	id1, activator, err := svc.CreateModel(context.Background(), model.ControllerDBModelCreationArgs{
	...
	id2, activator, err := svc.CreateModel(context.Background(), model.ControllerDBModelCreationArgs{
		AgentVersion: jujuversion.Current,
		Cloud:        "aws",
		CloudRegion:  "myregion",
		Credential:   cred,
...
func (s *serviceSuite) TestImportModelWithMissingAgentVersion(c *gc.C) {
	...
	_, err := svc.ImportModel(context.Background(), model.ModelImportArgs{
		ControllerDBModelCreationArgs: model.ControllerDBModelCreationArgs{
			Cloud:       "aws",
			CloudRegion: "myregion",
			Credential:  cred,
			Owner:       s.userUUID,
...
func (s *serviceSuite) TestControllerModel(c *gc.C) {
	...
	svc := NewService(s.state, s.deleter, DefaultAgentBinaryFinder(), loggertesting.WrapCheckLog(c))
	modelID, activator, err := svc.CreateModel(context.Background(), model.ControllerDBModelCreationArgs{
		AgentVersion: jujuversion.Current,
		Cloud:        "aws",
		CloudRegion:  "myregion",
		Credential:   cred,
