...
type State interface {
	...
	DeleteSecretBackend(ctx context.Context, _ secretbackend.BackendIdentifier, force bool) error
	ListSecretBackends(ctx context.Context, all bool) ([]*secretbackend.SecretBackend, error)
