...
// Source: github.com/juju/juju/domain/secretbackend (interfaces: WatcherFactory)
//
// Generated by this command:
//
//	mockgen -package state -destination watcherfactory_mock_test.go github.com/juju/juju/domain/secretbackend WatcherFactory
//
