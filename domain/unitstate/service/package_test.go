...
//go:generate go run github.com/canonical/gomock/mockgen -package service -destination secretbackend_mock_test.go github.com/juju/juju/domain/unitstate/service SecretBackendReferenceMutator
