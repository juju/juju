...
func (m *MockState) Add(arg0 context.Context, arg1 agentbinary.AddAgentBinaryArg) error {
	m.ctrl.T.Helper()
...
func (c *MockStateAddCall) Do(f func(context.Context, agentbinary.AddAgentBinaryArg) error) *MockStateAddCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateAddCall) DoAndReturn(f func(context.Context, agentbinary.AddAgentBinaryArg) error) *MockStateAddCall {
