...
//go:generate go run go.uber.org/mock/mockgen -typed -package service -destination agentobjectstore_mock_test.go github.com/juju/juju/domain/agentbinary/service AgentBinaryStoreState
