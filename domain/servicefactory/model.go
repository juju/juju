...
func (s *ModelFactory) Secret(
	adminConfigGetter secretservice.BackendAdminConfigGetter,
	userSecretConfigGetter secretservice.BackendUserSecretConfigGetter,
) *secretservice.WatchableService {
	...
	return secretservice.NewWatchableService(
		...
		adminConfigGetter, userSecretConfigGetter,
	)
}
