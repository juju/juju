...
func (s *watcherSuite) createApplicationWithCharm(c *gc.C, svc *service.Service, name string, charm internalcharm.Charm, units ...service.AddUnitArg) coreapplication.ID {
	ctx := context.Background()
