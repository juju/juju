...
// Source: github.com/juju/juju/domain/application/service (interfaces: CharmStore,LeadershipState)
//
// Generated by this command:
//
//	mockgen -typed -package service -destination service_mock_test.go github.com/juju/juju/domain/application/service CharmStore,LeadershipState
//
...
// MockLeadershipState is a mock of LeadershipState interface.
type MockLeadershipState struct {
	ctrl     *gomock.Controller
	recorder *MockLeadershipStateMockRecorder
}

// MockLeadershipStateMockRecorder is the mock recorder for MockLeadershipState.
type MockLeadershipStateMockRecorder struct {
	mock *MockLeadershipState
}

// NewMockLeadershipState creates a new mock instance.
func NewMockLeadershipState(ctrl *gomock.Controller) *MockLeadershipState {
	mock := &MockLeadershipState{ctrl: ctrl}
	mock.recorder = &MockLeadershipStateMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockLeadershipState) EXPECT() *MockLeadershipStateMockRecorder {
	return m.recorder
}
