...
func (s *WatchableService) WatchUnitInsertDeleteOnMachine(ctx context.Context, machineName machine.Name) (watcher.StringsWatcher, error) {
	...
	return s.watcherFactory.NewNamespaceMapperWatcher(
		...
		func(ctx context.Context, changes []changestream.ChangeEvent) ([]changestream.ChangeEvent, error) {
			...
			for _, change := range changes {
				...
				// panic(fmt.Sprintf("net node uuid: %q; err: %v", netNodeUUID, err))
