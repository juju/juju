...
func makeResourcesArgs(solvedResources ResolvedResources) ([]application.AddApplicationResourceArg, error) {
	var result []application.AddApplicationResourceArg
	if err := solvedResources.Validate(); err != nil {
		return result, err
	}
	for _, res := range solvedResources {
