...
type ApplicationState interface {
	...
	// UpsertCAASUnit creates or updates the specified CAAS unit, returning an error
	// satisfying [applicationerrors.ApplicationNotFoundError] if the application doesn't exist.
	UpsertCAASUnit(context.Context, string, application.StateTxOperationFunc) error
...
func (s *ApplicationService) RegisterCAASUnit(ctx context.Context, appName string, args RegisterCAASUnitParams) error {
	...
	err := s.st.UpsertCAASUnit(ctx, appName, func(ctx context.Context, stateOps application.StateTxOperations, appID coreapplication.ID) error {
