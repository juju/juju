...
// UpsertCAASUnit mocks base method.
func (m *MockApplicationState) UpsertCAASUnit(arg0 context.Context, arg1 string, arg2 application0.StateTxOperationFunc) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpsertCAASUnit", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpsertCAASUnit indicates an expected call of UpsertCAASUnit.
func (mr *MockApplicationStateMockRecorder) UpsertCAASUnit(arg0, arg1, arg2 any) *MockApplicationStateUpsertCAASUnitCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpsertCAASUnit", reflect.TypeOf((*MockApplicationState)(nil).UpsertCAASUnit), arg0, arg1, arg2)
	return &MockApplicationStateUpsertCAASUnitCall{Call: call}
}

// MockApplicationStateUpsertCAASUnitCall wrap *gomock.Call
type MockApplicationStateUpsertCAASUnitCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockApplicationStateUpsertCAASUnitCall) Return(arg0 error) *MockApplicationStateUpsertCAASUnitCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockApplicationStateUpsertCAASUnitCall) Do(f func(context.Context, string, application0.StateTxOperationFunc) error) *MockApplicationStateUpsertCAASUnitCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockApplicationStateUpsertCAASUnitCall) DoAndReturn(f func(context.Context, string, application0.StateTxOperationFunc) error) *MockApplicationStateUpsertCAASUnitCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
