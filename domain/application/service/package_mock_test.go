...
func (m *MockApplicationState) GetSecretsForOwners(arg0 domain.AtomicContext, arg1 secret.ApplicationOwners, arg2 secret.UnitOwners) ([]*secrets.URI, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockApplicationStateGetSecretsForOwnersCall) Do(f func(domain.AtomicContext, secret.ApplicationOwners, secret.UnitOwners) ([]*secrets.URI, error)) *MockApplicationStateGetSecretsForOwnersCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockApplicationStateGetSecretsForOwnersCall) DoAndReturn(f func(domain.AtomicContext, secret.ApplicationOwners, secret.UnitOwners) ([]*secrets.URI, error)) *MockApplicationStateGetSecretsForOwnersCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockDeleteSecretState) DeleteSecret(arg0 domain.AtomicContext, arg1 *secrets.URI, arg2 []int) ([]string, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockDeleteSecretStateDeleteSecretCall) Return(arg0 []string, arg1 error) *MockDeleteSecretStateDeleteSecretCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockDeleteSecretStateDeleteSecretCall) Do(f func(domain.AtomicContext, *secrets.URI, []int) ([]string, error)) *MockDeleteSecretStateDeleteSecretCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockDeleteSecretStateDeleteSecretCall) DoAndReturn(f func(domain.AtomicContext, *secrets.URI, []int) ([]string, error)) *MockDeleteSecretStateDeleteSecretCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// ListExternalSecretRevisions mocks base method.
func (m *MockDeleteSecretState) ListExternalSecretRevisions(arg0 domain.AtomicContext, arg1 *secrets.URI, arg2 ...int) ([]secrets.ValueRef, error) {
	m.ctrl.T.Helper()
	varargs := []any{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (mr *MockDeleteSecretStateMockRecorder) ListExternalSecretRevisions(arg0, arg1 any, arg2 ...any) *MockDeleteSecretStateListExternalSecretRevisionsCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{arg0, arg1}, arg2...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListExternalSecretRevisions", reflect.TypeOf((*MockDeleteSecretState)(nil).ListExternalSecretRevisions), varargs...)
	return &MockDeleteSecretStateListExternalSecretRevisionsCall{Call: call}
}

// MockDeleteSecretStateListExternalSecretRevisionsCall wrap *gomock.Call
type MockDeleteSecretStateListExternalSecretRevisionsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockDeleteSecretStateListExternalSecretRevisionsCall) Return(arg0 []secrets.ValueRef, arg1 error) *MockDeleteSecretStateListExternalSecretRevisionsCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockDeleteSecretStateListExternalSecretRevisionsCall) Do(f func(domain.AtomicContext, *secrets.URI, ...int) ([]secrets.ValueRef, error)) *MockDeleteSecretStateListExternalSecretRevisionsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockDeleteSecretStateListExternalSecretRevisionsCall) DoAndReturn(f func(domain.AtomicContext, *secrets.URI, ...int) ([]secrets.ValueRef, error)) *MockDeleteSecretStateListExternalSecretRevisionsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
