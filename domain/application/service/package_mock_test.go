...
func (m *MockState) GetUnitNetNodesByName(ctx context.Context, name unit.Name) ([]network.NetNodeUUID, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockStateGetUnitNetNodesByNameCall) Return(arg0 []network.NetNodeUUID, arg1 error) *MockStateGetUnitNetNodesByNameCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStateGetUnitNetNodesByNameCall) Do(f func(context.Context, unit.Name) ([]network.NetNodeUUID, error)) *MockStateGetUnitNetNodesByNameCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateGetUnitNetNodesByNameCall) DoAndReturn(f func(context.Context, unit.Name) ([]network.NetNodeUUID, error)) *MockStateGetUnitNetNodesByNameCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
