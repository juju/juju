...
// CheckProviderTypeSupportsCharmStorage mocks base method.
func (m *MockStorageProviderValidator) CheckProviderTypeSupportsCharmStorage(arg0 context.Context, arg1 string, arg2 charm.StorageType) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckProviderTypeSupportsCharmStorage", arg0, arg1, arg2)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CheckProviderTypeSupportsCharmStorage indicates an expected call of CheckProviderTypeSupportsCharmStorage.
func (mr *MockStorageProviderValidatorMockRecorder) CheckProviderTypeSupportsCharmStorage(arg0, arg1, arg2 any) *MockStorageProviderValidatorCheckProviderTypeSupportsCharmStorageCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckProviderTypeSupportsCharmStorage", reflect.TypeOf((*MockStorageProviderValidator)(nil).CheckProviderTypeSupportsCharmStorage), arg0, arg1, arg2)
	return &MockStorageProviderValidatorCheckProviderTypeSupportsCharmStorageCall{Call: call}
}

// MockStorageProviderValidatorCheckProviderTypeSupportsCharmStorageCall wrap *gomock.Call
type MockStorageProviderValidatorCheckProviderTypeSupportsCharmStorageCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockStorageProviderValidatorCheckProviderTypeSupportsCharmStorageCall) Return(arg0 bool, arg1 error) *MockStorageProviderValidatorCheckProviderTypeSupportsCharmStorageCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStorageProviderValidatorCheckProviderTypeSupportsCharmStorageCall) Do(f func(context.Context, string, charm.StorageType) (bool, error)) *MockStorageProviderValidatorCheckProviderTypeSupportsCharmStorageCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStorageProviderValidatorCheckProviderTypeSupportsCharmStorageCall) DoAndReturn(f func(context.Context, string, charm.StorageType) (bool, error)) *MockStorageProviderValidatorCheckProviderTypeSupportsCharmStorageCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
