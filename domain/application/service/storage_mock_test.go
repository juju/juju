...
func (m *MockStorageService) GetApplicationStorageInfo(arg0 context.Context, arg1 application.UUID) (application0.ApplicationStorage, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockStorageServiceGetApplicationStorageInfoCall) Return(arg0 application0.ApplicationStorage, arg1 error) *MockStorageServiceGetApplicationStorageInfoCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStorageServiceGetApplicationStorageInfoCall) Do(f func(context.Context, application.UUID) (application0.ApplicationStorage, error)) *MockStorageServiceGetApplicationStorageInfoCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStorageServiceGetApplicationStorageInfoCall) DoAndReturn(f func(context.Context, application.UUID) (application0.ApplicationStorage, error)) *MockStorageServiceGetApplicationStorageInfoCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
