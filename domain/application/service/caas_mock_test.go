...
func (m *MockApplication) EnsurePVCs(arg0 []storage.KubernetesFilesystemParams, arg1 map[string][]storage.KubernetesFilesystemUnitAttachmentParams, arg2 []storage.KubernetesFilesystemAttachment, arg3 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnsurePVCs", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(error)
	return ret0
}

// EnsurePVCs indicates an expected call of EnsurePVCs.
func (mr *MockApplicationMockRecorder) EnsurePVCs(arg0, arg1, arg2, arg3 any) *MockApplicationEnsurePVCsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnsurePVCs", reflect.TypeOf((*MockApplication)(nil).EnsurePVCs), arg0, arg1, arg2, arg3)
...
// Do rewrite *gomock.Call.Do
func (c *MockApplicationEnsurePVCsCall) Do(f func([]storage.KubernetesFilesystemParams, map[string][]storage.KubernetesFilesystemUnitAttachmentParams, []storage.KubernetesFilesystemAttachment, string) error) *MockApplicationEnsurePVCsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockApplicationEnsurePVCsCall) DoAndReturn(f func([]storage.KubernetesFilesystemParams, map[string][]storage.KubernetesFilesystemUnitAttachmentParams, []storage.KubernetesFilesystemAttachment, string) error) *MockApplicationEnsurePVCsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
