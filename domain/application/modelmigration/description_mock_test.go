...
// Source: github.com/juju/description/v8 (interfaces: CharmMetadata,CharmMetadataRelation,CharmMetadataStorage,CharmMetadataDevice,CharmMetadataPayload,CharmMetadataResource,CharmMetadataContainer,CharmMetadataContainerMount,CharmManifest,CharmManifestBase,CharmActions,CharmAction,CharmConfigs,CharmConfig)
//
// Generated by this command:
//
//	mockgen -typed -package modelmigration -destination description_mock_test.go github.com/juju/description/v8 CharmMetadata,CharmMetadataRelation,CharmMetadataStorage,CharmMetadataDevice,CharmMetadataPayload,CharmMetadataResource,CharmMetadataContainer,CharmMetadataContainerMount,CharmManifest,CharmManifestBase,CharmActions,CharmAction,CharmConfigs,CharmConfig
//
...
// MockCharmMetadataPayload is a mock of CharmMetadataPayload interface.
type MockCharmMetadataPayload struct {
	ctrl     *gomock.Controller
	recorder *MockCharmMetadataPayloadMockRecorder
}

// MockCharmMetadataPayloadMockRecorder is the mock recorder for MockCharmMetadataPayload.
type MockCharmMetadataPayloadMockRecorder struct {
	mock *MockCharmMetadataPayload
}

// NewMockCharmMetadataPayload creates a new mock instance.
func NewMockCharmMetadataPayload(ctrl *gomock.Controller) *MockCharmMetadataPayload {
	mock := &MockCharmMetadataPayload{ctrl: ctrl}
	mock.recorder = &MockCharmMetadataPayloadMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCharmMetadataPayload) EXPECT() *MockCharmMetadataPayloadMockRecorder {
	return m.recorder
}

// Name mocks base method.
func (m *MockCharmMetadataPayload) Name() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Name")
	ret0, _ := ret[0].(string)
	return ret0
...
// Name indicates an expected call of Name.
func (mr *MockCharmMetadataPayloadMockRecorder) Name() *MockCharmMetadataPayloadNameCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Name", reflect.TypeOf((*MockCharmMetadataPayload)(nil).Name))
	return &MockCharmMetadataPayloadNameCall{Call: call}
}

// MockCharmMetadataPayloadNameCall wrap *gomock.Call
type MockCharmMetadataPayloadNameCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockCharmMetadataPayloadNameCall) Return(arg0 string) *MockCharmMetadataPayloadNameCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockCharmMetadataPayloadNameCall) Do(f func() string) *MockCharmMetadataPayloadNameCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockCharmMetadataPayloadNameCall) DoAndReturn(f func() string) *MockCharmMetadataPayloadNameCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Type mocks base method.
func (m *MockCharmMetadataPayload) Type() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Type")
	ret0, _ := ret[0].(string)
	return ret0
...
// Type indicates an expected call of Type.
func (mr *MockCharmMetadataPayloadMockRecorder) Type() *MockCharmMetadataPayloadTypeCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Type", reflect.TypeOf((*MockCharmMetadataPayload)(nil).Type))
	return &MockCharmMetadataPayloadTypeCall{Call: call}
}

// MockCharmMetadataPayloadTypeCall wrap *gomock.Call
type MockCharmMetadataPayloadTypeCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockCharmMetadataPayloadTypeCall) Return(arg0 string) *MockCharmMetadataPayloadTypeCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockCharmMetadataPayloadTypeCall) Do(f func() string) *MockCharmMetadataPayloadTypeCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockCharmMetadataPayloadTypeCall) DoAndReturn(f func() string) *MockCharmMetadataPayloadTypeCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
