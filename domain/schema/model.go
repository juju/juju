...
//go:generate go run ./../../generate/triggergen -db=model -destination=./model/triggers/relation-triggers.gen.go -package=triggers -tables=relation_application_setting,relation_unit,relation_endpoint
...
func ModelDDL() *schema.Schema {
	...
	patches = append(patches,
		...
		triggers.ChangeLogTriggersForRelationApplicationSetting("relation_endpoint_uuid",
			tableRelationApplicationSetting),
		triggers.ChangeLogTriggersForRelationEndpoint("uuid", tableRelationEndpoint),
