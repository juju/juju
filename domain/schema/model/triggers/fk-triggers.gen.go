...
CREATE TRIGGER trg_fk_debug_agent_version_0
...
CREATE TRIGGER trg_fk_debug_annotation_charm_0
...
CREATE TRIGGER trg_fk_debug_annotation_unit_0
...
CREATE TRIGGER trg_fk_debug_application_2
...
CREATE TRIGGER trg_fk_debug_application_agent_1
...
CREATE TRIGGER trg_fk_debug_application_config_0
...
CREATE TRIGGER trg_fk_debug_application_config_hash_0
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_constraint_0
...
CREATE TRIGGER trg_fk_debug_application_constraint_1
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_controller_0
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_endpoint_2
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_exposed_endpoint_cidr_0
...
CREATE TRIGGER trg_fk_debug_application_exposed_endpoint_cidr_1
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_exposed_endpoint_space_0
BEFORE DELETE ON 'space' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_exposed_endpoint_space_1
BEFORE DELETE ON 'application_endpoint' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_exposed_endpoint_space_2
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_extra_endpoint_1
BEFORE DELETE ON 'space' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_platform_1
...
CREATE TRIGGER trg_fk_debug_application_platform_2
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
-- fk debug delete trigger for application for fk ref from application_remote_consumer
CREATE TRIGGER trg_fk_debug_application_remote_consumer_1
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_remote_offerer_0
BEFORE DELETE ON 'life' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_remote_relation_0
BEFORE DELETE ON 'relation' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_resource_0
...
CREATE TRIGGER trg_fk_debug_application_resource_1
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_scale_0
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_setting_0
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_application_storage_directive_1
...
CREATE TRIGGER trg_fk_debug_application_storage_directive_2
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_block_command_0
...
CREATE TRIGGER trg_fk_debug_block_device_0
...
CREATE TRIGGER trg_fk_debug_block_device_link_device_0
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_block_device_link_device_1
...
CREATE TRIGGER trg_fk_debug_charm_1
BEFORE DELETE ON 'architecture' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_action_0
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_category_0
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_container_0
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
                        RAISE(FAIL, 'Foreign Key violation during DELETE FROM charm_container due to referencing rows in charm_container_mount ON charm_uuid charm_container_key')
                    ELSE
                        NULL
                    END panic
        FROM 'charm_container_mount'
...
CREATE TRIGGER trg_fk_debug_charm_device_0
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_download_info_0
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_extra_binding_0
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_manifest_base_0
BEFORE DELETE ON 'architecture' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_manifest_base_1
BEFORE DELETE ON 'os' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_metadata_0
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_relation_0
...
CREATE TRIGGER trg_fk_debug_charm_relation_1
...
CREATE TRIGGER trg_fk_debug_charm_relation_2
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_storage_0
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_storage_1
...
CREATE TRIGGER trg_fk_debug_charm_storage_property_0
BEFORE DELETE ON 'charm_storage' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
                        RAISE(FAIL, 'Foreign Key violation during DELETE FROM charm_storage due to referencing rows in charm_storage_property ON charm_uuid charm_storage_name')
                    ELSE
                        NULL
                    END panic
        FROM 'charm_storage_property'
        WHERE charm_uuid=OLD.charm_uuid AND charm_storage_name=OLD.name;
END;

-- fk debug delete trigger for charm for fk ref from charm_storage_property
CREATE TRIGGER trg_fk_debug_charm_storage_property_1
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_tag_0
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_charm_term_0
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_constraint_0
...
CREATE TRIGGER trg_fk_debug_constraint_tag_0
BEFORE DELETE ON 'constraint' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_constraint_zone_0
BEFORE DELETE ON 'constraint' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_device_constraint_0
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_device_constraint_attribute_0
...
CREATE TRIGGER trg_fk_debug_fqdn_address_0
...
CREATE TRIGGER trg_fk_debug_hostname_address_0
BEFORE DELETE ON 'network_address_scope' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_instance_tag_0
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_ip_address_1
...
CREATE TRIGGER trg_fk_debug_ip_address_6
...
CREATE TRIGGER trg_fk_debug_k8s_pod_0
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_k8s_pod_port_0
...
CREATE TRIGGER trg_fk_debug_k8s_service_0
BEFORE DELETE ON 'net_node' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_link_layer_device_0
...
CREATE TRIGGER trg_fk_debug_link_layer_device_2
BEFORE DELETE ON 'net_node' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_link_layer_device_dns_address_0
BEFORE DELETE ON 'link_layer_device' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_link_layer_device_dns_domain_0
BEFORE DELETE ON 'link_layer_device' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_link_layer_device_route_0
BEFORE DELETE ON 'link_layer_device' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_1
BEFORE DELETE ON 'life' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_2
BEFORE DELETE ON 'net_node' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_agent_version_0
BEFORE DELETE ON 'architecture' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_cloud_instance_0
BEFORE DELETE ON 'availability_zone' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_cloud_instance_status_0
...
CREATE TRIGGER trg_fk_debug_machine_constraint_0
BEFORE DELETE ON 'constraint' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_constraint_1
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_container_type_0
BEFORE DELETE ON 'container_type' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_container_type_1
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_filesystem_0
...
CREATE TRIGGER trg_fk_debug_machine_filesystem_1
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_lxd_profile_0
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_manual_0
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_placement_1
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_platform_1
BEFORE DELETE ON 'os' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_platform_2
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_requires_reboot_0
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_ssh_host_key_0
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_status_0
...
CREATE TRIGGER trg_fk_debug_machine_status_1
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_machine_volume_0
...
CREATE TRIGGER trg_fk_debug_machine_volume_1
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_model_constraint_0
BEFORE DELETE ON 'constraint' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_model_constraint_1
BEFORE DELETE ON 'model' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_model_life_0
BEFORE DELETE ON 'life' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_model_life_1
BEFORE DELETE ON 'model' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_net_node_fqdn_address_0
...
CREATE TRIGGER trg_fk_debug_net_node_fqdn_address_1
BEFORE DELETE ON 'net_node' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_net_node_hostname_address_0
...
CREATE TRIGGER trg_fk_debug_net_node_hostname_address_1
BEFORE DELETE ON 'net_node' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_offer_connection_0
...
CREATE TRIGGER trg_fk_debug_offer_connection_1
...
CREATE TRIGGER trg_fk_debug_offer_endpoint_0
BEFORE DELETE ON 'offer' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_offer_endpoint_1
BEFORE DELETE ON 'application_endpoint' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
                        RAISE(FAIL, 'Foreign Key violation during DELETE FROM charm_action due to referencing rows in operation_action ON charm_uuid charm_action_key')
                    ELSE
                        NULL
                    END panic
        FROM 'operation_action'
...
CREATE TRIGGER trg_fk_debug_operation_machine_task_0
BEFORE DELETE ON 'machine' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_operation_machine_task_1
...
CREATE TRIGGER trg_fk_debug_operation_parameter_0
BEFORE DELETE ON 'operation' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_operation_task_0
BEFORE DELETE ON 'operation' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_operation_task_log_0
BEFORE DELETE ON 'operation_task' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_operation_task_status_0
...
CREATE TRIGGER trg_fk_debug_operation_task_status_1
BEFORE DELETE ON 'operation_task' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_port_range_0
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_port_range_1
BEFORE DELETE ON 'charm_relation' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_provider_ip_address_0
...
CREATE TRIGGER trg_fk_debug_provider_link_layer_device_0
BEFORE DELETE ON 'link_layer_device' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_provider_network_subnet_0
BEFORE DELETE ON 'subnet' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_provider_network_subnet_1
...
CREATE TRIGGER trg_fk_debug_provider_space_0
BEFORE DELETE ON 'space' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_provider_subnet_0
BEFORE DELETE ON 'subnet' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_relation_0
BEFORE DELETE ON 'charm_relation_scope' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_relation_1
BEFORE DELETE ON 'life' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_relation_application_setting_0
...
CREATE TRIGGER trg_fk_debug_relation_application_settings_hash_0
BEFORE DELETE ON 'relation_endpoint' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_relation_endpoint_0
BEFORE DELETE ON 'application_endpoint' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_relation_endpoint_1
BEFORE DELETE ON 'relation' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_relation_status_0
...
CREATE TRIGGER trg_fk_debug_relation_status_1
BEFORE DELETE ON 'relation' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_relation_unit_setting_0
...
CREATE TRIGGER trg_fk_debug_relation_unit_setting_archive_0
BEFORE DELETE ON 'relation' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_relation_unit_settings_hash_0
BEFORE DELETE ON 'relation_unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_removal_0
...
CREATE TRIGGER trg_fk_debug_resource_1
...
CREATE TRIGGER trg_fk_debug_resource_file_store_0
BEFORE DELETE ON 'object_store_metadata' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_resource_image_store_0
...
CREATE TRIGGER trg_fk_debug_resource_image_store_1
BEFORE DELETE ON 'resource' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_resource_retrieved_by_0
...
CREATE TRIGGER trg_fk_debug_resource_retrieved_by_1
BEFORE DELETE ON 'resource' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_secret_content_0
...
CREATE TRIGGER trg_fk_debug_secret_metadata_0
...
CREATE TRIGGER trg_fk_debug_secret_metadata_1
...
CREATE TRIGGER trg_fk_debug_secret_model_owner_0
BEFORE DELETE ON 'secret_metadata' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_secret_permission_2
...
CREATE TRIGGER trg_fk_debug_secret_permission_3
BEFORE DELETE ON 'secret_metadata' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_secret_reference_0
BEFORE DELETE ON 'secret' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_secret_remote_unit_consumer_0
BEFORE DELETE ON 'secret_metadata' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_secret_revision_0
BEFORE DELETE ON 'secret_metadata' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_secret_revision_expire_0
BEFORE DELETE ON 'secret_revision' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_secret_revision_obsolete_0
BEFORE DELETE ON 'secret_revision' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_secret_rotation_0
BEFORE DELETE ON 'secret_metadata' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_secret_unit_owner_0
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_secret_unit_owner_1
BEFORE DELETE ON 'secret_metadata' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_secret_value_ref_0
BEFORE DELETE ON 'secret_revision' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_attachment_0
BEFORE DELETE ON 'life' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_attachment_1
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_attachment_2
...
CREATE TRIGGER trg_fk_debug_storage_filesystem_0
...
CREATE TRIGGER trg_fk_debug_storage_filesystem_1
BEFORE DELETE ON 'life' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_filesystem_attachment_0
BEFORE DELETE ON 'storage_provision_scope' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_filesystem_attachment_2
BEFORE DELETE ON 'net_node' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_filesystem_status_0
...
CREATE TRIGGER trg_fk_debug_storage_instance_1
BEFORE DELETE ON 'life' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_instance_filesystem_0
BEFORE DELETE ON 'storage_filesystem' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_instance_filesystem_1
BEFORE DELETE ON 'storage_instance' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_instance_volume_0
BEFORE DELETE ON 'storage_volume' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_instance_volume_1
BEFORE DELETE ON 'storage_instance' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_pool_0
...
CREATE TRIGGER trg_fk_debug_storage_pool_attribute_0
BEFORE DELETE ON 'storage_pool' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_unit_owner_0
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_unit_owner_1
BEFORE DELETE ON 'storage_instance' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_volume_attachment_0
BEFORE DELETE ON 'storage_provision_scope' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_volume_attachment_1
BEFORE DELETE ON 'block_device' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_volume_attachment_2
BEFORE DELETE ON 'life' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_volume_attachment_plan_0
BEFORE DELETE ON 'storage_provision_scope' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_volume_attachment_plan_2
BEFORE DELETE ON 'life' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_storage_volume_attachment_plan_attr_0
...
CREATE TRIGGER trg_fk_debug_subnet_0
BEFORE DELETE ON 'space' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_1
BEFORE DELETE ON 'charm' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_3
BEFORE DELETE ON 'application' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_4
BEFORE DELETE ON 'life' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_agent_status_0
...
CREATE TRIGGER trg_fk_debug_unit_agent_version_0
BEFORE DELETE ON 'architecture' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_agent_version_1
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_principal_0
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
-- fk debug delete trigger for unit for fk ref from unit_principal
CREATE TRIGGER trg_fk_debug_unit_principal_1
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_resolved_0
...
CREATE TRIGGER trg_fk_debug_unit_resolved_1
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_state_0
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_state_charm_0
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_state_relation_0
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_storage_directive_1
BEFORE DELETE ON 'storage_pool' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_workload_status_0
BEFORE DELETE ON 'workload_status_value' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_workload_status_1
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
...
CREATE TRIGGER trg_fk_debug_unit_workload_version_0
BEFORE DELETE ON 'unit' FOR EACH ROW
BEGIN
        SELECT CASE WHEN COUNT(*) > 0 AND (SELECT * FROM pragma_foreign_keys)
                    THEN
