...
END;
-- controller-model removal needs to be handled differently to
...
-- new job types for user secret removal
INSERT INTO removal_type VALUES (16, 'user secret');
INSERT INTO removal_type VALUES (17, 'obsolete user secret revisions');
