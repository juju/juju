...
CREATE UNIQUE INDEX idx_object_store_metadata_hash_384 ON object_store_metadata (hash_384);
CREATE UNIQUE INDEX idx_object_store_metadata_hash ON object_store_metadata (hash_256, hash_384);
