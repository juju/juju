...
CREATE TABLE relation (
    ...
    life_id INT,
    provides_endpoint_uuid TEXT NOT NULL,
    requires_endpoint_uuid TEXT NOT NULL,
    relation_id INT,
    CONSTRAINT fk_relation_life
    FOREIGN KEY (life_id)
    REFERENCES life (id),
    CONSTRAINT fk_provides_uuid
    FOREIGN KEY (provides_endpoint_uuid)
    REFERENCES application_endpoint (uuid),
    CONSTRAINT fk_requires_uuid
    FOREIGN KEY (requires_endpoint_uuid)
    REFERENCES application_endpoint (uuid)
);
