...
func (m *MockState) PutContainerImageMetadata(arg0 context.Context, arg1, arg2, arg3, arg4 string) (resource.ResourceStorageUUID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PutContainerImageMetadata", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(resource.ResourceStorageUUID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Return rewrite *gomock.Call.Return
func (c *MockStatePutContainerImageMetadataCall) Return(arg0 resource.ResourceStorageUUID, arg1 error) *MockStatePutContainerImageMetadataCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStatePutContainerImageMetadataCall) Do(f func(context.Context, string, string, string, string) (resource.ResourceStorageUUID, error)) *MockStatePutContainerImageMetadataCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStatePutContainerImageMetadataCall) DoAndReturn(f func(context.Context, string, string, string, string) (resource.ResourceStorageUUID, error)) *MockStatePutContainerImageMetadataCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
