...
// Source: ./domain/modelmigration/service (interfaces: InstanceProvider,ResourceProvider,ControllerState,ModelState,WatcherFactory,CredentialValidator)
//
// Generated by this command:
//
//	mockgen -package service -destination domain/modelmigration/service/service_mock_test.go ./domain/modelmigration/service InstanceProvider,ResourceProvider,ControllerState,ModelState,WatcherFactory,CredentialValidator
//
...
type MockCredentialValidatorMockRecorder struct {
	...
	validateExpects []*gomock.Call3_1[context.Context, string, modelmigration.ModelCloudCredential, error]
}
...
func (m *MockCredentialValidator) Validate(ctx context.Context, modelUUID string, credential modelmigration.ModelCloudCredential) error {
	m.ctrl.T.Helper()
	return gomock.Dispatch3_1(&m.recorder.validateExpects, m.ctrl, m, "Validate", ctx, modelUUID, credential)
}

// Validate indicates an expected call of Validate.
func (mr *MockCredentialValidatorMockRecorder) Validate(ctx, modelUUID, credential any) *MockCredentialValidatorValidateCall {
	mr.mock.ctrl.T.Helper()
	call := gomock.NewCall3_1[context.Context, string, modelmigration.ModelCloudCredential, error](mr.mock.ctrl.T, mr.mock, "Validate", gomock.EnsureMatcher(ctx), gomock.EnsureMatcher(modelUUID), gomock.EnsureMatcher(credential))
...
type MockCredentialValidatorValidateCall = gomock.Call3_1[context.Context, string, modelmigration.ModelCloudCredential, error]
