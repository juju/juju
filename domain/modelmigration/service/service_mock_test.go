...
//
//	mockgen -package service -destination domain/modelmigration/service/service_mock_test.go github.com/juju/juju/domain/modelmigration/service InstanceProvider,ResourceProvider,ControllerState,ModelState,WatcherFactory
//
