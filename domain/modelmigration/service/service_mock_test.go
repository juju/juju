...
// Source: github.com/juju/juju/domain/modelmigration/service (interfaces: InstanceProvider,ResourceProvider,ControllerState,ModelState,WatcherFactory,ModelDBDeleter)
//
// Generated by this command:
//
//	mockgen -package service -destination service_mock_test.go github.com/juju/juju/domain/modelmigration/service InstanceProvider,ResourceProvider,ControllerState,ModelState,WatcherFactory,ModelDBDeleter
//
...
// MockModelDBDeleter is a mock of ModelDBDeleter interface.
type MockModelDBDeleter struct {
	ctrl     *gomock.Controller
	recorder *MockModelDBDeleterMockRecorder
	isgomock struct{}
}

// MockModelDBDeleterMockRecorder is the mock recorder for MockModelDBDeleter.
type MockModelDBDeleterMockRecorder struct {
	mock                 *MockModelDBDeleter
	deleteModelDBExpects []*gomock.Call2_1[context.Context, string, error]
}

// NewMockModelDBDeleter creates a new mock instance.
func NewMockModelDBDeleter(ctrl *gomock.Controller) *MockModelDBDeleter {
	mock := &MockModelDBDeleter{ctrl: ctrl}
	mock.recorder = &MockModelDBDeleterMockRecorder{mock: mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockModelDBDeleter) EXPECT() *MockModelDBDeleterMockRecorder {
	return m.recorder
}

// DeleteModelDB mocks base method.
func (m *MockModelDBDeleter) DeleteModelDB(ctx context.Context, modelUUID string) error {
	m.ctrl.T.Helper()
	return gomock.Dispatch2_1(&m.recorder.deleteModelDBExpects, m.ctrl, m, "DeleteModelDB", ctx, modelUUID)
}

// DeleteModelDB indicates an expected call of DeleteModelDB.
func (mr *MockModelDBDeleterMockRecorder) DeleteModelDB(ctx, modelUUID any) *MockModelDBDeleterDeleteModelDBCall {
	mr.mock.ctrl.T.Helper()
	call := gomock.NewCall2_1[context.Context, string, error](mr.mock.ctrl.T, mr.mock, "DeleteModelDB", gomock.EnsureMatcher(ctx), gomock.EnsureMatcher(modelUUID))
	mr.deleteModelDBExpects = append(mr.deleteModelDBExpects, call)
	mr.mock.ctrl.Track(call.Call)
	return call
}

// MockModelDBDeleterDeleteModelDBCall is the typed call wrapper for DeleteModelDB.
type MockModelDBDeleterDeleteModelDBCall = gomock.Call2_1[context.Context, string, error]
