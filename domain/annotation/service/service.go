...
type State interface {
	// GetAnnotations retrieves all the annotations associated with a given ID. If no annotations
	...
	// exists for the given ID, then it will be updated with the given value. First all annotations
	// are deleted, then the given pairs are inserted, so unsetting an annotation is implicit.
...
// GetAnnotations retrieves all the annotations associated with a given ID. If no annotations are
...
// SetAnnotations associates key/value annotation pairs with a given ID. If annotation already
// exists for the given ID, then it will be updated with the given value.
