...
//
//	mockgen -package modelmigration -destination migrations_mock_test.go github.com/juju/juju/domain/storage/modelmigration Coordinator,ImportService,ExportService
//
...
func (mr *MockImportServiceMockRecorder) CreateStoragePool(arg0, arg1, arg2, arg3 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateStoragePool", reflect.TypeOf((*MockImportService)(nil).CreateStoragePool), arg0, arg1, arg2, arg3)
}
