...
//
//	mockgen -typed -package service -destination internal_storage_mock_test.go github.com/juju/juju/internal/storage ProviderRegistry,Provider,VolumeSource,VolumeImporter,FilesystemSource,FilesystemImporter,FilesystemModelMigration
//
...
func NewMockFilesystemModelMigration(ctrl *gomock.Controller) *MockFilesystemModelMigration {
	...
	mock.recorder = &MockFilesystemModelMigrationMockRecorder{mock}
	return mock
}
...
func (m *MockFilesystemModelMigration) GetPersistentVolumeClaimIdentifiers(arg0 context.Context) ([]storage.PersistentVolumeClaimIdentifiers, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPersistentVolumeClaimIdentifiers", arg0)
	ret0, _ := ret[0].([]storage.PersistentVolumeClaimIdentifiers)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetPersistentVolumeClaimIdentifiers indicates an expected call of GetPersistentVolumeClaimIdentifiers.
func (mr *MockFilesystemModelMigrationMockRecorder) GetPersistentVolumeClaimIdentifiers(arg0 any) *MockFilesystemModelMigrationGetPersistentVolumeClaimIdentifiersCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPersistentVolumeClaimIdentifiers", reflect.TypeOf((*MockFilesystemModelMigration)(nil).GetPersistentVolumeClaimIdentifiers), arg0)
	return &MockFilesystemModelMigrationGetPersistentVolumeClaimIdentifiersCall{Call: call}
}

// MockFilesystemModelMigrationGetPersistentVolumeClaimIdentifiersCall wrap *gomock.Call
type MockFilesystemModelMigrationGetPersistentVolumeClaimIdentifiersCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockFilesystemModelMigrationGetPersistentVolumeClaimIdentifiersCall) Return(arg0 []storage.PersistentVolumeClaimIdentifiers, arg1 error) *MockFilesystemModelMigrationGetPersistentVolumeClaimIdentifiersCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockFilesystemModelMigrationGetPersistentVolumeClaimIdentifiersCall) Do(f func(context.Context) ([]storage.PersistentVolumeClaimIdentifiers, error)) *MockFilesystemModelMigrationGetPersistentVolumeClaimIdentifiersCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockFilesystemModelMigrationGetPersistentVolumeClaimIdentifiersCall) DoAndReturn(f func(context.Context) ([]storage.PersistentVolumeClaimIdentifiers, error)) *MockFilesystemModelMigrationGetPersistentVolumeClaimIdentifiersCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
