...
func (s *importSuite) TestIAASImportStorageInstancesVolumeBackedFilesystems(c *tc.C) {
	...
	c.Check(
		...
		domainstorageprovisioning.FilesystemParams{
			...
			ID:         "fs-data-0",
			Provider:   "ebs",
			ProviderID: new("provider-fs-data-0"),
			SizeMiB:    uint64(1024),
			BackingVolume: &domainstorageprovisioning.FilesystemBackingVolume{
				VolumeID: "0",
			},
	...
	c.Check(
		...
		domainstorageprovisioning.FilesystemParams{
			...
			ID:         "fs-cache-1",
			Provider:   "ebs",
			ProviderID: new("provider-fs-cache-1"),
			SizeMiB:    uint64(2048),
			BackingVolume: &domainstorageprovisioning.FilesystemBackingVolume{
				VolumeID: "1",
			},
...
func (s *importSuite) TestIAASImportStorageInstancesNonVolumeBackedFilesystems(c *tc.C) {
	// Arrange
	...
	c.Check(
		...
		domainstorageprovisioning.FilesystemParams{
			...
			ID:            "fs-logs-0",
			Provider:      "ebs",
			ProviderID:    new("provider-fs-logs-0"),
			SizeMiB:       uint64(1024),
			BackingVolume: nil,
		},
	)
	...
	c.Check(
		...
		domainstorageprovisioning.FilesystemParams{
			...
			ID:            "fs-scratch-1",
			Provider:      "ebs",
			ProviderID:    new("provider-fs-scratch-1"),
			SizeMiB:       uint64(2048),
			BackingVolume: nil,
		},
	)
...
func (s *importSuite) TestIAASImportStorageInstancesVolumesOnly(c *tc.C) {
	// Arrange
