...
const (
	...
	// StorageInstanceNotAlive describes an error that occurs when the storage
	// instance being operated on is not alive.
	StorageInstanceNotAlive = errors.ConstError("storage instance not alive")
