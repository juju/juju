...
// FilesystemUUID represents the unique id for a storage Filesystem instance.
type FilesystemUUID baseUUID
...
// String returns the string representation of this Filesystem uuid. This function
