...
`
	...
	return makeStorageInstanceInfoFromDBData(
		siInfo, attachments, attachmentBlockDeviceLinks,
	), nil
}
...
// makeStorageInstanceInfoFromDBData is responsible for taking the returned
// database data from [state.GetStorageInstanceInfo] and constructing a
// [internal.StorageInstanceInfo] result.
//
// This function is only designed to work with the data returned from
// [state.GetStorageInstanceInfo] and expects that attachments and
// attachmentBlockDeviceLinks have been ordered by Storage Attachment UUID.
func makeStorageInstanceInfoFromDBData(
	siInfo storageInstanceInfo,
	attachments []storageInstanceInfoAttachment,
	attachmentBlockDeviceLinks []storageInstanceInfoAttachmentBlockDeviceLink,
