...
func (s *stateSuite) TestSetModelPassword(c *tc.C) {
	st := NewState(s.TxnRunnerFactory())
	s.createModel(c)
...
// matched.
func (s *stateSuite) TestMatchesModelPasswordHash(c *tc.C) {
	st := NewState(s.TxnRunnerFactory())
	s.createModel(c)
...
// error.
func (s *stateSuite) TestMatchesModelPasswordHashNotSet(c *tc.C) {
	st := NewState(s.TxnRunnerFactory())
...
func (s *stateSuite) TestMatchesModelPasswordHashInvalidPassword(c *tc.C) {
	st := NewState(s.TxnRunnerFactory())
	s.createModel(c)
...
// model_agent table.
func (s *stateSuite) createModel(c *tc.C) {
