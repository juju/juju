...
//
//	mockgen -typed -package modelmigration -destination migrations_mock_test.go github.com/juju/juju/domain/externalcontroller/modelmigration Coordinator,ImportService
//
