...
type State interface {
	...
	AddExecOperation(ctx context.Context, operationUUID internaluuid.UUID, target operation.ReceiversWithoutLeader, args operation.ExecArgs) (operation.RunResult, error)
