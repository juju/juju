...
//
//	mockgen -typed -package service -destination service_mock_test.go github.com/juju/juju/domain/operation/service State,LeadershipService
//
...
func (m *MockState) GetPaginatedTaskLogsByUUID(arg0 context.Context, arg1 string, arg2 int) ([]internal.TaskLogMessage, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPaginatedTaskLogsByUUID", arg0, arg1, arg2)
...
func (mr *MockStateMockRecorder) GetPaginatedTaskLogsByUUID(arg0, arg1, arg2 any) *MockStateGetPaginatedTaskLogsByUUIDCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPaginatedTaskLogsByUUID", reflect.TypeOf((*MockState)(nil).GetPaginatedTaskLogsByUUID), arg0, arg1, arg2)
