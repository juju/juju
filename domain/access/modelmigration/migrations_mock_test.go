...
//
//	mockgen -typed -package modelmigration -destination migrations_mock_test.go github.com/juju/juju/domain/access/modelmigration Coordinator,ImportExternalUsersService,ImportOfferAccessService,ImportService
//
...
func NewMockImportExternalUsersService(ctrl *gomock.Controller) *MockImportExternalUsersService {
	...
	mock.recorder = &MockImportExternalUsersServiceMockRecorder{mock}
	return mock
}
...
func (m *MockImportExternalUsersService) ImportExternalUsers(arg0 context.Context, arg1 []internal.ExternalUserImport) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ImportExternalUsers", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// ImportExternalUsers indicates an expected call of ImportExternalUsers.
func (mr *MockImportExternalUsersServiceMockRecorder) ImportExternalUsers(arg0, arg1 any) *MockImportExternalUsersServiceImportExternalUsersCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ImportExternalUsers", reflect.TypeOf((*MockImportExternalUsersService)(nil).ImportExternalUsers), arg0, arg1)
	return &MockImportExternalUsersServiceImportExternalUsersCall{Call: call}
}

// MockImportExternalUsersServiceImportExternalUsersCall wrap *gomock.Call
type MockImportExternalUsersServiceImportExternalUsersCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockImportExternalUsersServiceImportExternalUsersCall) Return(arg0 error) *MockImportExternalUsersServiceImportExternalUsersCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockImportExternalUsersServiceImportExternalUsersCall) Do(f func(context.Context, []internal.ExternalUserImport) error) *MockImportExternalUsersServiceImportExternalUsersCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockImportExternalUsersServiceImportExternalUsersCall) DoAndReturn(f func(context.Context, []internal.ExternalUserImport) error) *MockImportExternalUsersServiceImportExternalUsersCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
