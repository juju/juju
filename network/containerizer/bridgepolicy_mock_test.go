...
// Source: github.com/juju/juju/network/containerizer (interfaces: Container,Unit,Application,Address,Subnet,LinkLayerDevice)
...
func (m *MockContainer) SetParentLinkLayerDevicesBeforeTheirChildren(arg0 state.LinkLayerDevicesArgs) error {
	m.ctrl.T.Helper()
