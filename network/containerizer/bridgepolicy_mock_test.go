...
// Source: github.com/juju/juju/network/containerizer (interfaces: Container,Unit,Application)
...
func (m *MockContainer) LinkLayerDevicesForSpaces(arg0 []string) (map[string][]LinkLayerDevice, error) {
