...
// ""<scope>:<address-value>@<space-name>(id:<space-provider-id>)""; for
// example:
//
//	public:c2-54-226-162-124.compute-1.amazonaws.com@public-api
//
// If the scope is ScopeUnknown, the initial scope: prefix will be omitted. If
// the SpaceName is empty the last '@space' part will be omitted as well.
