...
//
//	mockgen -package charmhub -destination client_mock_test.go github.com/juju/juju/charmhub Transport,RESTClient,FileSystem,Logger
//
...
func (mr *MockTransportMockRecorder) Do(arg0 any) *gomock.Call {
