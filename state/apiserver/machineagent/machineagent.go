...
// The machineagent package implements the API calls used specifically
// by the machine agent code.
...
// NewAPI returns an object implementing the machine agent API
// for the given 
...
func (api *API) GetMachines(args params.Machines) (params.MachineAgentGetMachinesResults, error) {
...
func (api *API) getMachine(id string) (result params.MachineAgentGetMachinesResult, err error) {
