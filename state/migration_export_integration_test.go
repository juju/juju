...
type MigrationIntegrationBaseSuite struct {
	ConnWithWallClockSuite
}

func (s *MigrationIntegrationBaseSuite) setLatestTools(c *gc.C, latestTools version.Number) {
	err := s.Model.UpdateLatestToolsVersion(latestTools)
	c.Assert(err, jc.ErrorIsNil)
}

func (s *MigrationIntegrationBaseSuite) setRandSequenceValue(c *gc.C, name string) int {
	var value int
	var err error
	count := rand.Intn(5) + 1
	for i := 0; i < count; i++ {
...
func (s *MigrationIntegrationBaseSuite) primeStatusHistory(c *gc.C, entity statusSetter, statusVal status.Status, count int) {
	primeStatusHistory(c, entity, statusVal, count, func(i int) map[string]interface{} {
		return map[string]interface{}{"index": count - i}
	}, 0, "")
}

func (s *MigrationIntegrationBaseSuite) makeApplicationWithUnits(c *gc.C, applicationname string, count int) {
...
func (s *MigrationIntegrationBaseSuite) makeUnitApplicationLeader(c *gc.C, unitName, applicationName string) {
...
func (s *MigrationIntegrationBaseSuite) makeUnitApplicationLeaderLegacy(c *gc.C, unitName, applicationName string) {
...
func (s *MigrationIntegrationBaseSuite) makeUnitWithStorage(c *gc.C) (*state.Application, *state.Unit, names.StorageTag) {
	pool := "modelscoped"
	kind := "block"
...
type MigrationIntegrationExportSuite struct {
	MigrationIntegrationBaseSuite
}

var _ = gc.Suite(&MigrationIntegrationExportSuite{})

func (s *MigrationIntegrationExportSuite) SetUpTest(c *gc.C) {
	s.MigrationIntegrationBaseSuite.SetUpTest(c)
	s.SetFeatureFlags(feature.StrictMigration)
}

func (s *MigrationIntegrationExportSuite) checkStatusHistory(c *gc.C, history []description.Status, statusVal status.Status) {
...
func (s *MigrationIntegrationExportSuite) TestModelInfo(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestModelUsers(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestSLAs(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestMeterStatus(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestMachines(c *gc.C) {
	s.assertMachinesMigrated(c, constraints.MustParse("arch=amd64 mem=8G tags=foo,bar spaces=dmz"))
}

func (s *MigrationIntegrationExportSuite) TestMachinesWithVirtConstraint(c *gc.C) {
	s.assertMachinesMigrated(c, constraints.MustParse("arch=amd64 mem=8G virt-type=kvm"))
}

func (s *MigrationIntegrationExportSuite) TestMachinesWithRootDiskSourceConstraint(c *gc.C) {
	s.assertMachinesMigrated(c, constraints.MustParse("arch=amd64 mem=8G root-disk-source=aldous"))
}

func (s *MigrationIntegrationExportSuite) assertMachinesMigrated(c *gc.C, cons constraints.Value) {
...
func (s *MigrationIntegrationExportSuite) TestMachineDevices(c *gc.C) {
	machine := s.Factory.MakeMachine(c, nil)
...
func (s *MigrationIntegrationExportSuite) TestApplications(c *gc.C) {
	s.assertMigrateApplications(c, s.State, constraints.MustParse("arch=amd64 mem=8G"))
}

func (s *MigrationIntegrationExportSuite) TestCAASApplications(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestApplicationsWithVirtConstraint(c *gc.C) {
	s.assertMigrateApplications(c, s.State, constraints.MustParse("arch=amd64 mem=8G virt-type=kvm"))
}

func (s *MigrationIntegrationExportSuite) TestApplicationsWithRootDiskSourceConstraint(c *gc.C) {
	s.assertMigrateApplications(c, s.State, constraints.MustParse("arch=amd64 mem=8G root-disk-source=vonnegut"))
}

func (s *MigrationIntegrationExportSuite) assertMigrateApplications(c *gc.C, st *state.State, cons constraints.Value) {
...
func (s *MigrationIntegrationExportSuite) TestMultipleApplications(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestApplicationExposingOffers(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestUnits(c *gc.C) {
	s.assertMigrateUnits(c, s.State)
}

func (s *MigrationIntegrationExportSuite) TestCAASUnits(c *gc.C) {
	caasSt := s.Factory.MakeCAASModel(c, nil)
	s.AddCleanup(func(_ *gc.C) { caasSt.Close() })
...
func (s *MigrationIntegrationExportSuite) assertMigrateUnits(c *gc.C, st *state.State) {
	f := factory.NewFactory(st, s.StatePool)
...
func (s *MigrationIntegrationExportSuite) TestApplicationLeadershipLegacy(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestApplicationLeadership(c *gc.C) {
	s.makeApplicationWithUnits(c, "mysql", 2)
...
func (s *MigrationIntegrationExportSuite) TestUnitsOpenPorts(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestEndpointBindings(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestRemoteEntities(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestSubordinateRelations(c *gc.C) {
	wordpress := state.AddTestingApplication(c, s.State, "wordpress", state.AddTestingCharm(c, s.State, "wordpress"))
	mysql := state.AddTestingApplication(c, s.State, "mysql", state.AddTestingCharm(c, s.State, "mysql"))
	wordpress_0 := s.Factory.MakeUnit(c, &factory.UnitParams{Application: wordpress})
	mysql_0 := s.Factory.MakeUnit(c, &factory.UnitParams{Application: mysql})
...
func (s *MigrationIntegrationExportSuite) TestSpaces(c *gc.C) {
	s.Factory.MakeSpace(c, &factory.SpaceParams{
		Name: "one", ProviderID: network.Id("provider"), IsPublic: true})
...
func (s *MigrationIntegrationExportSuite) TestMultipleSpaces(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestLinkLayerDevices(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestLinkLayerDevicesSkipped(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
	deviceArgs := state.LinkLayerDeviceArgs{
...
func (s *MigrationIntegrationExportSuite) TestInstanceDataSkipped(c *gc.C) {
...
func (s *MigrationIntegrationBaseSuite) TestMachineAgentBinariesSkipped(c *gc.C) {
	s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
...
func (s *MigrationIntegrationBaseSuite) TestUnitAgentBinariesSkipped(c *gc.C) {
...
func (s *MigrationIntegrationBaseSuite) TestRelationScopeSkipped(c *gc.C) {
	wordpress := state.AddTestingApplication(c, s.State, "wordpress", state.AddTestingCharm(c, s.State, "wordpress"))
	mysql := state.AddTestingApplication(c, s.State, "mysql", state.AddTestingCharm(c, s.State, "mysql"))
	// InferEndpoints will always return provider, requirer
	eps, err := s.State.InferEndpoints("mysql", "wordpress")
...
func (s *MigrationIntegrationExportSuite) TestSubnets(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestIPAddresses(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
...
func (s *MigrationIntegrationExportSuite) TestIPAddressesSkipped(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
...
func (s *MigrationIntegrationExportSuite) TestSSHHostKeys(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
...
func (s *MigrationIntegrationExportSuite) TestSSHHostKeysSkipped(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
	err := s.State.SetSSHHostKeys(machine.MachineTag(), []string{"bam", "mam"})
...
func (s *MigrationIntegrationExportSuite) TestCloudImageMetadata(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestCloudImageMetadataSkipped(c *gc.C) {
	storageSize := uint64(3)
	attrs := cloudimagemetadata.MetadataAttributes{
		Stream:          "stream",
		Region:          "region-test",
...
func (s *MigrationIntegrationExportSuite) TestActions(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
...
func (s *MigrationIntegrationExportSuite) TestActionsSkipped(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
...
func (s *MigrationIntegrationExportSuite) TestVolumeAttachmentPlansLocalDisk(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestVolumeAttachmentPlansISCSIDisk(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestVolumes(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Volumes: []state.HostVolumeParams{{
			Volume:     state.VolumeParams{Size: 1234},
			Attachment: state.VolumeAttachmentParams{ReadOnly: true},
...
func (s *MigrationIntegrationExportSuite) TestFilesystems(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
...
func (s *MigrationIntegrationExportSuite) TestStorage(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestStoragePools(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestPayloads(c *gc.C) {
	unit := s.Factory.MakeUnit(c, nil)
...
func (s *MigrationIntegrationExportSuite) TestResources(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) newResource(c *gc.C, appName, name string, revision int, body string) resource.Resource {
...
func (s *MigrationIntegrationExportSuite) TestRemoteApplications(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestModelStatus(c *gc.C) {
	model, err := s.State.Export()
	c.Assert(err, jc.ErrorIsNil)
...
func (s *MigrationIntegrationExportSuite) TestTooManyStatusHistories(c *gc.C) {
...
func (s *MigrationIntegrationExportSuite) TestRelationWithNoStatus(c *gc.C) {
