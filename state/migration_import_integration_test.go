...
type MigrationIntegrationImportSuite struct {
	MigrationIntegrationBaseSuite
}

var _ = gc.Suite(&MigrationIntegrationImportSuite{})

func (s *MigrationIntegrationImportSuite) checkStatusHistory(c *gc.C, exported, imported status.StatusHistoryGetter, size int) {
...
func (s *MigrationIntegrationImportSuite) TestExisting(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) importModel(
...
func (s *MigrationIntegrationImportSuite) assertAnnotations(c *gc.C, model *state.Model, entity state.GlobalEntity) {
	annotations, err := model.Annotations(entity)
	c.Assert(err, jc.ErrorIsNil)
	c.Assert(annotations, jc.DeepEquals, testAnnotations)
}

func (s *MigrationIntegrationImportSuite) TestNewModel(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) newModelUser(c *gc.C, name string, readOnly bool, lastConnection time.Time) permission.UserAccess {
...
func (s *MigrationIntegrationImportSuite) AssertUserEqual(c *gc.C, newUser, oldUser permission.UserAccess) {
...
func (s *MigrationIntegrationImportSuite) TestModelUsers(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestSLA(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestMeterStatus(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestMeterStatusNotAvailable(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) AssertMachineEqual(c *gc.C, newMachine, oldMachine *state.Machine) {
...
func (s *MigrationIntegrationImportSuite) TestMachines(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestMachineDevices(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestMachinePortOpsSubnetID(c *gc.C) {
	subnet, err := s.State.AddSubnet(network.SubnetInfo{CIDR: "10.0.0.0/24"})
	c.Assert(err, jc.ErrorIsNil)
	s.testMachinePortOps(c, subnet.ID(), subnet.ID())
}

func (s *MigrationIntegrationImportSuite) TestMachinePortOpsSubnetCIDR(c *gc.C) {
	subnet, err := s.State.AddSubnet(network.SubnetInfo{CIDR: "10.0.0.0/24"})
	c.Assert(err, jc.ErrorIsNil)
	s.testMachinePortOps(c, subnet.CIDR(), subnet.ID())
}

func (s *MigrationIntegrationImportSuite) TestMachinePortOpsSubnetEmpty(c *gc.C) {
	s.testMachinePortOps(c, "", "")
}

func (s *MigrationIntegrationImportSuite) testMachinePortOps(c *gc.C, setup, validate string) {
...
func (s *MigrationIntegrationImportSuite) setupSourceApplications(
...
func (s *MigrationIntegrationImportSuite) assertImportedApplication(
...
func (s *MigrationIntegrationImportSuite) TestApplications(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestApplicationStatus(c *gc.C) {
	cons := constraints.MustParse("arch=amd64 mem=8G")
...
func (s *MigrationIntegrationImportSuite) TestCAASApplications(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestCAASApplicationStatus(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestCharmRevSequencesNotImported(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestApplicationsSubordinatesAfter(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestUnits(c *gc.C) {
	s.assertUnitsMigrated(c, s.State, constraints.MustParse("arch=amd64 mem=8G"))
}

func (s *MigrationIntegrationImportSuite) TestCAASUnits(c *gc.C) {
	caasSt := s.Factory.MakeCAASModel(c, nil)
	s.AddCleanup(func(_ *gc.C) { caasSt.Close() })
...
func (s *MigrationIntegrationImportSuite) TestUnitsWithVirtConstraint(c *gc.C) {
	s.assertUnitsMigrated(c, s.State, constraints.MustParse("arch=amd64 mem=8G virt-type=kvm"))
}

func (s *MigrationIntegrationImportSuite) assertUnitsMigrated(c *gc.C, st *state.State, cons constraints.Value) {
	f := factory.NewFactory(st, s.StatePool)
...
func (s *MigrationIntegrationImportSuite) TestRemoteEntities(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestRelationNetworks(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestRelations(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) assertRelationsMissingStatus(c *gc.C, hasUnits bool) {
	wordpress := state.AddTestingApplication(c, s.State, "wordpress", state.AddTestingCharm(c, s.State, "wordpress"))
	state.AddTestingApplication(c, s.State, "mysql", state.AddTestingCharm(c, s.State, "mysql"))
	eps, err := s.State.InferEndpoints("mysql", "wordpress")
	c.Assert(err, jc.ErrorIsNil)
...
func (s *MigrationIntegrationImportSuite) TestRelationsMissingStatusWithUnits(c *gc.C) {
	s.assertRelationsMissingStatus(c, true)
}

func (s *MigrationIntegrationImportSuite) TestRelationsMissingStatusNoUnits(c *gc.C) {
	s.assertRelationsMissingStatus(c, false)
}

func (s *MigrationIntegrationImportSuite) TestEndpointBindings(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestUnitsOpenPorts(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestSpaces(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestDestroyEmptyModel(c *gc.C) {
	newModel, _ := s.importModel(c, s.State)
	s.assertDestroyModelAdvancesLife(c, newModel, state.Dying)
}

func (s *MigrationIntegrationImportSuite) TestDestroyModelWithMachine(c *gc.C) {
	s.Factory.MakeMachine(c, nil)
	newModel, _ := s.importModel(c, s.State)
	s.assertDestroyModelAdvancesLife(c, newModel, state.Dying)
}

func (s *MigrationIntegrationImportSuite) TestDestroyModelWithApplication(c *gc.C) {
	s.Factory.MakeApplication(c, nil)
	newModel, _ := s.importModel(c, s.State)
	s.assertDestroyModelAdvancesLife(c, newModel, state.Dying)
}

func (s *MigrationIntegrationImportSuite) assertDestroyModelAdvancesLife(c *gc.C, m *state.Model, life state.Life) {
	c.Assert(m.Destroy(state.DestroyModelParams{}), jc.ErrorIsNil)
	c.Assert(m.Refresh(), jc.ErrorIsNil)
	c.Assert(m.Life(), gc.Equals, life)
}

func (s *MigrationIntegrationImportSuite) TestLinkLayerDevice(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestLinkLayerDeviceMigratesReferences(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
...
func (s *MigrationIntegrationImportSuite) TestSubnets(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestSubnetsWithFan(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestIPAddress(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
...
func (s *MigrationIntegrationImportSuite) TestSSHHostKey(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
...
func (s *MigrationIntegrationImportSuite) TestCloudImageMetadata(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestAction(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
		Constraints: constraints.MustParse("arch=amd64 mem=8G"),
	})
...
func (s *MigrationIntegrationImportSuite) TestVolumes(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
...
func (s *MigrationIntegrationImportSuite) TestFilesystems(c *gc.C) {
	machine := s.Factory.MakeMachine(c, &factory.MachineParams{
...
func (s *MigrationIntegrationImportSuite) TestStorage(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestStorageDetached(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestStorageInstanceConstraints(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestStorageInstanceConstraintsFallback(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestStoragePools(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestPayloads(c *gc.C) {
...
// flag.
func (s *MigrationIntegrationImportSuite) TestRemoteApplicationsWithoutFeatureFlag(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestRemoteApplications(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) assertRemoteApplicationEndpoints(c *gc.C, expected, recieved *state.RemoteApplication) {
...
func (s *MigrationIntegrationImportSuite) assertRemoteApplicationSpaces(c *gc.C, expected, recieved *state.RemoteApplication) {
...
func (s *MigrationIntegrationImportSuite) TestApplicationsWithNilConfigValues(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestOneSubordinateTwoGuvnors(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestImportingModelWithBlankType(c *gc.C) {
...
func (s *MigrationIntegrationImportSuite) TestImportingRelationApplicationSettings(c *gc.C) {
	wordpress := state.AddTestingApplication(c, s.State, "wordpress", state.AddTestingCharm(c, s.State, "wordpress"))
	mysql := state.AddTestingApplication(c, s.State, "mysql", state.AddTestingCharm(c, s.State, "mysql"))
	eps, err := s.State.InferEndpoints("mysql", "wordpress")
	c.Assert(err, jc.ErrorIsNil)
