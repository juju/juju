...
func Initialize(c *gc.C, owner names.UserTag, cfg *config.Config, controllerInheritedConfig map[string]interface{}, regionConfig cloud.RegionConfig, newPolicy state.NewPolicyFunc) (*state.Controller, *state.StatePool) {
...
// configuration will be used.
func InitializeWithArgs(c *gc.C, args InitializeArgs) (*state.Controller, *state.StatePool) {
