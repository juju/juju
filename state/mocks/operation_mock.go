...
//
//	mockgen -package mocks -destination mocks/operation_mock.go github.com/juju/juju/state ModelOperation
//
...
func (mr *MockModelOperationMockRecorder) Done(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
