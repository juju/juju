...
// Source: github.com/juju/description/v6 (interfaces: ExternalController,OfferConnection,RemoteEntity,RelationNetwork,RemoteApplication,RemoteSpace,Status)
//
// Generated by this command:
//
//	mockgen -package migrations -destination description_mock_test.go github.com/juju/description/v6 ExternalController,OfferConnection,RemoteEntity,RelationNetwork,RemoteApplication,RemoteSpace,Status
//
