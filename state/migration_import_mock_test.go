...
// Source: github.com/juju/juju/state (interfaces: TransactionRunner,StateDocumentFactory,DocModelNamespace,ModelRemoteEntities,ModelRelationNetworks,ModelRemoteApplications)
...
// MockModelRemoteApplications is a mock of ModelRemoteApplications interface
type MockModelRemoteApplications struct {
	ctrl     *gomock.Controller
	recorder *MockModelRemoteApplicationsMockRecorder
}

// MockModelRemoteApplicationsMockRecorder is the mock recorder for MockModelRemoteApplications
type MockModelRemoteApplicationsMockRecorder struct {
	mock *MockModelRemoteApplications
}

// NewMockModelRemoteApplications creates a new mock instance
func NewMockModelRemoteApplications(ctrl *gomock.Controller) *MockModelRemoteApplications {
	mock := &MockModelRemoteApplications{ctrl: ctrl}
	mock.recorder = &MockModelRemoteApplicationsMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockModelRemoteApplications) EXPECT() *MockModelRemoteApplicationsMockRecorder {
	return m.recorder
}

// RemoteApplications mocks base method
func (m *MockModelRemoteApplications) RemoteApplications() []description.RemoteApplication {
...
func (mr *MockModelRemoteApplicationsMockRecorder) RemoteApplications() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RemoteApplications", reflect.TypeOf((*MockModelRemoteApplications)(nil).RemoteApplications))
}
