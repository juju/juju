...
// watchableCollections contains all the collections in mongo that should be watched by the
// TxnWatcher and publish to the hub.
var watchableCollections = []string{
	actionNotificationsC,
	actionresultsC,
	actionsC,
	annotationsC,
