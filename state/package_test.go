...
//go:generate go run go.uber.org/mock/mockgen -typed -package state -destination migration_description_mock_test.go github.com/juju/description/v8 ApplicationOffer,FirewallRule,RemoteEntity,RelationNetwork,RemoteApplication,RemoteSpace,Status
