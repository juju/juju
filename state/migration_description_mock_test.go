...
// Source: github.com/juju/description/v5 (interfaces: ApplicationOffer,ExternalController,FirewallRule,RemoteEntity,RelationNetwork,RemoteApplication,RemoteSpace,Status)
//
// Generated by this command:
//
//	mockgen -package state -destination migration_description_mock_test.go github.com/juju/description/v5 ApplicationOffer,ExternalController,FirewallRule,RemoteEntity,RelationNetwork,RemoteApplication,RemoteSpace,Status
//
