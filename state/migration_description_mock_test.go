...
//
//	mockgen -package state -destination migration_description_mock_test.go github.com/juju/description/v6 ApplicationOffer,FirewallRule,RemoteEntity,RelationNetwork,RemoteApplication,RemoteSpace,Status
//
