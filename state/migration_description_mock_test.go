...
// Source: github.com/juju/description/v2 (interfaces: ApplicationOffer,ExternalController,FirewallRule,RemoteEntity,RelationNetwork,RemoteApplication,RemoteSpace,Status)
