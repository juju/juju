...
func (a *APIAddresser) APIAddresses() ([]string, error) {
	...
	err := a.facadeCaller.CallFacade("APIAddresses", nil, &result)
	if err != nil {
		return nil, err
	}
...
func (a *APIAddresser) CACert() (string, error) {
	...
	err := a.facadeCaller.CallFacade("CACert", nil, &result)
	if err != nil {
		return "", err
	}
...
func (a *APIAddresser) APIHostPorts() ([][]network.HostPort, error) {
	...
	err := a.facadeCaller.CallFacade("APIHostPorts", nil, &result)
	if err != nil {
		return nil, err
	}
...
func (a *APIAddresser) WatchAPIHostPorts() (watcher.NotifyWatcher, error) {
	...
	err := a.facadeCaller.CallFacade("WatchAPIHostPorts", nil, &result)
	if err != nil {
		return nil, err
	}
	return watcher.NewNotifyWatcher(a.facadeCaller.RawAPICaller(), result), nil
}
