...
func (u *Unit) SetStatus(status params.Status, info string, data params.StatusData) error {
	...
	err := u.st.caller.FacadeCall("SetStatus", args, &result)
	if err != nil {
		return err
	}
...
func (u *Unit) EnsureDead() error {
	...
	err := u.st.caller.FacadeCall("EnsureDead", args, &result)
	if err != nil {
		return err
	}
	return result.OneError()
...
func (u *Unit) ConfigSettings() (charm.Settings, error) {
	...
	err := u.st.caller.FacadeCall("ConfigSettings", args, &results)
	if err != nil {
		return nil, err
	}
	if len(results.Results) != 1 {
...
func (u *Unit) Destroy() error {
	...
	err := u.st.caller.FacadeCall("Destroy", args, &result)
	if err != nil {
		return err
	}
	return result.OneError()
...
func (u *Unit) DestroyAllSubordinates() error {
	...
	err := u.st.caller.FacadeCall("DestroyAllSubordinates", args, &result)
	if err != nil {
		return err
	}
	return result.OneError()
...
func (u *Unit) Resolved() (params.ResolvedMode, error) {
	...
	err := u.st.caller.FacadeCall("Resolved", args, &results)
	if err != nil {
		return "", err
	}
	if len(results.Results) != 1 {
...
func (u *Unit) IsPrincipal() (bool, error) {
	...
	err := u.st.caller.FacadeCall("GetPrincipal", args, &results)
	if err != nil {
		return false, err
	}
	if len(results.Results) != 1 {
...
func (u *Unit) HasSubordinates() (bool, error) {
	...
	err := u.st.caller.FacadeCall("HasSubordinates", args, &results)
	if err != nil {
		return false, err
	}
	if len(results.Results) != 1 {
...
func (u *Unit) PublicAddress() (string, error) {
	...
	err := u.st.caller.FacadeCall("PublicAddress", args, &results)
	if err != nil {
		return "", err
	}
	if len(results.Results) != 1 {
...
func (u *Unit) PrivateAddress() (string, error) {
	...
	err := u.st.caller.FacadeCall("PrivateAddress", args, &results)
	if err != nil {
		return "", err
	}
	if len(results.Results) != 1 {
...
func (u *Unit) OpenPort(protocol string, number int) error {
	...
	err := u.st.caller.FacadeCall("OpenPort", args, &result)
	if err != nil {
		return err
	}
	return result.OneError()
...
func (u *Unit) ClosePort(protocol string, number int) error {
	...
	err := u.st.caller.FacadeCall("ClosePort", args, &result)
	if err != nil {
		return err
	}
	return result.OneError()
...
func (u *Unit) CharmURL() (*charm.URL, error) {
	...
	err := u.st.caller.FacadeCall("CharmURL", args, &results)
	if err != nil {
		return nil, err
	}
	if len(results.Results) != 1 {
...
func (u *Unit) SetCharmURL(curl *charm.URL) error {
	...
	err := u.st.caller.FacadeCall("SetCharmURL", args, &result)
	if err != nil {
		return err
	}
	return result.OneError()
...
func (u *Unit) ClearResolved() error {
	...
	err := u.st.caller.FacadeCall("ClearResolved", args, &result)
	if err != nil {
		return err
	}
	return result.OneError()
...
func (u *Unit) WatchConfigSettings() (watcher.NotifyWatcher, error) {
	...
	err := u.st.caller.FacadeCall("WatchConfigSettings", args, &results)
	if err != nil {
		return nil, err
	}
	if len(results.Results) != 1 {
...
func (u *Unit) JoinedRelations() ([]string, error) {
	...
	err := u.st.caller.FacadeCall("JoinedRelations", args, &results)
	if err != nil {
		return nil, err
	}
	if len(results.Results) != 1 {
