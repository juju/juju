...
// Source: github.com/juju/juju/worker/sshserver (interfaces: FacadeClient)
//
// Generated by this command:
//
//	mockgen -package sshserver_test -destination facade_client_mock_test.go github.com/juju/juju/worker/sshserver FacadeClient
//
