...
// Source: github.com/juju/juju/worker/changestream/stream (interfaces: Logger)
//
// Generated by this command:
//
//	mockgen -package stream -destination logger_mock_test.go github.com/juju/juju/worker/changestream/stream Logger
//
