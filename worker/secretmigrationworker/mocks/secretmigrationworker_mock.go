...
// Source: github.com/juju/juju/worker/secretmigrationworker (interfaces: Logger,Facade)
...
// GetSecretsToMigrate mocks base method.
func (m *MockFacade) GetSecretsToMigrate() ([]secrets.SecretMetadataForMigration, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSecretsToMigrate")
	ret0, _ := ret[0].([]secrets.SecretMetadataForMigration)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetSecretsToMigrate indicates an expected call of GetSecretsToMigrate.
func (mr *MockFacadeMockRecorder) GetSecretsToMigrate() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetSecretsToMigrate", reflect.TypeOf((*MockFacade)(nil).GetSecretsToMigrate))
}
