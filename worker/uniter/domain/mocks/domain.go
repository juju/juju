...
// Source: github.com/juju/juju/worker/uniter/domain (interfaces: Unit,Relation,RelationUnit,Application,Charm)
...
func (m *MockUnit) Application() (domain.Application, error) {
	m.ctrl.T.Helper()
...
func (m *MockRelation) Unit(arg0 names.UnitTag) (domain.RelationUnit, error) {
	m.ctrl.T.Helper()
...
func (m *MockRelationUnit) Relation() domain.Relation {
	m.ctrl.T.Helper()
