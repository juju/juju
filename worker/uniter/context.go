...
type HookContext struct {
	...
	// actionResults holds the results set by the action-set jujuc
	// utility.
	actionResults map[string]interface{}

	// actionErr stores errors generated by Action-related events.
	actionErr error
...
func (ctx *HookContext) ActionSetResults(results map[string]interface{}) {
	ctx.actionResults = results
}

// ActionResults retrieves the state set by ActionSetResults.
func (ctx *HookContext) ActionResults() (map[string]interface{}, bool) {
	if ctx.actionResults == nil {
		return map[string]interface{}{}, ctx.actionErr != nil
	}
	return ctx.actionResults, ctx.actionErr != nil
}
