...
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination mocks/mock_state_tracker.go github.com/juju/juju/worker/uniter/relation StateTrackerClient
