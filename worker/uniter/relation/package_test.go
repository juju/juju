...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/mock_relationer.go github.com/juju/juju/worker/uniter/relation Relationer
...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/mock_state_tracker.go github.com/juju/juju/worker/uniter/relation StateTrackerClient
