...
// the desired hooks.
func (q *liveSource) Changes() <-chan juju.RelationUnitsChange {
...
func (q *liveSource) Update(change juju.RelationUnitsChange) error {
	if !q.started {
		q.started = true
		...
		departs := juju.RelationUnitsChange{}
...
func (q *liveSource) update(change juju.RelationUnitsChange) {
