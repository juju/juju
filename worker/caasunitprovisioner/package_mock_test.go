...
//
//	mockgen -package caasunitprovisioner -destination package_mock_test.go github.com/juju/juju/worker/caasunitprovisioner ProvisioningStatusSetter
//
...
func (m *MockProvisioningStatusSetter) SetOperatorStatus(arg0 string, arg1 status.Status, arg2 string, arg3 map[string]any) error {
	m.ctrl.T.Helper()
...
func (mr *MockProvisioningStatusSetterMockRecorder) SetOperatorStatus(arg0, arg1, arg2, arg3 any) *gomock.Call {
