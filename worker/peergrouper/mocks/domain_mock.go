...
// Source: github.com/juju/juju/worker/peergrouper (interfaces: ControllerConfigGetter)
...
func (m *MockControllerConfigGetter) Watch() (watcher.Watcher[[]string], error) {
	m.ctrl.T.Helper()
...
func (mr *MockControllerConfigGetterMockRecorder) Watch() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Watch", reflect.TypeOf((*MockControllerConfigGetter)(nil).Watch))
}
