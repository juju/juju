...
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination mocks/deployer_mocks.go github.com/juju/juju/worker/deployer Client,Machine,Unit
