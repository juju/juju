...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/secretdrainworker_mock.go github.com/juju/juju/worker/secretdrainworker Logger,Facade
