...
// Source: github.com/juju/juju/worker/caasfirewallerembedded (interfaces: CAASBroker,PortMutator,ServiceUpdater)
...
func (m *MockPortMutator) UpdatePorts(arg0 []caas.ServicePort) error {
	m.ctrl.T.Helper()
...
func (mr *MockPortMutatorMockRecorder) UpdatePorts(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatePorts", reflect.TypeOf((*MockPortMutator)(nil).UpdatePorts), arg0)
}
