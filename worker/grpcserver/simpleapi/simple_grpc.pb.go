...
func (c *simpleServiceClient) Status(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/juju.simpleapi.SimpleService/Status", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *simpleServiceClient) Deploy(ctx context.Context, in *DeployRequest, opts ...grpc.CallOption) (*DeployResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/juju.simpleapi.SimpleService/Deploy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SimpleService_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/juju.simpleapi.SimpleService/Status",
	}
...
func _SimpleService_Deploy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/juju.simpleapi.SimpleService/Deploy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var SimpleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "juju.simpleapi.SimpleService",
