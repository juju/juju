...
// Source: github.com/juju/juju/worker/objectstore (interfaces: TrackedObjectStore,StatePool,MongoSession,MetadataServiceGetter,MetadataService)
...
func (mr *MockMetadataServiceGetterMockRecorder) ForModelUUID(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForModelUUID", reflect.TypeOf((*MockMetadataServiceGetter)(nil).ForModelUUID), arg0)
}
...
func (mr *MockMetadataServiceMockRecorder) ObjectStore() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ObjectStore", reflect.TypeOf((*MockMetadataService)(nil).ObjectStore))
}
