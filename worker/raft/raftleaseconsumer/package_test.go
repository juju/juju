...
//go:generate go run github.com/golang/mock/mockgen -package raftleaseconsumer -destination target_mock_test.go github.com/juju/juju/core/raftlease NotifyTarget,FSMResponse
...
//go:generate go run github.com/golang/mock/mockgen -package raftleaseconsumer -destination raft_future_mock_test.go github.com/hashicorp/raft ApplyFuture
