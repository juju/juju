...
//
//	mockgen -package raft -destination raft_mock_test.go github.com/juju/juju/worker/raft Raft,ApplierMetrics
//
...
func (mr *MockRaftMockRecorder) Apply(arg0, arg1 any) *gomock.Call {
...
func (mr *MockApplierMetricsMockRecorder) Record(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
