...
//go:generate go run go.uber.org/mock/mockgen -package globalclockupdater -destination raftlease_test.go github.com/juju/juju/core/raftlease ReadOnlyClock,FSMResponse
