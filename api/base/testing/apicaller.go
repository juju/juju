...
func APICallerWithBakery(callerFunc APICallerFunc, discharger base.MacaroonDischarger) *apiCallerWithBakery {
	return &apiCallerWithBakery{callerFunc, discharger}
}
