...
func (s *applicationSuite) TestGetApplicationStorageSuccessful(c *tc.C) {
	...
	mockFacadeCaller := mocks.NewMockFacadeCaller(ctrl)
	mockFacadeCaller.EXPECT().FacadeCall(context.Background(), "GetApplicationStorage", args, result).SetArg(2, results).Return(nil)
...
func (s *applicationSuite) TestUpdateApplicationStorageSuccessful(c *tc.C) {
	...
	mockFacadeCaller := mocks.NewMockFacadeCaller(ctrl)
	mockFacadeCaller.EXPECT().FacadeCall(context.Background(), "UpdateApplicationStorage", args, result).SetArg(2, results).Return(nil)
