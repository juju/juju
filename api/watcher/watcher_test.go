...
func setupWatcher[T any](c *gc.C, caller *apimocks.MockAPICaller, facadeName string) (string, chan T) {
	...
	caller.EXPECT().APICall(context.Background(), facadeName, 666, "id-666", "Stop", nil, gomock.Any()).DoAndReturn(func(_ string, _ int, _ string, _ string, _ any, _ any) {
		select {
		case stopped <- true:
		default:
		}
	...
	caller.EXPECT().APICall(context.Background(), facadeName, 666, "id-666", "Next", nil, gomock.Any()).DoAndReturn(func(_ string, _ int, _ string, _ string, _ any, r *any) error {
		select {
		case ev, ok := <-eventCh:
			if !ok {
				c.FailNow()
...
func (s *watcherSuite) TestWatchMachine(c *gc.C) {
	...
	caller.EXPECT().APICall(context.Background(), "Machiner", 666, "", "Life", args, gomock.Any()).SetArg(5, lifeResults).Return(nil)
	initialResults := params.NotifyWatchResults{
		Results: []params.NotifyWatchResult{{
			NotifyWatcherId: watcherID,
		}},
	}
	caller.EXPECT().APICall(context.Background(), "Machiner", 666, "", "Watch", args, gomock.Any()).SetArg(5, initialResults).Return(nil)
...
func (s *watcherSuite) TestWatchUnits(c *gc.C) {
	...
	caller.EXPECT().APICall(context.Background(), "Deployer", 666, "", "WatchUnits", args, gomock.Any()).SetArg(5, initialResults).Return(nil)
...
func (s *watcherSuite) TestWatchMachineStorage(c *gc.C) {
	...
	caller.EXPECT().APICall(context.Background(), "StorageProvisioner", 666, "", "WatchVolumeAttachments", args, gomock.Any()).SetArg(5, initialResults).Return(nil)
...
func (s *watcherSuite) TestRelationStatusWatcher(c *gc.C) {
	...
	caller.EXPECT().APICall(context.Background(), "CrossModelRelations", 666, "", "WatchRelationsSuspendedStatus", args, gomock.Any()).SetArg(5, initialResults).Return(nil)
...
func (s *watcherSuite) TestOfferStatusWatcher(c *gc.C) {
	...
	caller.EXPECT().APICall(context.Background(), "CrossModelRelations", 666, "", "WatchOfferStatus", args, gomock.Any()).SetArg(5, initialResults).Return(nil)
...
func (s *watcherSuite) assertSecretsTriggerWatcher(c *gc.C, caller *apimocks.MockAPICaller, apiName string, watchFunc func(ownerTags ...names.Tag) (corewatcher.SecretTriggerWatcher, error)) {
	...
	caller.EXPECT().APICall(context.Background(), "SecretsManager", 666, "", apiName, args, gomock.Any()).SetArg(5, initialResults).Return(nil)
...
func (s *watcherSuite) TestCrossModelSecretsRevisionWatcher(c *gc.C) {
	...
	caller.EXPECT().APICall(context.Background(), "CrossModelRelations", 666, "", "WatchConsumedSecretsChanges", args, gomock.Any()).SetArg(5, initialResults).Return(nil)
...
func (s *migrationSuite) TestMigrationStatusWatcher(c *gc.C) {
	...
	caller.EXPECT().APICall(context.Background(), "MigrationMinion", 666, "", "Watch", nil, gomock.Any()).SetArg(5, initialResult).Return(nil)
