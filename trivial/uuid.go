...
// ValidUUIDString specifies the regular expression that matches an UUID (version 4, variant 2).
const ValidUUIDString = "[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[8,9,a,b][0-9a-f]{3}-[0-9a-f]{12}"
