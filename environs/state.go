...
// SaveProviderState stores the instances in the state file in the given
// storage.
...
// LoadProviderState reads state from the given storage.
func LoadProviderState(storage StorageReader) ([]instance.Id, error) {
