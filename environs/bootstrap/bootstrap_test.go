...
func (s *bootstrapSuite) TestBootstrapLocalTools(c *gc.C) {
	...
	s.PatchValue(&arch.HostArch, func() string { return arch.AMD64 })
	s.PatchValue(bootstrap.FindTools, func(simplestreams.DataSourceFactory, environs.BootstrapEnviron, int, int, []string, tools.Filter) (tools.List, error) {
...
func (s *bootstrapSuite) assertBootstrapPackagedToolsAvailable(c *gc.C, clientArch string) {
	...
	findToolsOk := false
	s.PatchValue(bootstrap.FindTools, func(_ simplestreams.DataSourceFactory, _ environs.BootstrapEnviron, _ int, _ int, _ []string, filter tools.Filter) (tools.List, error) {
