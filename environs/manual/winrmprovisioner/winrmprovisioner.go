...
func gatherMachineParams(hostname string, cli *winrm.Client) (*params.AddMachineParams, error) {
...
func checkProvisioned(host string, cli *winrm.Client) (bool, error) {
...
func DetectSeriesAndHardwareCharacteristics(host string, cli *winrm.Client) (hc instance.HardwareCharacteristics, series string, err error) {
...
func runProvisionScript(script string, cli *winrm.Client, stdin, stderr io.Writer) (err error) {
