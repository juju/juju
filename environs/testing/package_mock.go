...
func (m *MockEnviron) ConstraintsValidator() (constraints.Validator, error) {
	ret := m.ctrl.Call(m, "ConstraintsValidator")
...
func (mr *MockEnvironMockRecorder) ConstraintsValidator() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConstraintsValidator", reflect.TypeOf((*MockEnviron)(nil).ConstraintsValidator))
}
...
// ConstraintsValidator mocks base method
func (m *MockNetworkingEnviron) ConstraintsValidator() (constraints.Validator, error) {
	ret := m.ctrl.Call(m, "ConstraintsValidator")
	ret0, _ := ret[0].(constraints.Validator)
	ret1, _ := ret[1].(error)
	return ret0, ret1
...
// ConstraintsValidator indicates an expected call of ConstraintsValidator
func (mr *MockNetworkingEnvironMockRecorder) ConstraintsValidator() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConstraintsValidator", reflect.TypeOf((*MockNetworkingEnviron)(nil).ConstraintsValidator))
}
