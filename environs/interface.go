...
type Environ interface {
	...
	// If the configuration's AdminSecret is non-empty, the
	// adminstrator password on the newly bootstrapped
	// state will be set to a hash of it (see trivial.PasswordHash),
	// and should be changed at the first opportunity.
