...
type CharmHubClient interface {
	...
	// Read the path to get the contents of the charm.
	...
	DownloadAndRead(ctx context.Context, url *url.URL, path string, options ...charmhub.DownloadOption) (*charm.CharmArchive, *charmhub.Digest, error)
}
