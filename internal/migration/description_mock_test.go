...
// Source: github.com/juju/description/v9 (interfaces: Model)
//
// Generated by this command:
//
//	mockgen -typed -package migration_test -destination description_mock_test.go github.com/juju/description/v9 Model
//
