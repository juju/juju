...
func (mr *MockMetricsCollectorMockRecorder) ChangesCountObserve(arg0 any) *gomock.Call {
...
func (mr *MockMetricsCollectorMockRecorder) ChangesRequestDurationObserve(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
