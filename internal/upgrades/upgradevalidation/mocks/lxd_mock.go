...
// Source: github.com/juju/juju/provider/lxd (interfaces: ServerFactory,Server)
//
// Generated by this command:
//
//	mockgen -package mocks -destination mocks/lxd_mock.go github.com/juju/juju/provider/lxd ServerFactory,Server
//
