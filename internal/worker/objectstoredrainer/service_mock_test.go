...
func (m *MockDrainingService) GetDrainingPhase(arg0 context.Context) (objectstore.Phase, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDrainingServiceMockRecorder) GetDrainingPhase(arg0 any) *MockDrainingServiceGetDrainingPhaseCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDrainingPhase", reflect.TypeOf((*MockDrainingService)(nil).GetDrainingPhase), arg0)
	return &MockDrainingServiceGetDrainingPhaseCall{Call: call}
}

// MockDrainingServiceGetDrainingPhaseCall wrap *gomock.Call
type MockDrainingServiceGetDrainingPhaseCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockDrainingServiceGetDrainingPhaseCall) Return(arg0 objectstore.Phase, arg1 error) *MockDrainingServiceGetDrainingPhaseCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockDrainingServiceGetDrainingPhaseCall) Do(f func(context.Context) (objectstore.Phase, error)) *MockDrainingServiceGetDrainingPhaseCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockDrainingServiceGetDrainingPhaseCall) DoAndReturn(f func(context.Context) (objectstore.Phase, error)) *MockDrainingServiceGetDrainingPhaseCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
