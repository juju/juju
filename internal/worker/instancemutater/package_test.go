...
//go:generate go run go.uber.org/mock/mockgen -typed -package mocks -destination mocks/logger_mock.go github.com/juju/juju/internal/worker/instancemutater Logger
