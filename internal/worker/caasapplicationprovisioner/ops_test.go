...
func (s *OpsSuite) TestRefreshApplicationStatus(c *gc.C) {
	...
	err := caasapplicationprovisioner.AppOps.RefreshApplicationStatus(context.Background(), "test", appId, app, appLife, facade, statusService, clk, s.logger)
	c.Assert(err, jc.ErrorIsNil)
}
...
func (s *OpsSuite) TestReconcileDeadUnitScale(c *gc.C) {
	...
	err := caasapplicationprovisioner.AppOps.ReconcileDeadUnitScale(context.Background(), "test", appId, app, facade, applicationService, statusService, s.logger)
	c.Assert(err, jc.ErrorIsNil)
}
...
func (s *OpsSuite) TestEnsureScaleAlive(c *gc.C) {
	...
	err := caasapplicationprovisioner.AppOps.EnsureScale(context.Background(), "test", appId, app, life.Alive, facade, unitFacade, applicationService, statusService, s.logger)
	c.Assert(err, jc.ErrorIsNil)
}
...
func (s *OpsSuite) TestEnsureScaleDyingDead(c *gc.C) {
	...
	err := caasapplicationprovisioner.AppOps.EnsureScale(context.Background(), "test", appId, app, life.Dead, facade, unitFacade, applicationService, statusService, s.logger)
	c.Assert(err, jc.ErrorIsNil)
}
...
func (s *OpsSuite) TestAppAlive(c *gc.C) {
	...
	err := caasapplicationprovisioner.AppOps.AppAlive(context.Background(), "test", app, password, &lastApplied, facade, statusService, clk, s.logger)
	c.Assert(err, jc.ErrorIsNil)
}
...
func (s *OpsSuite) TestAppDying(c *gc.C) {
	...
	err := caasapplicationprovisioner.AppOps.AppDying(context.Background(), "test", appId, app, life.Dying, facade, unitFacade, applicationService, statusService, s.logger)
	c.Assert(err, jc.ErrorIsNil)
}
