...
// Source: github.com/juju/juju/internal/worker/caasapplicationprovisioner (interfaces: ApplicationService,RemovalService,StatusService,AgentPasswordService,StorageProvisioningService)
//
// Generated by this command:
//
//	mockgen -typed -package mocks -destination mocks/domain_mock.go github.com/juju/juju/internal/worker/caasapplicationprovisioner ApplicationService,RemovalService,StatusService,AgentPasswordService,StorageProvisioningService
//
...
func (m *MockRemovalService) MarkApplicationAsDeadWithNoEntities(arg0 context.Context, arg1 application.UUID) error {
	m.ctrl.T.Helper()
...
func (mr *MockRemovalServiceMockRecorder) MarkApplicationAsDeadWithNoEntities(arg0, arg1 any) *MockRemovalServiceMarkApplicationAsDeadWithNoEntitiesCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkApplicationAsDeadWithNoEntities", reflect.TypeOf((*MockRemovalService)(nil).MarkApplicationAsDeadWithNoEntities), arg0, arg1)
	return &MockRemovalServiceMarkApplicationAsDeadWithNoEntitiesCall{Call: call}
}

// MockRemovalServiceMarkApplicationAsDeadWithNoEntitiesCall wrap *gomock.Call
type MockRemovalServiceMarkApplicationAsDeadWithNoEntitiesCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockRemovalServiceMarkApplicationAsDeadWithNoEntitiesCall) Return(arg0 error) *MockRemovalServiceMarkApplicationAsDeadWithNoEntitiesCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRemovalServiceMarkApplicationAsDeadWithNoEntitiesCall) Do(f func(context.Context, application.UUID) error) *MockRemovalServiceMarkApplicationAsDeadWithNoEntitiesCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRemovalServiceMarkApplicationAsDeadWithNoEntitiesCall) DoAndReturn(f func(context.Context, application.UUID) error) *MockRemovalServiceMarkApplicationAsDeadWithNoEntitiesCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
