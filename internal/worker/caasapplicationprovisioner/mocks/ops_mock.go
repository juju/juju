...
func (m *MockApplicationOps) AppAlive(arg0 context.Context, arg1, arg2 string, arg3 caas.Application, arg4 string, arg5 *caas.ApplicationConfig, arg6 *caasapplicationprovisioner.ProvisioningInfo, arg7 caasapplicationprovisioner.StatusService, arg8 clock.Clock, arg9 logger.Logger) error {
	m.ctrl.T.Helper()
...
func (c *MockApplicationOpsAppAliveCall) Do(f func(context.Context, string, string, caas.Application, string, *caas.ApplicationConfig, *caasapplicationprovisioner.ProvisioningInfo, caasapplicationprovisioner.StatusService, clock.Clock, logger.Logger) error) *MockApplicationOpsAppAliveCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockApplicationOpsAppAliveCall) DoAndReturn(f func(context.Context, string, string, caas.Application, string, *caas.ApplicationConfig, *caasapplicationprovisioner.ProvisioningInfo, caasapplicationprovisioner.StatusService, clock.Clock, logger.Logger) error) *MockApplicationOpsAppAliveCall {
