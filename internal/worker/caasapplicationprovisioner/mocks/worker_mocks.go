...
//
//	mockgen -typed -package mocks -destination mocks/worker_mocks.go github.com/juju/juju/internal/worker/caasapplicationprovisioner Runner,ResourceOpenerGetter
//
...
func (mr *MockResourceOpenerGetterMockRecorder) ResourceOpenerForApplication(arg0, arg1, arg2 any) *MockResourceOpenerGetterResourceOpenerForApplicationCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResourceOpenerForApplication", reflect.TypeOf((*MockResourceOpenerGetter)(nil).ResourceOpenerForApplication), arg0, arg1, arg2)
	return &MockResourceOpenerGetterResourceOpenerForApplicationCall{Call: call}
}

// MockResourceOpenerGetterResourceOpenerForApplicationCall wrap *gomock.Call
type MockResourceOpenerGetterResourceOpenerForApplicationCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockResourceOpenerGetterResourceOpenerForApplicationCall) Return(arg0 resource.Opener, arg1 error) *MockResourceOpenerGetterResourceOpenerForApplicationCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}
