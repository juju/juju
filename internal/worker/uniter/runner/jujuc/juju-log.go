...
//
//go:generate go run github.com/canonical/gomock/mockgen -package mocks -destination mocks/juju-log_mock.go github.com/juju/juju/internal/worker/uniter/runner/jujuc JujuLogContext
