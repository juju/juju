...
//go:generate go run github.com/canonical/gomock/mockgen -package api -destination uniter_mocks.go github.com/juju/juju/internal/worker/uniter/api UniterClient
