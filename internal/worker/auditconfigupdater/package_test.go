...
//go:generate go run github.com/canonical/gomock/mockgen -package auditconfigupdater -destination agent_mock_test.go github.com/juju/juju/agent Agent,Config
