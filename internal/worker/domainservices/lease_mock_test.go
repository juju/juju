...
// Source: github.com/juju/juju/core/lease (interfaces: LeaseCheckerWaiter,Manager,LeaseManagerGetter,ModelLeaseManagerGetter)
//
// Generated by this command:
//
//	mockgen -typed -package domainservices -destination lease_mock_test.go github.com/juju/juju/core/lease LeaseCheckerWaiter,Manager,LeaseManagerGetter,ModelLeaseManagerGetter
//
...
func (m *MockLeaseManagerGetter) GetLeaseManager(arg0 model.UUID) (lease.LeaseCheckerWaiter, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockLeaseManagerGetterGetLeaseManagerCall) Return(arg0 lease.LeaseCheckerWaiter, arg1 error) *MockLeaseManagerGetterGetLeaseManagerCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockLeaseManagerGetterGetLeaseManagerCall) Do(f func(model.UUID) (lease.LeaseCheckerWaiter, error)) *MockLeaseManagerGetterGetLeaseManagerCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockLeaseManagerGetterGetLeaseManagerCall) DoAndReturn(f func(model.UUID) (lease.LeaseCheckerWaiter, error)) *MockLeaseManagerGetterGetLeaseManagerCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
