...
// Source: github.com/juju/juju/core/objectstore (interfaces: ObjectStore,ObjectStoreGetter,ModelObjectStoreGetter,ControllerObjectStoreGetter)
//
// Generated by this command:
//
//	mockgen -typed -package domainservices -destination objectstore_mock_test.go github.com/juju/juju/core/objectstore ObjectStore,ObjectStoreGetter,ModelObjectStoreGetter,ControllerObjectStoreGetter
//
...
// MockControllerObjectStoreGetter is a mock of ControllerObjectStoreGetter interface.
type MockControllerObjectStoreGetter struct {
	ctrl     *gomock.Controller
	recorder *MockControllerObjectStoreGetterMockRecorder
}

// MockControllerObjectStoreGetterMockRecorder is the mock recorder for MockControllerObjectStoreGetter.
type MockControllerObjectStoreGetterMockRecorder struct {
	mock *MockControllerObjectStoreGetter
}

// NewMockControllerObjectStoreGetter creates a new mock instance.
func NewMockControllerObjectStoreGetter(ctrl *gomock.Controller) *MockControllerObjectStoreGetter {
	mock := &MockControllerObjectStoreGetter{ctrl: ctrl}
	mock.recorder = &MockControllerObjectStoreGetterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockControllerObjectStoreGetter) EXPECT() *MockControllerObjectStoreGetterMockRecorder {
	return m.recorder
}

// GetControllerObjectStore mocks base method.
func (m *MockControllerObjectStoreGetter) GetControllerObjectStore(arg0 context.Context) (objectstore.ObjectStore, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetControllerObjectStore", arg0)
	ret0, _ := ret[0].(objectstore.ObjectStore)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetControllerObjectStore indicates an expected call of GetControllerObjectStore.
func (mr *MockControllerObjectStoreGetterMockRecorder) GetControllerObjectStore(arg0 any) *MockControllerObjectStoreGetterGetControllerObjectStoreCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetControllerObjectStore", reflect.TypeOf((*MockControllerObjectStoreGetter)(nil).GetControllerObjectStore), arg0)
	return &MockControllerObjectStoreGetterGetControllerObjectStoreCall{Call: call}
}

// MockControllerObjectStoreGetterGetControllerObjectStoreCall wrap *gomock.Call
type MockControllerObjectStoreGetterGetControllerObjectStoreCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockControllerObjectStoreGetterGetControllerObjectStoreCall) Return(arg0 objectstore.ObjectStore, arg1 error) *MockControllerObjectStoreGetterGetControllerObjectStoreCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockControllerObjectStoreGetterGetControllerObjectStoreCall) Do(f func(context.Context) (objectstore.ObjectStore, error)) *MockControllerObjectStoreGetterGetControllerObjectStoreCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockControllerObjectStoreGetterGetControllerObjectStoreCall) DoAndReturn(f func(context.Context) (objectstore.ObjectStore, error)) *MockControllerObjectStoreGetterGetControllerObjectStoreCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
