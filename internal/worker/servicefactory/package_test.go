...
//go:generate go run go.uber.org/mock/mockgen -typed -package servicefactory -destination objectstore_mock_test.go github.com/juju/juju/core/objectstore ObjectStore,ObjectStoreGetter,SingularObjectStoreGetter
...
type baseSuite struct {
	...
	singluarObjectStoreGetter *MockSingularObjectStoreGetter
}
...
func (s *baseSuite) setupMocks(c *gc.C) *gomock.Controller {
	...
	s.singluarObjectStoreGetter = NewMockSingularObjectStoreGetter(ctrl)
