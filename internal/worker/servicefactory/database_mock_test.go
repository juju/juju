...
//
//	mockgen -package servicefactory -destination database_mock_test.go github.com/juju/juju/core/database DBDeleter
//
...
func (mr *MockDBDeleterMockRecorder) DeleteDB(arg0 any) *gomock.Call {
