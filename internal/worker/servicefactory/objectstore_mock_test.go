...
// Source: github.com/juju/juju/core/objectstore (interfaces: ObjectStore,ObjectStoreGetter,SingularObjectStoreGetter)
//
// Generated by this command:
//
//	mockgen -typed -package servicefactory -destination objectstore_mock_test.go github.com/juju/juju/core/objectstore ObjectStore,ObjectStoreGetter,SingularObjectStoreGetter
//
...
// MockSingularObjectStoreGetter is a mock of SingularObjectStoreGetter interface.
type MockSingularObjectStoreGetter struct {
	ctrl     *gomock.Controller
	recorder *MockSingularObjectStoreGetterMockRecorder
}

// MockSingularObjectStoreGetterMockRecorder is the mock recorder for MockSingularObjectStoreGetter.
type MockSingularObjectStoreGetterMockRecorder struct {
	mock *MockSingularObjectStoreGetter
}

// NewMockSingularObjectStoreGetter creates a new mock instance.
func NewMockSingularObjectStoreGetter(ctrl *gomock.Controller) *MockSingularObjectStoreGetter {
	mock := &MockSingularObjectStoreGetter{ctrl: ctrl}
	mock.recorder = &MockSingularObjectStoreGetterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSingularObjectStoreGetter) EXPECT() *MockSingularObjectStoreGetterMockRecorder {
	return m.recorder
}

// GetObjectStore mocks base method.
func (m *MockSingularObjectStoreGetter) GetObjectStore(arg0 context.Context) (objectstore.ObjectStore, error) {
	m.ctrl.T.Helper()
...
// GetObjectStore indicates an expected call of GetObjectStore.
func (mr *MockSingularObjectStoreGetterMockRecorder) GetObjectStore(arg0 any) *MockSingularObjectStoreGetterGetObjectStoreCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetObjectStore", reflect.TypeOf((*MockSingularObjectStoreGetter)(nil).GetObjectStore), arg0)
	return &MockSingularObjectStoreGetterGetObjectStoreCall{Call: call}
}

// MockSingularObjectStoreGetterGetObjectStoreCall wrap *gomock.Call
type MockSingularObjectStoreGetterGetObjectStoreCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockSingularObjectStoreGetterGetObjectStoreCall) Return(arg0 objectstore.ObjectStore, arg1 error) *MockSingularObjectStoreGetterGetObjectStoreCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockSingularObjectStoreGetterGetObjectStoreCall) Do(f func(context.Context) (objectstore.ObjectStore, error)) *MockSingularObjectStoreGetterGetObjectStoreCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockSingularObjectStoreGetterGetObjectStoreCall) DoAndReturn(f func(context.Context) (objectstore.ObjectStore, error)) *MockSingularObjectStoreGetterGetObjectStoreCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
