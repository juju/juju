...
func (m *MockModelServiceFactory) Application(arg0 storage.ProviderRegistry) *service0.Service {
	m.ctrl.T.Helper()
...
func (m *MockModelServiceFactory) Secret(arg0 service15.BackendAdminConfigGetter) *service15.SecretService {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Secret", arg0)
	ret0, _ := ret[0].(*service15.SecretService)
	return ret0
}
...
// Secret mocks base method.
func (m *MockServiceFactory) Secret(arg0 service15.BackendAdminConfigGetter) *service15.SecretService {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Secret", arg0)
	ret0, _ := ret[0].(*service15.SecretService)
	return ret0
