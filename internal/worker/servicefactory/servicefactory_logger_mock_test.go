...
//
//	mockgen -typed -package servicefactory -destination servicefactory_logger_mock_test.go github.com/juju/juju/internal/worker/servicefactory Logger
//
...
func (c *MockLoggerChildCall) Return(arg0 Logger) *MockLoggerChildCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockLoggerChildCall) Do(f func(string) Logger) *MockLoggerChildCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockLoggerChildCall) DoAndReturn(f func(string) Logger) *MockLoggerChildCall {
