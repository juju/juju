...
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination mocks/interface_mock.go github.com/juju/juju/internal/worker/meterstatus UnitStateAPI,StateReadWriter
