...
//
//	mockgen -typed -package upgradedatabase -destination service_mock_test.go github.com/juju/juju/internal/worker/upgradedatabase UpgradeService,ControllerNodeService
//
...
func (m *MockUpgradeService) GetAllModelUUIDs(arg0 context.Context) ([]model.UUID, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUpgradeServiceMockRecorder) GetAllModelUUIDs(arg0 any) *MockUpgradeServiceGetAllModelUUIDsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllModelUUIDs", reflect.TypeOf((*MockUpgradeService)(nil).GetAllModelUUIDs), arg0)
	return &MockUpgradeServiceGetAllModelUUIDsCall{Call: call}
}

// MockUpgradeServiceGetAllModelUUIDsCall wrap *gomock.Call
type MockUpgradeServiceGetAllModelUUIDsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockUpgradeServiceGetAllModelUUIDsCall) Return(arg0 []model.UUID, arg1 error) *MockUpgradeServiceGetAllModelUUIDsCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockUpgradeServiceGetAllModelUUIDsCall) Do(f func(context.Context) ([]model.UUID, error)) *MockUpgradeServiceGetAllModelUUIDsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockUpgradeServiceGetAllModelUUIDsCall) DoAndReturn(f func(context.Context) ([]model.UUID, error)) *MockUpgradeServiceGetAllModelUUIDsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
