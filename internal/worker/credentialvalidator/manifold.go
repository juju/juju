...
// FilterErrors converts credential-change errors into dependency bounce
// signals, so the engine restarts the manifold instead of reporting
// failure and takes a fresh reading of the credential state.
