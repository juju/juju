...
//go:generate go run go.uber.org/mock/mockgen -typed -package mocks -destination mocks/mocks_cred_api.go github.com/juju/juju/internal/worker/common CredentialAPI
...
//go:generate go run go.uber.org/mock/mockgen -typed -package mocks -destination mocks/servicefactory_mocks.go github.com/juju/juju/internal/worker/instancepoller MachineService
