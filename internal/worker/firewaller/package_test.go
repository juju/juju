...
//go:generate go run go.uber.org/mock/mockgen -typed -package mocks -destination mocks/servicefactory_mocks.go github.com/juju/juju/internal/worker/firewaller ServiceFactoryGetter,ServiceFactory,MachineService
