...
// Source: github.com/juju/juju/internal/flightrecorder (interfaces: FileRecorder)
//
// Generated by this command:
//
//	mockgen -typed -package flightrecorder -destination recorder_mock_test.go github.com/juju/juju/internal/flightrecorder FileRecorder
//
...
func (m *MockFileRecorder) Start() error {
	m.ctrl.T.Helper()
...
func (mr *MockFileRecorderMockRecorder) Start() *MockFileRecorderStartCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Start", reflect.TypeOf((*MockFileRecorder)(nil).Start))
...
// Do rewrite *gomock.Call.Do
func (c *MockFileRecorderStartCall) Do(f func() error) *MockFileRecorderStartCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockFileRecorderStartCall) DoAndReturn(f func() error) *MockFileRecorderStartCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
