...
func (m *MockSessionHandler) Handle(arg0 ssh.Session, arg1 string) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockSessionHandlerHandleCall) Do(f func(ssh.Session, string)) *MockSessionHandlerHandleCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockSessionHandlerHandleCall) DoAndReturn(f func(ssh.Session, string)) *MockSessionHandlerHandleCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
