...
//go:generate go run github.com/canonical/gomock/mockgen -package sshserver -destination proxy_mock_test.go github.com/juju/juju/internal/sshproxy ProxyFactory,ProxyHandlers,TerminatingServerFactory
