...
// Source: github.com/juju/juju/internal/worker/sshserver (interfaces: ControllerConfigService,Authenticator,Authorizer,ProxyFactory,ProxyHandlers,Resolver,TunnelTracker)
//
// Generated by this command:
//
//	mockgen -package sshserver -destination service_mock_test.go github.com/juju/juju/internal/worker/sshserver ControllerConfigService,Authenticator,Authorizer,ProxyFactory,ProxyHandlers,Resolver,TunnelTracker
//
...
type MockResolverMockRecorder struct {
	mock           *MockResolver
	resolveExpects []*gomock.Call2_2[context.Context, virtualhostname.Info, Termination, error]
}
...
func (m *MockResolver) Resolve(ctx context.Context, destination virtualhostname.Info) (Termination, error) {
	m.ctrl.T.Helper()
...
func (mr *MockResolverMockRecorder) Resolve(ctx, destination any) *MockResolverResolveCall {
	mr.mock.ctrl.T.Helper()
	call := gomock.NewCall2_2[context.Context, virtualhostname.Info, Termination, error](mr.mock.ctrl.T, mr.mock, "Resolve", gomock.EnsureMatcher(ctx), gomock.EnsureMatcher(destination))
...
type MockResolverResolveCall = gomock.Call2_2[context.Context, virtualhostname.Info, Termination, error]
