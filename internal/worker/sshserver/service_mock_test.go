...
// Source: github.com/juju/juju/internal/worker/sshserver (interfaces: FacadeClient,JWTParser,SessionHandler,TunnelAuthenticator)
//
// Generated by this command:
//
//	mockgen -package sshserver -destination service_mock_test.go github.com/juju/juju/internal/worker/sshserver FacadeClient,JWTParser,SessionHandler,TunnelAuthenticator
//
...
func (mr *MockTunnelAuthenticatorMockRecorder) AuthenticateTunnel(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AuthenticateTunnel", reflect.TypeOf((*MockTunnelAuthenticator)(nil).AuthenticateTunnel), arg0, arg1)
}
