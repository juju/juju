...
// Source: github.com/juju/juju/internal/worker/sshserver (interfaces: ControllerConfigService,Authenticator,Authorizer,ProxyFactory,ProxyHandlers,TunnelTracker,AccessService)
//
// Generated by this command:
//
//	mockgen -package sshserver -destination service_mock_test.go github.com/juju/juju/internal/worker/sshserver ControllerConfigService,Authenticator,Authorizer,ProxyFactory,ProxyHandlers,TunnelTracker,AccessService
//
...
func (m *MockAccessService) HasSSHAccessToModel(arg0 context.Context, arg1 string, arg2 virtualhostname.Info) (bool, error) {
	m.ctrl.T.Helper()
	return gomock.Dispatch3_2(&m.recorder.hasSSHAccessToModelExpects, m.ctrl, m, "HasSSHAccessToModel", arg0, arg1, arg2)
}

// HasSSHAccessToModel indicates an expected call of HasSSHAccessToModel.
func (mr *MockAccessServiceMockRecorder) HasSSHAccessToModel(arg0, arg1, arg2 any) *MockAccessServiceHasSSHAccessToModelCall {
	mr.mock.ctrl.T.Helper()
	call := gomock.NewCall3_2[context.Context, string, virtualhostname.Info, bool, error](mr.mock.ctrl.T, mr.mock, "HasSSHAccessToModel", gomock.EnsureMatcher(arg0), gomock.EnsureMatcher(arg1), gomock.EnsureMatcher(arg2))
	mr.hasSSHAccessToModelExpects = append(mr.hasSSHAccessToModelExpects, call)
	mr.mock.ctrl.Track(call.Call)
	return call
}
