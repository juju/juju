...
//
//	mockgen -typed -package dbaccessor -destination package_mock_test.go github.com/juju/juju/internal/worker/dbaccessor Logger,DBApp,NodeManager,TrackedDB,Client,ClusterConfig
//
...
// Do rewrite *gomock.Call.Do
func (c *MockLoggerLogfCall) Do(f func(loggo.Level, string, ...any)) *MockLoggerLogfCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockLoggerLogfCall) DoAndReturn(f func(loggo.Level, string, ...any)) *MockLoggerLogfCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
