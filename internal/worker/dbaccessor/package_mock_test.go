...
// Source: github.com/juju/juju/internal/worker/dbaccessor (interfaces: Logger,DBApp,NodeManager,TrackedDB,Hub,Client,ClusterConfig)
//
// Generated by this command:
//
//	mockgen -package dbaccessor -destination package_mock_test.go github.com/juju/juju/internal/worker/dbaccessor Logger,DBApp,NodeManager,TrackedDB,Hub,Client,ClusterConfig
//
...
func (mr *MockTrackedDBMockRecorder) StdTxn(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClusterConfigMockRecorder) DBBindAddresses() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DBBindAddresses", reflect.TypeOf((*MockClusterConfig)(nil).DBBindAddresses))
}
