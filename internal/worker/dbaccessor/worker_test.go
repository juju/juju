...
func (s *workerSuite) TestWorkerStartupExistingNodeRemovesStaleMembers(c *gc.C) {
	...
	// Peer 777 exists in the current Dqlite cluster and should be removed
	// once API details indicate it is no longer part of controller topology.
