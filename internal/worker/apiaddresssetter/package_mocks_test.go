...
//
//	mockgen -package apiaddresssetter -destination internal/worker/apiaddresssetter/package_mocks_test.go github.com/juju/juju/internal/worker/apiaddresssetter ControllerConfigService,ApplicationService,ControllerNodeService,NetworkService,ModelService,DomainServices,ControllerDomainServices
//
...
func (m *MockControllerNodeService) SetSharedAPIAddresses(ctx context.Context, addresses controllernode.APIAddresses) error {
	m.ctrl.T.Helper()
...
func (mr *MockControllerNodeServiceMockRecorder) SetSharedAPIAddresses(ctx, addresses any) *MockControllerNodeServiceSetSharedAPIAddressesCall {
	mr.mock.ctrl.T.Helper()
...
// MockControllerNodeServiceSetSharedAPIAddressesCall is the typed call wrapper for SetSharedAPIAddresses.
type MockControllerNodeServiceSetSharedAPIAddressesCall = gomock.Call2_1[context.Context, controllernode.APIAddresses, error]
