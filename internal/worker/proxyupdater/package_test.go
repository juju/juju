...
//go:generate go run github.com/canonical/gomock/mockgen -package proxyupdater -destination gate_mock_test.go github.com/juju/juju/internal/worker/gate Unlocker
