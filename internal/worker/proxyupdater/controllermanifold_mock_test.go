...
// Source: github.com/juju/juju/internal/worker/proxyupdater (interfaces: ControllerDomainServices,DomainServices,ModelService,ModelConfigService,ControllerNodeService,ProxyReadyUnlocker)
//
// Generated by this command:
//
//	mockgen -package proxyupdater -destination controllermanifold_mock_test.go github.com/juju/juju/internal/worker/proxyupdater ControllerDomainServices,DomainServices,ModelService,ModelConfigService,ControllerNodeService,ProxyReadyUnlocker
//
...
// MockProxyReadyUnlocker is a mock of ProxyReadyUnlocker interface.
type MockProxyReadyUnlocker struct {
	ctrl     *gomock.Controller
	recorder *MockProxyReadyUnlockerMockRecorder
	isgomock struct{}
}

// MockProxyReadyUnlockerMockRecorder is the mock recorder for MockProxyReadyUnlocker.
type MockProxyReadyUnlockerMockRecorder struct {
	mock          *MockProxyReadyUnlocker
	unlockExpects []*gomock.Call0_0
}

// NewMockProxyReadyUnlocker creates a new mock instance.
func NewMockProxyReadyUnlocker(ctrl *gomock.Controller) *MockProxyReadyUnlocker {
	mock := &MockProxyReadyUnlocker{ctrl: ctrl}
	mock.recorder = &MockProxyReadyUnlockerMockRecorder{mock: mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProxyReadyUnlocker) EXPECT() *MockProxyReadyUnlockerMockRecorder {
	return m.recorder
}

// Unlock mocks base method.
func (m *MockProxyReadyUnlocker) Unlock() {
	m.ctrl.T.Helper()
	gomock.Dispatch0_0(&m.recorder.unlockExpects, m.ctrl, m, "Unlock")
}

// Unlock indicates an expected call of Unlock.
func (mr *MockProxyReadyUnlockerMockRecorder) Unlock() *MockProxyReadyUnlockerUnlockCall {
	mr.mock.ctrl.T.Helper()
...
// MockProxyReadyUnlockerUnlockCall is the typed call wrapper for Unlock.
type MockProxyReadyUnlockerUnlockCall = gomock.Call0_0
