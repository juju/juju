...
// Source: github.com/juju/juju/internal/worker/logsink (interfaces: ModelService)
//
// Generated by this command:
//
//	mockgen -typed -package logsink -destination services_mock_test.go github.com/juju/juju/internal/worker/logsink ModelService
//
...
func (m *MockModelService) Model(arg0 context.Context, arg1 model.UUID) (model.ModelInfo, error) {
	m.ctrl.T.Helper()
...
func (c *MockModelServiceModelCall) Do(f func(context.Context, model.UUID) (model.ModelInfo, error)) *MockModelServiceModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelServiceModelCall) DoAndReturn(f func(context.Context, model.UUID) (model.ModelInfo, error)) *MockModelServiceModelCall {
