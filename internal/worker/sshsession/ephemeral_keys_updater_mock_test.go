...
//
//	mockgen -package sshsession_test -destination ./ephemeral_keys_updater_mock_test.go github.com/juju/juju/internal/worker/authenticationworker EphemeralKeysUpdater
//
