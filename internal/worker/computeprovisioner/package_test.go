...
//go:generate go run go.uber.org/mock/mockgen -typed -package computeprovisioner_test -destination dependency_mock_test.go github.com/juju/worker/v5/dependency Getter
