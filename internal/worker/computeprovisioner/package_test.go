...
//go:generate go run go.uber.org/mock/mockgen -typed -package computeprovisioner_test -destination provisioner_mock_test.go github.com/juju/juju/internal/worker/computeprovisioner ControllerAPI,MachinesAPI
