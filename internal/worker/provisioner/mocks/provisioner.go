...
//
//	mockgen -typed -package mocks -destination mocks/provisioner.go github.com/juju/juju/internal/worker/provisioner ContainerMachine,ContainerMachineGetter,ContainerProvisionerAPI,ControllerAPI,MachinesAPI
//
...
// Return rewrite *gomock.Call.Return
func (c *MockContainerMachineGetterMachinesCall) Return(arg0 []provisioner0.ContainerMachineResult, arg1 error) *MockContainerMachineGetterMachinesCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockContainerMachineGetterMachinesCall) Do(f func(context.Context, ...names.MachineTag) ([]provisioner0.ContainerMachineResult, error)) *MockContainerMachineGetterMachinesCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockContainerMachineGetterMachinesCall) DoAndReturn(f func(context.Context, ...names.MachineTag) ([]provisioner0.ContainerMachineResult, error)) *MockContainerMachineGetterMachinesCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
