...
// workers for aborting claims and warning about stale importing or activating
...
// instruction. (Aborting claims are driven to completion by the reconciler;
// importing and activating need source/operator resolution.)
