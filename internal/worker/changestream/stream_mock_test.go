...
//
//	mockgen -package changestream -destination stream_mock_test.go github.com/juju/juju/internal/worker/changestream DBGetter,Logger,WatchableDBWorker,FileNotifyWatcher
//
...
func (mr *MockWatchableDBWorkerMockRecorder) StdTxn(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWatchableDBWorkerMockRecorder) Subscribe(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWatchableDBWorkerMockRecorder) Txn(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
