...
// Source: github.com/juju/juju/internal/worker/controlsocket (interfaces: AccessService,ControllerObjectStoreService)
//
// Generated by this command:
//
//	mockgen -typed -package controlsocket -destination services_mock_test.go github.com/juju/juju/internal/worker/controlsocket AccessService,ControllerObjectStoreService
//
...
func (m *MockControllerObjectStoreService) SetObjectStoreBackendToS3(arg0 context.Context, arg1 objectstore.S3Credentials) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetObjectStoreBackendToS3", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetObjectStoreBackendToS3 indicates an expected call of SetObjectStoreBackendToS3.
func (mr *MockControllerObjectStoreServiceMockRecorder) SetObjectStoreBackendToS3(arg0, arg1 any) *MockControllerObjectStoreServiceSetObjectStoreBackendToS3Call {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetObjectStoreBackendToS3", reflect.TypeOf((*MockControllerObjectStoreService)(nil).SetObjectStoreBackendToS3), arg0, arg1)
	return &MockControllerObjectStoreServiceSetObjectStoreBackendToS3Call{Call: call}
}

// MockControllerObjectStoreServiceSetObjectStoreBackendToS3Call wrap *gomock.Call
type MockControllerObjectStoreServiceSetObjectStoreBackendToS3Call struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockControllerObjectStoreServiceSetObjectStoreBackendToS3Call) Return(arg0 error) *MockControllerObjectStoreServiceSetObjectStoreBackendToS3Call {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockControllerObjectStoreServiceSetObjectStoreBackendToS3Call) Do(f func(context.Context, objectstore.S3Credentials) error) *MockControllerObjectStoreServiceSetObjectStoreBackendToS3Call {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockControllerObjectStoreServiceSetObjectStoreBackendToS3Call) DoAndReturn(f func(context.Context, objectstore.S3Credentials) error) *MockControllerObjectStoreServiceSetObjectStoreBackendToS3Call {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
