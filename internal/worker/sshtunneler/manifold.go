...
type ManifoldConfig struct {
	...
	// ClockName is the name of the clock dependency.
	ClockName string
...
func (config ManifoldConfig) start(ctx context.Context, getter dependency.Getter) (worker.Worker, error) {
	// sshtunneler is not enabled by default; it requires the SSHJump feature
	// flag.
	...
	return NewWorker(domainServicesGetter, config.GetSSHService, config.GetMachineService, controllerNodeService, clk)
}
