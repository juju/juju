...
//
//	mockgen -typed -package machineprovisioner_test -destination base_mock_test.go github.com/juju/juju/api/base APICaller
//

// Package machineprovisioner_test is a generated GoMock package.
