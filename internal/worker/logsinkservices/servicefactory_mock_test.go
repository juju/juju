...
// Source: github.com/juju/juju/internal/services (interfaces: LogSinkServices,LogSinkServicesGetter)
//
// Generated by this command:
//
//	mockgen -typed -package logsinkservices -destination servicefactory_mock_test.go github.com/juju/juju/internal/services LogSinkServices,LogSinkServicesGetter
//
...
// MockLogSinkServicesGetter is a mock of LogSinkServicesGetter interface.
type MockLogSinkServicesGetter struct {
	ctrl     *gomock.Controller
	recorder *MockLogSinkServicesGetterMockRecorder
}

// MockLogSinkServicesGetterMockRecorder is the mock recorder for MockLogSinkServicesGetter.
type MockLogSinkServicesGetterMockRecorder struct {
	mock *MockLogSinkServicesGetter
}

// NewMockLogSinkServicesGetter creates a new mock instance.
func NewMockLogSinkServicesGetter(ctrl *gomock.Controller) *MockLogSinkServicesGetter {
	mock := &MockLogSinkServicesGetter{ctrl: ctrl}
	mock.recorder = &MockLogSinkServicesGetterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockLogSinkServicesGetter) EXPECT() *MockLogSinkServicesGetterMockRecorder {
	return m.recorder
}

// ServicesForModel mocks base method.
func (m *MockLogSinkServicesGetter) ServicesForModel(arg0 model.UUID) services.LogSinkServices {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ServicesForModel", arg0)
	ret0, _ := ret[0].(services.LogSinkServices)
	return ret0
}

// ServicesForModel indicates an expected call of ServicesForModel.
func (mr *MockLogSinkServicesGetterMockRecorder) ServicesForModel(arg0 any) *MockLogSinkServicesGetterServicesForModelCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ServicesForModel", reflect.TypeOf((*MockLogSinkServicesGetter)(nil).ServicesForModel), arg0)
	return &MockLogSinkServicesGetterServicesForModelCall{Call: call}
}

// MockLogSinkServicesGetterServicesForModelCall wrap *gomock.Call
type MockLogSinkServicesGetterServicesForModelCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockLogSinkServicesGetterServicesForModelCall) Return(arg0 services.LogSinkServices) *MockLogSinkServicesGetterServicesForModelCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockLogSinkServicesGetterServicesForModelCall) Do(f func(model.UUID) services.LogSinkServices) *MockLogSinkServicesGetterServicesForModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockLogSinkServicesGetterServicesForModelCall) DoAndReturn(f func(model.UUID) services.LogSinkServices) *MockLogSinkServicesGetterServicesForModelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
