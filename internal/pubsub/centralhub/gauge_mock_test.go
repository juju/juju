...
//
//	mockgen -package centralhub -destination gauge_mock_test.go github.com/juju/juju/internal/pubsub/centralhub GaugeVec
//
...
func (mr *MockGaugeVecMockRecorder) Collect(arg0 any) *gomock.Call {
...
func (mr *MockGaugeVecMockRecorder) Describe(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGaugeVecMockRecorder) With(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
