...
// Source: github.com/juju/juju/internal/bootstrap (interfaces: AgentBinaryStorage,AgentBinaryStore,ControllerCharmDeployer,HTTPClient,Machine,MachineGetter,ApplicationService,ModelConfigService,Downloader,AgentPasswordService,ServiceManager)
//
// Generated by this command:
//
//	mockgen -typed -package bootstrap -destination bootstrap_mock_test.go github.com/juju/juju/internal/bootstrap AgentBinaryStorage,AgentBinaryStore,ControllerCharmDeployer,HTTPClient,Machine,MachineGetter,ApplicationService,ModelConfigService,Downloader,AgentPasswordService,ServiceManager
//
...
func (m *MockControllerCharmDeployer) AddControllerApplication(arg0 context.Context, arg1 DeployCharmInfo, arg2 string) error {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockControllerCharmDeployerAddControllerApplicationCall) Return(arg0 error) *MockControllerCharmDeployerAddControllerApplicationCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockControllerCharmDeployerAddControllerApplicationCall) Do(f func(context.Context, DeployCharmInfo, string) error) *MockControllerCharmDeployerAddControllerApplicationCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockControllerCharmDeployerAddControllerApplicationCall) DoAndReturn(f func(context.Context, DeployCharmInfo, string) error) *MockControllerCharmDeployerAddControllerApplicationCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// CompleteProcess mocks base method.
func (m *MockControllerCharmDeployer) CompleteProcess(arg0 context.Context, arg1 unit.Name) (network.ProviderAddresses, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockControllerCharmDeployerCompleteProcessCall) Return(arg0 network.ProviderAddresses, arg1 error) *MockControllerCharmDeployerCompleteProcessCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockControllerCharmDeployerCompleteProcessCall) Do(f func(context.Context, unit.Name) (network.ProviderAddresses, error)) *MockControllerCharmDeployerCompleteProcessCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockControllerCharmDeployerCompleteProcessCall) DoAndReturn(f func(context.Context, unit.Name) (network.ProviderAddresses, error)) *MockControllerCharmDeployerCompleteProcessCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
