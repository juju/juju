...
func (mr *MockLoggerFactoryMockRecorder) Child(arg0 any) *MockLoggerFactoryChildCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Child", reflect.TypeOf((*MockLoggerFactory)(nil).Child), arg0)
	return &MockLoggerFactoryChildCall{Call: call}
}

// MockLoggerFactoryChildCall wrap *gomock.Call
type MockLoggerFactoryChildCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockLoggerFactoryChildCall) Return(arg0 charmhub.Logger) *MockLoggerFactoryChildCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockLoggerFactoryChildCall) Do(f func(string) charmhub.Logger) *MockLoggerFactoryChildCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockLoggerFactoryChildCall) DoAndReturn(f func(string) charmhub.Logger) *MockLoggerFactoryChildCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (mr *MockLoggerFactoryMockRecorder) ChildWithTags(arg0 any, arg1 ...any) *MockLoggerFactoryChildWithTagsCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{arg0}, arg1...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChildWithTags", reflect.TypeOf((*MockLoggerFactory)(nil).ChildWithTags), varargs...)
	return &MockLoggerFactoryChildWithTagsCall{Call: call}
}

// MockLoggerFactoryChildWithTagsCall wrap *gomock.Call
type MockLoggerFactoryChildWithTagsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockLoggerFactoryChildWithTagsCall) Return(arg0 charmhub.Logger) *MockLoggerFactoryChildWithTagsCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockLoggerFactoryChildWithTagsCall) Do(f func(string, ...string) charmhub.Logger) *MockLoggerFactoryChildWithTagsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockLoggerFactoryChildWithTagsCall) DoAndReturn(f func(string, ...string) charmhub.Logger) *MockLoggerFactoryChildWithTagsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (mr *MockLoggerFactoryMockRecorder) ForNamespace(arg0 any) *MockLoggerFactoryForNamespaceCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForNamespace", reflect.TypeOf((*MockLoggerFactory)(nil).ForNamespace), arg0)
	return &MockLoggerFactoryForNamespaceCall{Call: call}
}

// MockLoggerFactoryForNamespaceCall wrap *gomock.Call
type MockLoggerFactoryForNamespaceCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockLoggerFactoryForNamespaceCall) Return(arg0 services.LoggerFactory) *MockLoggerFactoryForNamespaceCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockLoggerFactoryForNamespaceCall) Do(f func(string) services.LoggerFactory) *MockLoggerFactoryForNamespaceCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockLoggerFactoryForNamespaceCall) DoAndReturn(f func(string) services.LoggerFactory) *MockLoggerFactoryForNamespaceCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
