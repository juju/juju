...
type MockControllerCharmDeployerMockRecorder struct {
	...
	completeIAASProcessExpects          []*gomock.Call1_1[context.Context, error]
...
// CompleteIAASProcess mocks base method.
func (m *MockControllerCharmDeployer) CompleteIAASProcess(arg0 context.Context) error {
	m.ctrl.T.Helper()
	return gomock.Dispatch1_1(&m.recorder.completeIAASProcessExpects, m.ctrl, m, "CompleteIAASProcess", arg0)
}

// CompleteIAASProcess indicates an expected call of CompleteIAASProcess.
func (mr *MockControllerCharmDeployerMockRecorder) CompleteIAASProcess(arg0 any) *MockControllerCharmDeployerCompleteIAASProcessCall {
	mr.mock.ctrl.T.Helper()
	call := gomock.NewCall1_1[context.Context, error](mr.mock.ctrl.T, mr.mock, "CompleteIAASProcess", gomock.EnsureMatcher(arg0))
	mr.completeIAASProcessExpects = append(mr.completeIAASProcessExpects, call)
	mr.mock.ctrl.Track(call.Call)
	return call
}

// MockControllerCharmDeployerCompleteIAASProcessCall is the typed call wrapper for CompleteIAASProcess.
type MockControllerCharmDeployerCompleteIAASProcessCall = gomock.Call1_1[context.Context, error]
...
func (m *MockIAASApplicationService) MergeExposeSettings(ctx context.Context, appName string, exposedEndpoints map[string]application0.ExposedEndpoint) error {
	m.ctrl.T.Helper()
...
func (mr *MockIAASApplicationServiceMockRecorder) MergeExposeSettings(ctx, appName, exposedEndpoints any) *MockIAASApplicationServiceMergeExposeSettingsCall {
	mr.mock.ctrl.T.Helper()
...
// MockIAASApplicationServiceMergeExposeSettingsCall is the typed call wrapper for MergeExposeSettings.
type MockIAASApplicationServiceMergeExposeSettingsCall = gomock.Call3_1[context.Context, string, map[string]application0.ExposedEndpoint, error]
...
// MergeExposeSettings mocks base method.
func (m *MockCAASApplicationService) MergeExposeSettings(ctx context.Context, appName string, exposedEndpoints map[string]application0.ExposedEndpoint) error {
	m.ctrl.T.Helper()
	return gomock.Dispatch3_1(&m.recorder.mergeExposeSettingsExpects, m.ctrl, m, "MergeExposeSettings", ctx, appName, exposedEndpoints)
}

// MergeExposeSettings indicates an expected call of MergeExposeSettings.
func (mr *MockCAASApplicationServiceMockRecorder) MergeExposeSettings(ctx, appName, exposedEndpoints any) *MockCAASApplicationServiceMergeExposeSettingsCall {
	mr.mock.ctrl.T.Helper()
	call := gomock.NewCall3_1[context.Context, string, map[string]application0.ExposedEndpoint, error](mr.mock.ctrl.T, mr.mock, "MergeExposeSettings", gomock.EnsureMatcher(ctx), gomock.EnsureMatcher(appName), gomock.EnsureMatcher(exposedEndpoints))
	mr.mergeExposeSettingsExpects = append(mr.mergeExposeSettingsExpects, call)
	mr.mock.ctrl.Track(call.Call)
...
// MockCAASApplicationServiceMergeExposeSettingsCall is the typed call wrapper for MergeExposeSettings.
type MockCAASApplicationServiceMergeExposeSettingsCall = gomock.Call3_1[context.Context, string, map[string]application0.ExposedEndpoint, error]
