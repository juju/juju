...
// Source: github.com/juju/juju/internal/bootstrap (interfaces: AgentBinaryStore,ControllerCharmDeployer,HTTPClient,ApplicationService,IAASApplicationService,K8sApplicationService,ModelConfigService,Downloader,AgentPasswordService,ServiceManager)
//
// Generated by this command:
//
//	mockgen -package bootstrap -destination bootstrap_mock_test.go github.com/juju/juju/internal/bootstrap AgentBinaryStore,ControllerCharmDeployer,HTTPClient,ApplicationService,IAASApplicationService,K8sApplicationService,ModelConfigService,Downloader,AgentPasswordService,ServiceManager
//
...
// MockK8sApplicationService is a mock of K8sApplicationService interface.
type MockK8sApplicationService struct {
	ctrl     *gomock.Controller
	recorder *MockK8sApplicationServiceMockRecorder
	isgomock struct{}
}

// MockK8sApplicationServiceMockRecorder is the mock recorder for MockK8sApplicationService.
type MockK8sApplicationServiceMockRecorder struct {
	mock                         *MockK8sApplicationService
...
// NewMockK8sApplicationService creates a new mock instance.
func NewMockK8sApplicationService(ctrl *gomock.Controller) *MockK8sApplicationService {
	mock := &MockK8sApplicationService{ctrl: ctrl}
	mock.recorder = &MockK8sApplicationServiceMockRecorder{mock: mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockK8sApplicationService) EXPECT() *MockK8sApplicationServiceMockRecorder {
	return m.recorder
}

// CreateCAASApplication mocks base method.
func (m *MockK8sApplicationService) CreateCAASApplication(arg0 context.Context, arg1 string, arg2 charm0.Charm, arg3 charm.Origin, arg4 service.AddApplicationArgs, arg5 ...service.AddUnitArg) (application.UUID, error) {
	m.ctrl.T.Helper()
...
func (mr *MockK8sApplicationServiceMockRecorder) CreateCAASApplication(arg0, arg1, arg2, arg3, arg4 any, arg5 ...any) *MockK8sApplicationServiceCreateCAASApplicationCall {
	mr.mock.ctrl.T.Helper()
	varArgs := gomock.EnsureVariadicMatcher(arg5)
...
// MockK8sApplicationServiceCreateCAASApplicationCall is the typed call wrapper for CreateCAASApplication.
type MockK8sApplicationServiceCreateCAASApplicationCall = gomock.Call5V_2[context.Context, string, charm0.Charm, charm.Origin, service.AddApplicationArgs, service.AddUnitArg, application.UUID, error]

// UpdateCAASUnit mocks base method.
func (m *MockK8sApplicationService) UpdateCAASUnit(ctx context.Context, unitName unit.Name, params service.UpdateCAASUnitParams) error {
	m.ctrl.T.Helper()
...
func (mr *MockK8sApplicationServiceMockRecorder) UpdateCAASUnit(ctx, unitName, params any) *MockK8sApplicationServiceUpdateCAASUnitCall {
	mr.mock.ctrl.T.Helper()
...
// MockK8sApplicationServiceUpdateCAASUnitCall is the typed call wrapper for UpdateCAASUnit.
type MockK8sApplicationServiceUpdateCAASUnitCall = gomock.Call3_1[context.Context, unit.Name, service.UpdateCAASUnitParams, error]

// UpdateK8sService mocks base method.
func (m *MockK8sApplicationService) UpdateK8sService(ctx context.Context, appName, providerID string, sAddrs network.ProviderAddresses) error {
	m.ctrl.T.Helper()
	return gomock.Dispatch4_1(&m.recorder.updateK8sServiceExpects, m.ctrl, m, "UpdateK8sService", ctx, appName, providerID, sAddrs)
}

// UpdateK8sService indicates an expected call of UpdateK8sService.
func (mr *MockK8sApplicationServiceMockRecorder) UpdateK8sService(ctx, appName, providerID, sAddrs any) *MockK8sApplicationServiceUpdateK8sServiceCall {
	mr.mock.ctrl.T.Helper()
	call := gomock.NewCall4_1[context.Context, string, string, network.ProviderAddresses, error](mr.mock.ctrl.T, mr.mock, "UpdateK8sService", gomock.EnsureMatcher(ctx), gomock.EnsureMatcher(appName), gomock.EnsureMatcher(providerID), gomock.EnsureMatcher(sAddrs))
	mr.updateK8sServiceExpects = append(mr.updateK8sServiceExpects, call)
	mr.mock.ctrl.Track(call.Call)
...
// MockK8sApplicationServiceUpdateK8sServiceCall is the typed call wrapper for UpdateK8sService.
type MockK8sApplicationServiceUpdateK8sServiceCall = gomock.Call4_1[context.Context, string, string, network.ProviderAddresses, error]
