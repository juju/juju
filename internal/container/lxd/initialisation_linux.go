...
//go:generate go run github.com/canonical/gomock/mockgen -package mocks -destination mocks/snap_manager_mock.go github.com/juju/juju/internal/container/lxd SnapManager
