...
//
//	mockgen -typed -package snap -destination runnable_mock_test.go github.com/juju/juju/internal/service/snap Runnable
//
...
// MockRunnableExecuteCall wrap *gomock.Call
type MockRunnableExecuteCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockRunnableExecuteCall) Return(arg0 string, arg1 error) *MockRunnableExecuteCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRunnableExecuteCall) Do(f func(string, ...string) (string, error)) *MockRunnableExecuteCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRunnableExecuteCall) DoAndReturn(f func(string, ...string) (string, error)) *MockRunnableExecuteCall {
