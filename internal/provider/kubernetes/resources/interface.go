...
//go:generate go run go.uber.org/mock/mockgen -typed -package mocks -destination mocks/resources_mock.go github.com/juju/juju/internal/provider/kubernetes/resources Resource,Applier
