...
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination mocks/sizequeue_mock.go github.com/juju/juju/caas/kubernetes/provider/exec SizeGetter
