...
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination ./mocks/parsers_mock.go github.com/juju/juju/internal/provider/kubernetes/specs PodSpecConverter
func parsePodSpec(
	in string,
