...
func (cs *controllerStack) GetControllerRuntimeConfigContent(c *tc.C) string {
	runtimeCfg := controllerruntimeconfig.ControllerRuntimeConfig{
		...
		DataDir:                cs.pcfg.DataDir + "/controller",
		IsK8SController:        true,
		SocketDir:              cs.pcfg.DataDir + "/controller/sockets",
		SharedAgentDir:         cs.pcfg.DataDir + "/controller",
		...
		LokiEndpoint:           cs.agentConfig.LokiEndpoint(),
		LokiCACert:             cs.agentConfig.LokiCACert(),
		LokiInsecureSkipVerify: cs.agentConfig.LokiInsecureSkipVerify(),
		LokiOrgID:              cs.agentConfig.LokiOrgID(),
