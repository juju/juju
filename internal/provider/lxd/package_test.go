...
//go:generate go run github.com/canonical/gomock/mockgen -package lxd -destination package_mock_test.go github.com/juju/juju/internal/provider/lxd Server,ServerFactory,InterfaceAddress,CertificateReadWriter,CertificateGenerator,LXCConfigReader
//go:generate go run github.com/canonical/gomock/mockgen -package lxd -destination environs_mock_test.go github.com/juju/juju/environs CredentialInvalidator
