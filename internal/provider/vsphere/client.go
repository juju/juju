...
//go:generate go run github.com/canonical/gomock/mockgen -package mocks -destination mocks/client_mock.go github.com/juju/juju/internal/provider/vsphere Client
func dialClient(
	ctx context.Context,
