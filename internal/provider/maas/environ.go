...
// NewEnviron creates a new MAAS environment.
func NewEnviron(ctx context.Context, cloud environscloudspec.CloudSpec, cfg *config.Config, invalidator environs.CredentialInvalidator) (*maasEnviron, error) {
	env := &maasEnviron{
		name:                  cfg.Name(),
		uuid:                  cfg.UUID(),
