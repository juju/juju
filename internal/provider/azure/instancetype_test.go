...
func (s *InstanceTypeSuite) TestStandard(c *tc.C) {
	vm := armcompute.VirtualMachineSize{
		Name:           new("Standard_A2"),
		MemoryInMB:     new(int32(100)),
		NumberOfCores:  new(int32(2)),
		OSDiskSizeInMB: new(int32(1024 * 1024)),
	}
