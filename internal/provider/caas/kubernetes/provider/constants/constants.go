...
const (
	...
	// NOTE: 170 uid/gid must be updated here and in internal/provider/caas/Dockerfile and internal/provider/caas/scripts.go
	JujuUserID = 170
	...
	// NOTE: 171 uid/gid must be updated here and in internal/provider/caas/Dockerfile
	JujuSudoUserID = 171
