...
func (s *cinderVolumeSourceSuite) TestDestroyVolumes(c *tc.C) {
	...
	mockAdaptor.CheckCalls(c, []testhelpers.StubCall{
		{"GetVolume", []any{mockVolId}},
		{"DeleteVolume", []any{mockVolId}},
	})
}
...
func (s *cinderVolumeSourceSuite) TestReleaseVolumes(c *tc.C) {
	...
	mockAdaptor.CheckCalls(c, []testhelpers.StubCall{
		{"GetVolume", []any{mockVolId}},
		{"SetVolumeMetadata", []any{mockVolId, metadata}},
	})
}
...
func (s *cinderVolumeSourceSuite) TestDetachVolumes(c *tc.C) {
	...
	mockAdaptor.CheckCalls(c, []testhelpers.StubCall{
		{"DetachVolume", []any{mockServerId, mockVolId}},
		{"DetachVolume", []any{mockServerId2, "42"}},
	})
}
...
func (s *cinderVolumeSourceSuite) TestImportVolume(c *tc.C) {
	...
	info, err := volSource.(storage.VolumeImporter).ImportVolume(c.Context(), mockVolId, "", tags, false)
	c.Assert(err, tc.ErrorIsNil)
	...
	mockAdaptor.CheckCalls(c, []testhelpers.StubCall{
		{"GetVolume", []any{mockVolId}},
		{"SetVolumeMetadata", []any{mockVolId, tags}},
	})
}
...
func (s *cinderVolumeSourceSuite) TestImportVolumeInUse(c *tc.C) {
	...
	volSource := openstack.NewCinderVolumeSource(mockAdaptor, s.env, s.invalidator)
	_, err := volSource.(storage.VolumeImporter).ImportVolume(c.Context(), mockVolId, "", nil, false)
...
func (ma *mockAdaptor) DeleteAttachment(attachmentId string) error {
...
func (s *cinderVolumeSourceSuite) TestDestroyVolumesDeleteAttachmentOrphaned(c *tc.C) {
	...
	c.Assert(err, tc.ErrorIsNil)
	c.Assert(errs, tc.DeepEquals, []error{nil})
	mockAdaptor.CheckCallNames(c,
		"GetVolume", "DetachVolume", "DeleteAttachment", "GetVolume", "DeleteVolume")
}

func (s *cinderVolumeSourceSuite) TestDestroyVolumesDeleteAttachmentForbidden(c *tc.C) {
	s.assertDestroyVolumesDeleteAttachmentFallback(
		c, gooseerrors.NewForbiddenf(nil, nil, "forbidden"),
	)
}

func (s *cinderVolumeSourceSuite) TestDestroyVolumesDeleteAttachmentNotImplemented(c *tc.C) {
	s.assertDestroyVolumesDeleteAttachmentFallback(
		c, gooseerrors.NewNotImplementedf(nil, nil, "not implemented"),
	)
}

func (s *cinderVolumeSourceSuite) assertDestroyVolumesDeleteAttachmentFallback(c *tc.C, deleteErr error) {
	attempted := false
	mockAdaptor := &mockAdaptor{
		getVolume: func(volId string) (*cinder.Volume, error) {
			if attempted {
...
func (s *cinderVolumeSourceSuite) TestDestroyVolumesSkipsEmptyAttachmentId(c *tc.C) {
	getVolumeCalls := 0
	...
	c.Assert(err, tc.ErrorIsNil)
	c.Assert(errs, tc.DeepEquals, []error{nil})
	c.Assert(deletedAttachmentIds, tc.DeepEquals, []string{"att-1"})
}

func (s *cinderVolumeSourceSuite) TestDestroyVolumesDeleteAttachmentConflict(c *tc.C) {
