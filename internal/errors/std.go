...
// IsOf reports whether any error in err's tree matches one of the target
...
//
// IsOf is the same as writing Is(err, type1) || Is(err, type2) || Is(err, type3)
func IsOf(err error, targets ...error) bool {
