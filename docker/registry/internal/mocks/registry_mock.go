...
//
//	mockgen -package mocks -destination mocks/registry_mock.go github.com/juju/juju/docker/registry/internal Initializer
//
...
func (mr *MockInitializerMockRecorder) WrapTransport(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
