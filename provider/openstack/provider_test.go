...
var addressTests = []struct {
	...
	private:  []nova.IPAddress{{4, "192.168.0.1", "private"}},
	networks: []string{"private"},
	expected: "192.168.0.1",
}, {
	summary:  "private IPv6 only",
	private:  []nova.IPAddress{{6, "fc00::1", "private"}},
	networks: []string{"private"},
	expected: "fc00::1",
}, {
	summary:  "private only, both IPv4 and IPv6",
	private:  []nova.IPAddress{{4, "192.168.0.1", "private"}, {6, "fc00::1", "private"}},
	networks: []string{"private"},
	expected: "192.168.0.1",
}, {
	summary:  "private only, both IPv6 and IPv4",
	private:  []nova.IPAddress{{6, "fc00::1", "private"}, {4, "192.168.0.1", "private"}},
	networks: []string{"private"},
	expected: "fc00::1",
}, {
	summary:  "private IPv4 plus (what HP cloud used to do)",
	private:  []nova.IPAddress{{4, "10.0.0.1", "private"}, {4, "8.8.4.4", "private"}},
	networks: []string{"private"},
	expected: "8.8.4.4",
}, {
	summary:  "public IPv4 only",
	public:   []nova.IPAddress{{4, "8.8.8.8", "private"}},
	networks: []string{"", "public"},
	expected: "8.8.8.8",
}, {
	summary:  "public IPv6 only",
	public:   []nova.IPAddress{{6, "2001:db8::1", "private"}},
	networks: []string{"", "public"},
	expected: "2001:db8::1",
}, {
	summary:  "public only, both IPv4 and IPv6",
	public:   []nova.IPAddress{{4, "8.8.8.8", "private"}, {6, "2001:db8::1", "private"}},
	networks: []string{"", "public"},
	expected: "8.8.8.8",
}, {
	summary:  "public only, both IPv6 and IPv4",
	public:   []nova.IPAddress{{6, "2001:db8::1", "private"}, {4, "8.8.8.8", "private"}},
	networks: []string{"", "public"},
	expected: "2001:db8::1",
}, {
	summary:  "public and private both IPv4",
	private:  []nova.IPAddress{{4, "10.0.0.4", "private"}},
	public:   []nova.IPAddress{{4, "8.8.4.4", "private"}},
	...
	private:  []nova.IPAddress{{4, "127.0.0.4", "private"}, {4, "192.168.0.1", "private"}},
	public:   []nova.IPAddress{{4, "8.8.8.8", "private"}},
	networks: []string{"private", "public"},
	expected: "8.8.8.8",
}, {
	summary:  "public, private, and localhost IPv6",
	private:  []nova.IPAddress{{6, "::1", "private"}, {6, "fc00::1", "private"}},
	public:   []nova.IPAddress{{6, "2001:db8::1", "private"}},
	networks: []string{"private", "public"},
	expected: "2001:db8::1",
}, {
	summary:  "public, private, and localhost - both IPv4 and IPv6",
	private:  []nova.IPAddress{{4, "127.0.0.4", "private"}, {4, "192.168.0.1", "private"}, {6, "::1", "private"}, {6, "fc00::1", "private"}},
	public:   []nova.IPAddress{{4, "8.8.8.8", "private"}, {6, "2001:db8::1", "private"}},
	networks: []string{"private", "public"},
	expected: "8.8.8.8",
}, {
	summary:  "public, private, and localhost - both IPv6 and IPv4",
	private:  []nova.IPAddress{{6, "::1", "private"}, {6, "fc00::1", "private"}, {4, "127.0.0.4", "private"}, {4, "192.168.0.1", "private"}},
	public:   []nova.IPAddress{{6, "2001:db8::1", "private"}, {4, "8.8.8.8", "private"}},
	networks: []string{"private", "public"},
	expected: "2001:db8::1",
}, {
	...
	private:  []nova.IPAddress{{4, "172.16.0.1", "private"}},
	public:   []nova.IPAddress{{4, "8.8.8.8", "private"}},
	...
	private:  []nova.IPAddress{{4, "172.16.0.1", "private"}, {6, "fc00::1", "private"}},
	public:   []nova.IPAddress{{4, "8.8.8.8", "private"}, {6, "2001:db8::1", "private"}},
	networks: []string{"special", "public"},
	expected: "8.8.8.8",
}, {
	summary:  "custom and public - both IPv6 and IPv4",
	private:  []nova.IPAddress{{6, "fc00::1", "private"}, {4, "172.16.0.1", "private"}},
	public:   []nova.IPAddress{{6, "2001:db8::1", "private"}, {4, "8.8.8.8", "private"}},
	networks: []string{"special", "public"},
	expected: "2001:db8::1",
}, {
	...
	floatingIP: "8.8.4.4",
	private:    []nova.IPAddress{{4, "10.0.0.1", "private"}},
	networks:   []string{"private"},
	expected:   "8.8.4.4",
}, {
