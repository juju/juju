...
local:
    ...
    # Override the directory that is used for the storage files and
    # database. The default location is $JUJU_HOME/<ENV>.
    # $JUJU_HOME defaults to ~/.juju
    #
    # root-dir: ~/.juju/local

    # Override the storage port if you have multiple local providers,
    # or if the default port is used by another program.
    #
    # storage-port: 8040

    # Override the network bridge if you have changed the default lxc
    # bridge
    #
