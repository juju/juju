...
func (env *joyentEnviron) getSupportedArchitectures(knownArchitectures []string) ([]string, error) {
	cfg := env.Ecfg()
	...
	return common.SupportedArchitectures(env, imageConstraint, knownArchitectures)
}
