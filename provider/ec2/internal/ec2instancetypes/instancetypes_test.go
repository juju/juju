...
func (s *InstanceTypesSuite) TestRegionInstanceTypesAvailability(c *gc.C) {
	...
	c.Assert(
		...
		jc.DeepEquals,
		[]string{
			"a1.2xlarge", "a1.4xlarge", "a1.large", "a1.medium", "a1.metal",
			"a1.xlarge", "cc2.8xlarge", "cr1.8xlarge", "h1.16xlarge", "h1.2xlarge",
			"h1.4xlarge", "h1.8xlarge", "hs1.8xlarge", "inf1.24xlarge", "inf1.2xlarge",
			"inf1.6xlarge", "inf1.xlarge", "m5dn.12xlarge", "m5dn.16xlarge", "m5dn.24xlarge",
			"m5dn.2xlarge", "m5dn.4xlarge", "m5dn.8xlarge", "m5dn.large", "m5dn.xlarge",
			"m5n.12xlarge", "m5n.16xlarge", "m5n.24xlarge", "m5n.2xlarge", "m5n.4xlarge",
			"m5n.8xlarge", "m5n.large", "m5n.xlarge", "m6g.12xlarge", "m6g.16xlarge",
			"m6g.2xlarge", "m6g.4xlarge", "m6g.8xlarge", "m6g.large", "m6g.medium",
			"m6g.xlarge", "p2.16xlarge", "p2.8xlarge", "p2.xlarge", "p3.16xlarge",
			"p3.2xlarge", "p3.8xlarge", "p3dn.24xlarge", "r5dn.12xlarge", "r5dn.16xlarge",
			...
			"r5n.4xlarge", "r5n.8xlarge", "r5n.large", "r5n.xlarge", "x1.16xlarge",
			"x1.32xlarge", "x1e.16xlarge", "x1e.2xlarge", "x1e.32xlarge", "x1e.4xlarge",
