...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination ../testing/mocks_clientcompute.go -write_package_comment=false github.com/juju/juju/provider/oci/common OCIComputeClient
...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination ../testing/mocks_clientnetworking.go -write_package_comment=false github.com/juju/juju/provider/oci/common OCIVirtualNetworkingClient
...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination ../testing/mocks_clientstorage.go -write_package_comment=false github.com/juju/juju/provider/oci/common OCIStorageClient
