...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination testing/mocks_identity.go -write_package_comment=false github.com/juju/juju/provider/oci IdentityClient
...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination testing/mocks_compute.go -write_package_comment=false github.com/juju/juju/provider/oci ComputeClient
...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination testing/mocks_networking.go -write_package_comment=false github.com/juju/juju/provider/oci NetworkingClient
...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination testing/mocks_firewall.go -write_package_comment=false github.com/juju/juju/provider/oci FirewallClient
...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination testing/mocks_storage.go -write_package_comment=false github.com/juju/juju/provider/oci StorageClient
