...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination testing/mocks_identity.go github.com/juju/juju/provider/oci IdentityClient
...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination testing/mocks_compute.go github.com/juju/juju/provider/oci ComputeClient
type ComputeClient interface {
	PaginatedListVnicAttachments(ctx context.Context, compartmentID, instID *string) ([]ociCore.VnicAttachment, error)
	...
	PaginatedListInstances(ctx context.Context, compartmentID *string) ([]ociCore.Instance, error)
	PaginatedListShapes(ctx context.Context, compartmentID, imageID *string) ([]ociCore.Shape, error)
	PaginatedListImages(ctx context.Context, compartmentID *string) ([]ociCore.Image, error)
	PaginatedListVolumeAttachments(ctx context.Context, compartmentID, instID *string) ([]ociCore.VolumeAttachment, error)
...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination testing/mocks_networking.go github.com/juju/juju/provider/oci NetworkingClient
type NetworkingClient interface {
	...
	PaginatedListVcns(ctx context.Context, compartmentID *string) ([]ociCore.Vcn, error)
	...
	PaginatedListSubnets(ctx context.Context, compartmentID, vcnID *string) ([]ociCore.Subnet, error)
	...
	PaginatedListInternetGateways(ctx context.Context, compartmentID, vcnID *string) ([]ociCore.InternetGateway, error)
	...
	PaginatedListRouteTables(ctx context.Context, compartmentID, vcnID *string) ([]ociCore.RouteTable, error)

	GetVnic(ctx context.Context, request ociCore.GetVnicRequest) (ociCore.GetVnicResponse, error)
}

//go:generate go run github.com/golang/mock/mockgen -package testing -destination testing/mocks_firewall.go github.com/juju/juju/provider/oci FirewallClient
type FirewallClient interface {
	...
	PaginatedListSecurityLists(ctx context.Context, compartmentID, vcnID *string) ([]ociCore.SecurityList, error)
...
//go:generate go run github.com/golang/mock/mockgen -package testing -destination testing/mocks_storage.go github.com/juju/juju/provider/oci StorageClient
type StorageClient interface {
	CreateVolume(ctx context.Context, request ociCore.CreateVolumeRequest) (ociCore.CreateVolumeResponse, error)
	PaginatedListVolumes(ctx context.Context, compartmentID *string) ([]ociCore.Volume, error)
