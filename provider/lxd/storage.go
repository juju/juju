...
func (s *lxdFilesystemSource) performFilesystemOperation(ctx context.ProviderCallContext, args []storage.FilesystemAttachmentParams, op filesystemOperation) ([]error, error) {
