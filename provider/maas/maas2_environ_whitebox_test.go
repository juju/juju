...
func (suite *maas2EnvironSuite) TestStartInstanceNetworkInterfaces(c *gc.C) {
	...
	expected := []network.InterfaceInfo{{
		...
		NoAutoStart:       false,
		ConfigType:        "static",
		Address:           corenetwork.NewProviderAddressInSpace("default", "10.20.19.103"),
		...
		NoAutoStart:       false,
		ConfigType:        "static",
		Address:           corenetwork.NewProviderAddressInSpace("default", "10.20.19.104"),
		DNSServers:        corenetwork.NewProviderAddressesInSpace("default", "10.20.19.2", "10.20.19.3"),
		DNSSearchDomains:  nil,
		MTU:               1500,
		GatewayAddress:    corenetwork.NewProviderAddressInSpace("default", "10.20.19.2"),
		...
		NoAutoStart:         false,
		ConfigType:          "static",
		Address:             corenetwork.NewProviderAddressInSpace("admin", "10.50.19.103"),
		DNSServers:          nil,
		DNSSearchDomains:    nil,
		MTU:                 1500,
...
func (suite *maas2EnvironSuite) TestAllocateContainerAddressesSingleNic(c *gc.C) {
	...
	expected := []network.InterfaceInfo{{
		...
		InterfaceType:     "ethernet",
		ConfigType:        "static",
		Address:           corenetwork.NewProviderAddressInSpace("freckles", "192.168.1.127"),
...
func (suite *maas2EnvironSuite) TestAllocateContainerAddressesNoStaticRoutesAPI(c *gc.C) {
	...
	expected := []network.InterfaceInfo{{
		...
		InterfaceType:     "ethernet",
		ConfigType:        "static",
		Address:           corenetwork.NewProviderAddressInSpace("freckles", "10.20.19.104"),
		DNSServers:        corenetwork.NewProviderAddressesInSpace("freckles", "10.20.19.2", "10.20.19.3"),
		MTU:               1500,
...
func (suite *maas2EnvironSuite) TestAllocateContainerAddressesDualNic(c *gc.C) {
	...
	expected := []network.InterfaceInfo{{
		...
		InterfaceType:     "ethernet",
		ConfigType:        "static",
		Address:           corenetwork.NewProviderAddressInSpace("freckles", "10.20.19.127"),
		DNSServers:        corenetwork.NewProviderAddressesInSpace("freckles", "10.20.19.2", "10.20.19.3"),
		MTU:               1500,
		GatewayAddress:    corenetwork.NewProviderAddressInSpace("freckles", "10.20.19.2"),
	}, {
...
func (suite *maas2EnvironSuite) TestAllocateContainerReuseExistingDevice(c *gc.C) {
	...
	expected := []network.InterfaceInfo{{
		...
		InterfaceType:     "ethernet",
		ConfigType:        "static",
		Address:           corenetwork.NewProviderAddressInSpace("space-1", "10.20.19.105"),
...
func (suite *maas2EnvironSuite) TestAllocateContainerRefusesReuseInvalidNIC(c *gc.C) {
	...
	expected := []network.InterfaceInfo{{
		...
		InterfaceType:     "ethernet",
		ConfigType:        "static",
		Address:           corenetwork.NewProviderAddressInSpace("freckles", "10.20.19.105"),
		DNSServers:        corenetwork.NewProviderAddressesInSpace("freckles", "10.20.19.2", "10.20.19.3"),
		MTU:               1500,
		GatewayAddress:    corenetwork.NewProviderAddressInSpace("freckles", "10.20.19.2"),
		Routes:            []network.Route{},
		...
		InterfaceType:     "ethernet",
		ConfigType:        "static",
		Address:           corenetwork.NewProviderAddressInSpace("freckles", "192.168.1.101"),
