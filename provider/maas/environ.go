...
func (environ *maasEnviron) StartInstance(args environs.StartInstanceParams) (
	*environs.StartInstanceResult, error,
	...
	if environ.supportsNetworkDeploymentUbuntu {
		// Use the new 1.9 MAAS API when available.
		interfaces, err = inst.interfaces()
	} else {
...
func (environ *maasEnviron) newCloudinitConfig(hostname, ser string) (cloudinit.CloudConfig, error) {
