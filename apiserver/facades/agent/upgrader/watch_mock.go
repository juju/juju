...
// WatchApplicationTargetAgentVersion mocks base method.
func (m *MockModelAgentService) WatchApplicationTargetAgentVersion(arg0 context.Context, arg1 string) (watcher.Watcher[struct{}], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WatchApplicationTargetAgentVersion", arg0, arg1)
	ret0, _ := ret[0].(watcher.Watcher[struct{}])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// WatchApplicationTargetAgentVersion indicates an expected call of WatchApplicationTargetAgentVersion.
func (mr *MockModelAgentServiceMockRecorder) WatchApplicationTargetAgentVersion(arg0, arg1 any) *MockModelAgentServiceWatchApplicationTargetAgentVersionCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WatchApplicationTargetAgentVersion", reflect.TypeOf((*MockModelAgentService)(nil).WatchApplicationTargetAgentVersion), arg0, arg1)
	return &MockModelAgentServiceWatchApplicationTargetAgentVersionCall{Call: call}
}

// MockModelAgentServiceWatchApplicationTargetAgentVersionCall wrap *gomock.Call
type MockModelAgentServiceWatchApplicationTargetAgentVersionCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockModelAgentServiceWatchApplicationTargetAgentVersionCall) Return(arg0 watcher.Watcher[struct{}], arg1 error) *MockModelAgentServiceWatchApplicationTargetAgentVersionCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelAgentServiceWatchApplicationTargetAgentVersionCall) Do(f func(context.Context, string) (watcher.Watcher[struct{}], error)) *MockModelAgentServiceWatchApplicationTargetAgentVersionCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelAgentServiceWatchApplicationTargetAgentVersionCall) DoAndReturn(f func(context.Context, string) (watcher.Watcher[struct{}], error)) *MockModelAgentServiceWatchApplicationTargetAgentVersionCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
