...
// Source: github.com/juju/juju/apiserver/facades/agent/uniter (interfaces: ApplicationService,ResolveService,StatusService,RelationService,ModelInfoService,MachineService,NetworkService,OperationService,PortService,RemovalService,StorageProvisioningService,BlockDeviceService,CrossModelRelationService,UnitStateService)
//
// Generated by this command:
//
//	mockgen -typed -package uniter -destination service_mock_test.go github.com/juju/juju/apiserver/facades/agent/uniter ApplicationService,ResolveService,StatusService,RelationService,ModelInfoService,MachineService,NetworkService,OperationService,PortService,RemovalService,StorageProvisioningService,BlockDeviceService,CrossModelRelationService,UnitStateService
//
