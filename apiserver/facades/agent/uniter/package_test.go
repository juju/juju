...
//go:generate go run github.com/canonical/gomock/mockgen -package uniter -destination clock_mock_test.go github.com/juju/clock Clock
//go:generate go run github.com/canonical/gomock/mockgen -package uniter -destination secret_mocks_test.go github.com/juju/juju/apiserver/facades/agent/uniter SecretService
//go:generate go run github.com/canonical/gomock/mockgen -package uniter_test -destination legacy_service_mock_test.go github.com/juju/juju/apiserver/facades/agent/uniter ModelConfigService,ModelInfoService,MachineService
//go:generate go run github.com/canonical/gomock/mockgen -package uniter_test -destination facade_mock_test.go github.com/juju/juju/internal/worker/watcherregistry WatcherRegistry
//go:generate go run github.com/canonical/gomock/mockgen -package uniter -destination service_mock_test.go github.com/juju/juju/apiserver/facades/agent/uniter ApplicationService,ResolveService,StatusService,RelationService,ModelInfoService,MachineService,NetworkService,OperationService,PortService,RemovalService,StorageProvisioningService,BlockDeviceService,CrossModelRelationService,UnitStateService,ControllerNodeService,TracingService
//go:generate go run github.com/canonical/gomock/mockgen -package uniter -destination watcher_registry_mock_test.go github.com/juju/juju/internal/worker/watcherregistry WatcherRegistry
//go:generate go run github.com/canonical/gomock/mockgen -package uniter -destination apiserver_mock_test.go github.com/juju/juju/apiserver/common APIAddressAccessor
//go:generate go run github.com/canonical/gomock/mockgen -package uniter -destination relation_mock_test.go github.com/juju/juju/domain/relation RelationUnitsWatcher
//go:generate go run github.com/canonical/gomock/mockgen -package uniter -destination watcher_mock_test.go github.com/juju/juju/core/watcher NotifyWatcher
