...
func (s *unitMetricBatchesSuite) setupMocks(c *gc.C) *gomock.Controller {
...
func (s *unitMetricBatchesSuite) TestModelConfig(c *gc.C) {
	defer s.setupMocks(c).Finish()

	s.ModelWatcherTest.TestModelConfig(c)
}

func (s *unitMetricBatchesSuite) TestWatchForModelConfigChanges(c *gc.C) {
	defer s.setupMocks(c).Finish()

	s.ModelWatcherTest.TestWatchForModelConfigChanges(c)
}
