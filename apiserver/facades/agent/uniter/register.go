...
// NewUniterFacade creates a new instance of the core Uniter API.
func NewUniterFacade(context facade.Context) (*UniterAPI, error) {
	...
	msAPI, err := meterstatus.NewMeterStatusAPI(st, resources, authorizer, context.Logger().Child("meterstatus"), ctrlConfigService)
	if err != nil {
	...
	return NewUniterAPI(
		...
		common.NewExternalUnitStateAPI(st, resources, authorizer, accessUnit, logger, ctrlConfigService),
		secretsAPI,
