...
//go:generate go run go.uber.org/mock/mockgen -package machine_test -destination package_mock_test.go github.com/juju/juju/apiserver/facades/agent/machine SpaceService
