...
//go:generate go run go.uber.org/mock/mockgen -typed -package migrationminion_test -destination mocks_test.go github.com/juju/juju/apiserver/facades/agent/migrationminion ModelMigrationService
