...
func (s *SecretsDrainSuite) TestCanManageOwnerUnit(c *gc.C) {
...
func (s *SecretsDrainSuite) TestCanManageLeaderUnitAppSecret(c *gc.C) {
	s.authTag = names.NewUnitTag("mariadb/0")
	defer s.setup(c).Finish()
...
func (s *SecretsDrainSuite) TestCanManageAppTagLogin(c *gc.C) {
