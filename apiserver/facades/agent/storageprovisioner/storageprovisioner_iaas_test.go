...
func (s *iaasProvisionerSuite) TestNewStorageProvisionerAPINonMachine(c *gc.C) {
...
func (s *iaasProvisionerSuite) TestVolumesEmptyArgs(c *gc.C) {
	defer s.setupMocks(c).Finish()
...
func (s *iaasProvisionerSuite) TestVolumeParamsEmptyArgs(c *gc.C) {
	defer s.setupMocks(c).Finish()
