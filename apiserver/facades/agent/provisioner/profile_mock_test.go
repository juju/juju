...
func (m *MockProfileMachine) UpgradeCharmProfileApplication() string {
...
func (m *MockProfileMachine) UpgradeCharmProfileCharmURL() string {
...
func (m *MockProfileBackend) Charm(arg0 *charm_v6.URL) (ProfileCharm, error) {
	ret := m.ctrl.Call(m, "Charm", arg0)
	ret0, _ := ret[0].(ProfileCharm)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
