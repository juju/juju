...
//go:generate go run go.uber.org/mock/mockgen -typed -package provisioner -destination service_mock_test.go github.com/juju/juju/apiserver/facades/agent/provisioner AgentProvisionerService,KeyUpdaterService,ApplicationService,ControllerConfigService,MachineService,StatusService,NetworkService,RemovalService,ModelInfoService,ModelConfigService,StoageProvisioningService,StoragePoolGetter,CloudImageMetadataService,ProvisioningService
