...
//
//	mockgen -typed -package mocks -destination mocks/keymanager_mock.go github.com/juju/juju/apiserver/facades/client/keymanager Model,BlockChecker
//
...
func (mr *MockModelMockRecorder) UpdateModelConfig(arg0, arg1, arg2 any, arg3 ...any) *MockModelUpdateModelConfigCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{arg0, arg1, arg2}, arg3...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateModelConfig", reflect.TypeOf((*MockModel)(nil).UpdateModelConfig), varargs...)
	return &MockModelUpdateModelConfigCall{Call: call}
}

// MockModelUpdateModelConfigCall wrap *gomock.Call
type MockModelUpdateModelConfigCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockModelUpdateModelConfigCall) Return(arg0 error) *MockModelUpdateModelConfigCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelUpdateModelConfigCall) Do(f func(config.ConfigSchemaSourceGetter, map[string]any, []string, ...state.ValidateConfigFunc) error) *MockModelUpdateModelConfigCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelUpdateModelConfigCall) DoAndReturn(f func(config.ConfigSchemaSourceGetter, map[string]any, []string, ...state.ValidateConfigFunc) error) *MockModelUpdateModelConfigCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
