...
// Source: github.com/juju/juju/apiserver/facades/client/spaces (interfaces: Backing,BlockChecker,Machine,RenameSpace,RenameSpaceState,Settings,OpFactory,RemoveSpace,Subnet,Constraints,MovingSubnet,MoveSubnetsOp,Address)
...
func (m *MockMoveSubnetsOp) GetMovedSubnets() []spaces.MovedSubnet {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMovedSubnets")
	ret0, _ := ret[0].([]spaces.MovedSubnet)
	return ret0
}
