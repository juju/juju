...
// Source: github.com/juju/juju/apiserver/facades/client/spaces (interfaces: Backing,BlockChecker,Machine,RenameSpace,RenameSpaceState,Settings,OpFactory,UpdateSubnet)
...
func (m *MockOpFactory) NewUpdateSpaceModelOp(arg0 string, arg1 []networkingcommon.BackingSubnet) (state.ModelOperation, error) {
	m.ctrl.T.Helper()
