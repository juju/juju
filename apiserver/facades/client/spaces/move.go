...
func (api *API) getAffectedNetworks(ctx context.Context, subnets network.SubnetInfos, spaceName string, allSpaces network.SpaceInfos, force bool) (*affectedNetworks, error) {
