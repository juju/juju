...
//
//	mockgen -typed -package spaces -destination package_mock_test.go github.com/juju/juju/apiserver/facades/client/spaces BlockChecker,Constraints,NetworkService,ControllerConfigService,ApplicationService,MachineService
//
...
func (m *MockNetworkService) RemoveSpace(arg0 context.Context, arg1 network.SpaceName, arg2, arg3 bool) (network0.RemoveSpaceViolations, error) {
	m.ctrl.T.Helper()
...
func (mr *MockNetworkServiceMockRecorder) RemoveSpace(arg0, arg1, arg2, arg3 any) *MockNetworkServiceRemoveSpaceCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RemoveSpace", reflect.TypeOf((*MockNetworkService)(nil).RemoveSpace), arg0, arg1, arg2, arg3)
...
// Return rewrite *gomock.Call.Return
func (c *MockNetworkServiceRemoveSpaceCall) Return(arg0 network0.RemoveSpaceViolations, arg1 error) *MockNetworkServiceRemoveSpaceCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockNetworkServiceRemoveSpaceCall) Do(f func(context.Context, network.SpaceName, bool, bool) (network0.RemoveSpaceViolations, error)) *MockNetworkServiceRemoveSpaceCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockNetworkServiceRemoveSpaceCall) DoAndReturn(f func(context.Context, network.SpaceName, bool, bool) (network0.RemoveSpaceViolations, error)) *MockNetworkServiceRemoveSpaceCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockMachineService) CountMachinesInSpace(arg0 context.Context, arg1 network.SpaceUUID) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountMachinesInSpace", arg0, arg1)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockMachineServiceMockRecorder) CountMachinesInSpace(arg0, arg1 any) *MockMachineServiceCountMachinesInSpaceCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountMachinesInSpace", reflect.TypeOf((*MockMachineService)(nil).CountMachinesInSpace), arg0, arg1)
	return &MockMachineServiceCountMachinesInSpaceCall{Call: call}
}

// MockMachineServiceCountMachinesInSpaceCall wrap *gomock.Call
type MockMachineServiceCountMachinesInSpaceCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockMachineServiceCountMachinesInSpaceCall) Return(arg0 int64, arg1 error) *MockMachineServiceCountMachinesInSpaceCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockMachineServiceCountMachinesInSpaceCall) Do(f func(context.Context, network.SpaceUUID) (int64, error)) *MockMachineServiceCountMachinesInSpaceCall {
	c.Call = c.Call.Do(f)
	return c
}
