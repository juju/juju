...
// Source: github.com/juju/juju/apiserver/facades/client/spaces (interfaces: Backing,BlockChecker,Machine,RenameSpace,RenameSpaceState,Settings,OpFactory,Constraints,Address,Unit,ReloadSpaces,ReloadSpacesState,ReloadSpacesEnviron,EnvironSpaces,AuthorizerState,Bindings,NetworkService)
//
// Generated by this command:
//
//	mockgen -package spaces -destination package_mock_test.go github.com/juju/juju/apiserver/facades/client/spaces Backing,BlockChecker,Machine,RenameSpace,RenameSpaceState,Settings,OpFactory,Constraints,Address,Unit,ReloadSpaces,ReloadSpacesState,ReloadSpacesEnviron,EnvironSpaces,AuthorizerState,Bindings,NetworkService
//
...
// AddSpace mocks base method.
func (m *MockNetworkService) AddSpace(arg0 context.Context, arg1 string, arg2 network.Id, arg3 []string) (network.Id, error) {
	m.ctrl.T.Helper()
...
// AddSpace indicates an expected call of AddSpace.
func (mr *MockNetworkServiceMockRecorder) AddSpace(arg0, arg1, arg2, arg3 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddSpace", reflect.TypeOf((*MockNetworkService)(nil).AddSpace), arg0, arg1, arg2, arg3)
}
