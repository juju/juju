...
//
//	mockgen -typed -package spaces -destination package_mock_test.go github.com/juju/juju/apiserver/facades/client/spaces Backing,BlockChecker,Machine,Constraints,Address,Unit,Bindings,NetworkService,ControllerConfigService
//
...
func (mr *MockBackingMockRecorder) ApplyOperation(arg0 any) *MockBackingApplyOperationCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ApplyOperation", reflect.TypeOf((*MockBacking)(nil).ApplyOperation), arg0)
	return &MockBackingApplyOperationCall{Call: call}
}

// MockBackingApplyOperationCall wrap *gomock.Call
type MockBackingApplyOperationCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockBackingApplyOperationCall) Return(arg0 error) *MockBackingApplyOperationCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockBackingApplyOperationCall) Do(f func(state.ModelOperation) error) *MockBackingApplyOperationCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockBackingApplyOperationCall) DoAndReturn(f func(state.ModelOperation) error) *MockBackingApplyOperationCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// ISGOMOCK indicates that this struct is a gomock mock.
func (m *MockConstraints) ISGOMOCK() struct{} {
	return struct{}{}
}
...
// ISGOMOCK indicates that this struct is a gomock mock.
func (m *MockBindings) ISGOMOCK() struct{} {
	return struct{}{}
}
