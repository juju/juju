...
//
//	mockgen -package mocks -destination mocks/local_mock.go github.com/juju/juju/apiserver/facades/client/action State,Model
//
...
func (m *MockModel) AddAction(arg0 state.ActionReceiver, arg1, arg2 string, arg3 map[string]any) (state.Action, error) {
	m.ctrl.T.Helper()
...
func (mr *MockModelMockRecorder) AddAction(arg0, arg1, arg2, arg3 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockModelMockRecorder) FindActionTagsById(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
