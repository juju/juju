...
//
//	mockgen -package mocks -destination mocks/state_mock.go github.com/juju/juju/state Action,ActionReceiver
//
...
func (m *MockActionReceiver) PrepareActionPayload(arg0 string, arg1 map[string]any) (map[string]any, error) {
	m.ctrl.T.Helper()
...
func (mr *MockActionReceiverMockRecorder) PrepareActionPayload(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
