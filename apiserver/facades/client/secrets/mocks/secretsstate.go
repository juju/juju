...
//
//	mockgen -package mocks -destination mocks/secretsstate.go github.com/juju/juju/apiserver/facades/client/secrets SecretsState,SecretsConsumer
//
...
func (mr *MockSecretsStateMockRecorder) ListUnusedSecretRevisions(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
