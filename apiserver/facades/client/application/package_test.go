...
//go:generate go run github.com/golang/mock/mockgen -package application -destination update_series_mocks_test.go github.com/juju/juju/apiserver/facades/client/application Application,Charm,CharmMeta,UpdateSeriesState,UpdateSeriesValidator,CharmhubClient
