...
func (s *permSuite) TestDeployPermission(c *gc.C) {
	...
	for _, fn := range []func(*gc.C){s.newIAASAPI, s.newCAASAPI} {
...
func (s *permSuite) TestAddUnitsPermission(c *gc.C) {
	defer s.setupMocks(c).Finish()
...
func (s *permSuite) TestAddUnitsBlocked(c *gc.C) {
	defer s.setupMocks(c).Finish()
...
func (s *permSuite) TestAddUnitsInvalidForCAAS(c *gc.C) {
	defer s.setupMocks(c).Finish()
...
func (s *permSuite) TestDestroyUnitPermission(c *gc.C) {
	defer s.setupMocks(c).Finish()
...
func (s *permSuite) TestDestroyUnitBlocked(c *gc.C) {
	defer s.setupMocks(c).Finish()
...
func (s *permSuite) TestDestroyUnitInvalidForCAAS(c *gc.C) {
	defer s.setupMocks(c).Finish()
...
func (s *permSuite) TestScaleApplicationsPermission(c *gc.C) {
	defer s.setupMocks(c).Finish()
...
func (s *permSuite) TestScaleApplicationsBlocked(c *gc.C) {
	defer s.setupMocks(c).Finish()
...
func (s *permSuite) TestScaleApplicationsInvalidForIAAS(c *gc.C) {
	defer s.setupMocks(c).Finish()
