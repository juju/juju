...
func (m *MockDeployFromRepositoryState) AddApplication(arg0 state.AddApplicationArgs, arg1 objectstore.ObjectStore, arg2 status.StatusHistoryRecorder) (Application, error) {
	m.ctrl.T.Helper()
