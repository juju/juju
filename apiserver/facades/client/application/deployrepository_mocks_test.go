...
func (m *MockDeployFromRepositoryState) AddApplication(arg0 state.AddApplicationArgs) (application.Application, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeployFromRepositoryState) AddCharmMetadata(arg0 state.CharmInfo) (application.Charm, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeployFromRepositoryState) Machine(arg0 string) (application.Machine, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeployFromRepositoryValidator) ValidateArg(arg0 params.DeployFromRepositoryArg) (application.deployTemplate, []error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateArg", arg0)
	ret0, _ := ret[0].(application.deployTemplate)
	ret1, _ := ret[1].([]error)
	return ret0, ret1
}
