...
//
//	mockgen -package mocks -destination mocks/repository_mock.go github.com/juju/juju/apiserver/facades/client/application Repository
//
...
func (mr *MockRepositoryMockRecorder) DownloadCharm(arg0, arg1 any) *gomock.Call {
...
func (mr *MockRepositoryMockRecorder) FindDownloadURL(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Resolve(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
