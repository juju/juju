...
// Source: github.com/juju/juju/apiserver/facades/client/application (interfaces: MachineService,ApplicationService,StoragePoolGetter,NetworkService,ExternalControllerService,ModelConfigService,ModelAgentService,StubService)
//
// Generated by this command:
//
//	mockgen -typed -package application -destination service_mock_test.go github.com/juju/juju/apiserver/facades/client/application MachineService,ApplicationService,StoragePoolGetter,NetworkService,ExternalControllerService,ModelConfigService,ModelAgentService,StubService
//
