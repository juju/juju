...
// Source: github.com/juju/juju/apiserver/facades/client/application (interfaces: ExternalControllerService,NetworkService,StorageInterface,DeployFromRepository,BlockChecker,ModelConfigService,MachineService,ApplicationService,PortService,StubService,Leadership,StorageService,RelationService)
//
...
func (m *MockApplicationService) GetCharmConfig(arg0 context.Context, arg1 charm0.CharmLocator) (charm1.Config, error) {
	m.ctrl.T.Helper()
...
func (mr *MockApplicationServiceMockRecorder) GetCharmConfig(arg0, arg1 any) *MockApplicationServiceGetCharmConfigCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCharmConfig", reflect.TypeOf((*MockApplicationService)(nil).GetCharmConfig), arg0, arg1)
	return &MockApplicationServiceGetCharmConfigCall{Call: call}
}

// MockApplicationServiceGetCharmConfigCall wrap *gomock.Call
type MockApplicationServiceGetCharmConfigCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockApplicationServiceGetCharmConfigCall) Return(arg0 charm1.Config, arg1 error) *MockApplicationServiceGetCharmConfigCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockApplicationServiceGetCharmConfigCall) Do(f func(context.Context, charm0.CharmLocator) (charm1.Config, error)) *MockApplicationServiceGetCharmConfigCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockApplicationServiceGetCharmConfigCall) DoAndReturn(f func(context.Context, charm0.CharmLocator) (charm1.Config, error)) *MockApplicationServiceGetCharmConfigCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// AddPeerRelation mocks base method.
func (m *MockRelationService) AddPeerRelation(arg0 context.Context, arg1 string) (relation0.Endpoint, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddPeerRelation", arg0, arg1)
	ret0, _ := ret[0].(relation0.Endpoint)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// AddPeerRelation indicates an expected call of AddPeerRelation.
func (mr *MockRelationServiceMockRecorder) AddPeerRelation(arg0, arg1 any) *MockRelationServiceAddPeerRelationCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddPeerRelation", reflect.TypeOf((*MockRelationService)(nil).AddPeerRelation), arg0, arg1)
	return &MockRelationServiceAddPeerRelationCall{Call: call}
}

// MockRelationServiceAddPeerRelationCall wrap *gomock.Call
type MockRelationServiceAddPeerRelationCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockRelationServiceAddPeerRelationCall) Return(arg0 relation0.Endpoint, arg1 error) *MockRelationServiceAddPeerRelationCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRelationServiceAddPeerRelationCall) Do(f func(context.Context, string) (relation0.Endpoint, error)) *MockRelationServiceAddPeerRelationCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRelationServiceAddPeerRelationCall) DoAndReturn(f func(context.Context, string) (relation0.Endpoint, error)) *MockRelationServiceAddPeerRelationCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockRelationService) DeleteRelation(arg0 context.Context, arg1 relation.UUID) error {
	m.ctrl.T.Helper()
...
func (mr *MockRelationServiceMockRecorder) DeleteRelation(arg0, arg1 any) *MockRelationServiceDeleteRelationCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteRelation", reflect.TypeOf((*MockRelationService)(nil).DeleteRelation), arg0, arg1)
	return &MockRelationServiceDeleteRelationCall{Call: call}
}

// MockRelationServiceDeleteRelationCall wrap *gomock.Call
type MockRelationServiceDeleteRelationCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockRelationServiceDeleteRelationCall) Return(arg0 error) *MockRelationServiceDeleteRelationCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRelationServiceDeleteRelationCall) Do(f func(context.Context, relation.UUID) error) *MockRelationServiceDeleteRelationCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRelationServiceDeleteRelationCall) DoAndReturn(f func(context.Context, relation.UUID) error) *MockRelationServiceDeleteRelationCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
