...
// Source: github.com/juju/juju/apiserver/facades/client/modelmanager (interfaces: ApplicationService,AccessService,SecretBackendService,ModelService,DomainServicesGetter,ModelDefaultsService,ModelInfoService,ModelConfigService,NetworkService,ModelDomainServices,MachineService,CloudImageMetadataService)
//
...
func (m *MockModelDomainServices) CloudImageMetadata() modelmanager.CloudImageMetadataService {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CloudImageMetadata")
	ret0, _ := ret[0].(modelmanager.CloudImageMetadataService)
	return ret0
}
...
// Return rewrite *gomock.Call.Return
func (c *MockModelDomainServicesCloudImageMetadataCall) Return(arg0 modelmanager.CloudImageMetadataService) *MockModelDomainServicesCloudImageMetadataCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelDomainServicesCloudImageMetadataCall) Do(f func() modelmanager.CloudImageMetadataService) *MockModelDomainServicesCloudImageMetadataCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelDomainServicesCloudImageMetadataCall) DoAndReturn(f func() modelmanager.CloudImageMetadataService) *MockModelDomainServicesCloudImageMetadataCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockCloudImageMetadataService) AllCloudImageMetadata(arg0 context.Context) ([]cloudimagemetadata.Metadata, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCloudImageMetadataServiceMockRecorder) AllCloudImageMetadata(arg0 any) *MockCloudImageMetadataServiceAllCloudImageMetadataCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllCloudImageMetadata", reflect.TypeOf((*MockCloudImageMetadataService)(nil).AllCloudImageMetadata), arg0)
	return &MockCloudImageMetadataServiceAllCloudImageMetadataCall{Call: call}
}

// MockCloudImageMetadataServiceAllCloudImageMetadataCall wrap *gomock.Call
type MockCloudImageMetadataServiceAllCloudImageMetadataCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockCloudImageMetadataServiceAllCloudImageMetadataCall) Return(arg0 []cloudimagemetadata.Metadata, arg1 error) *MockCloudImageMetadataServiceAllCloudImageMetadataCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockCloudImageMetadataServiceAllCloudImageMetadataCall) Do(f func(context.Context) ([]cloudimagemetadata.Metadata, error)) *MockCloudImageMetadataServiceAllCloudImageMetadataCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockCloudImageMetadataServiceAllCloudImageMetadataCall) DoAndReturn(f func(context.Context) ([]cloudimagemetadata.Metadata, error)) *MockCloudImageMetadataServiceAllCloudImageMetadataCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
