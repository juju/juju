...
// Source: github.com/juju/juju/apiserver/facades/client/modelmanager (interfaces: StatePool,State,Model,MongoSession)
...
func (m *MockState) MongoSession() modelmanager.MongoSession {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MongoSession")
	ret0, _ := ret[0].(modelmanager.MongoSession)
	return ret0
}
...
func (m *MockMongoSession) CurrentStatus() (*replicaset.Status, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CurrentStatus")
...
func (mr *MockMongoSessionMockRecorder) CurrentStatus() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CurrentStatus", reflect.TypeOf((*MockMongoSession)(nil).CurrentStatus))
}
