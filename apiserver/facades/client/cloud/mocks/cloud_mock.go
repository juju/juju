...
// Source: github.com/juju/juju/apiserver/facades/client/cloud (interfaces: ModelCredentialService,CredentialService,CloudService,CloudAccessService)
//
// Generated by this command:
//
//	mockgen -package mocks -destination mocks/cloud_mock.go github.com/juju/juju/apiserver/facades/client/cloud ModelCredentialService,CredentialService,CloudService,CloudAccessService
//
...
func (m *MockModelCredentialService) CredentialModelsAndOwnerAccess(arg0 names.CloudCredentialTag) ([]cloud.CredentialOwnerModelAccess, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CredentialModelsAndOwnerAccess", arg0)
	ret0, _ := ret[0].([]cloud.CredentialOwnerModelAccess)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
