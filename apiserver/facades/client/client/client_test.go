...
func (m *mockRepo) GetCharm(curl *charm.URL, downloadURL *url.URL, archivePath string) (*charm.CharmArchive, error) {
	m.MethodCall(m, "GetCharm", curl, downloadURL, archivePath)
	return nil, nil
}
