...
func (m *MockStatusService) GetModelStatus(arg0 context.Context) (status0.ModelStatus, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetModelStatus", arg0)
	ret0, _ := ret[0].(status0.ModelStatus)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Return rewrite *gomock.Call.Return
func (c *MockStatusServiceGetModelStatusCall) Return(arg0 status0.ModelStatus, arg1 error) *MockStatusServiceGetModelStatusCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStatusServiceGetModelStatusCall) Do(f func(context.Context) (status0.ModelStatus, error)) *MockStatusServiceGetModelStatusCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStatusServiceGetModelStatusCall) DoAndReturn(f func(context.Context) (status0.ModelStatus, error)) *MockStatusServiceGetModelStatusCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
