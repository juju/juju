...
//
//	mockgen -package mocks -destination mocks/common_mock.go github.com/juju/juju/apiserver/common ToolsFinder
//
...
func (mr *MockToolsFinderMockRecorder) FindTools(arg0 any) *gomock.Call {
