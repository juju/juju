...
func (s *UpgradeSeriesPrepareMachineManagerSuite) TestUpgradeSeriesPrepareIncompatibleBase(c *gc.C) {
	...
	machine0 := s.expectPrepareMachine(ctrl, apiservererrors.NewErrIncompatibleBase([]corebase.Base{corebase.MustParseBaseFromString("ubuntu@16.10"), corebase.MustParseBaseFromString("ubuntu@17.04")}, corebase.MustParseBaseFromString("ubuntu@22.04"), "TestCharm"))
	s.st.EXPECT().Machine("0").Return(machine0, nil)
