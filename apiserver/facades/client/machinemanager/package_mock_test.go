...
// Return rewrite *gomock.Call.Return
func (c *MockMachineUnitsCall) Return(arg0 []Unit, arg1 error) *MockMachineUnitsCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockMachineUnitsCall) Do(f func() ([]Unit, error)) *MockMachineUnitsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockMachineUnitsCall) DoAndReturn(f func() ([]Unit, error)) *MockMachineUnitsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockStubService) GetEnvironAgentBinariesFinder() stub.EnvironAgentBinariesFinderFunc {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEnvironAgentBinariesFinder")
	ret0, _ := ret[0].(stub.EnvironAgentBinariesFinderFunc)
	return ret0
}

// GetEnvironAgentBinariesFinder indicates an expected call of GetEnvironAgentBinariesFinder.
func (mr *MockStubServiceMockRecorder) GetEnvironAgentBinariesFinder() *MockStubServiceGetEnvironAgentBinariesFinderCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEnvironAgentBinariesFinder", reflect.TypeOf((*MockStubService)(nil).GetEnvironAgentBinariesFinder))
	return &MockStubServiceGetEnvironAgentBinariesFinderCall{Call: call}
}

// MockStubServiceGetEnvironAgentBinariesFinderCall wrap *gomock.Call
type MockStubServiceGetEnvironAgentBinariesFinderCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockStubServiceGetEnvironAgentBinariesFinderCall) Return(arg0 stub.EnvironAgentBinariesFinderFunc) *MockStubServiceGetEnvironAgentBinariesFinderCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStubServiceGetEnvironAgentBinariesFinderCall) Do(f func() stub.EnvironAgentBinariesFinderFunc) *MockStubServiceGetEnvironAgentBinariesFinderCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStubServiceGetEnvironAgentBinariesFinderCall) DoAndReturn(f func() stub.EnvironAgentBinariesFinderFunc) *MockStubServiceGetEnvironAgentBinariesFinderCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
