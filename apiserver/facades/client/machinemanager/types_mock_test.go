...
// Source: github.com/juju/juju/apiserver/facades/client/machinemanager (interfaces: Machine,Application,Unit)
...
// VerifySupportedSeries mocks base method
func (m *MockApplication) VerifySupportedSeries(arg0 string, arg1 bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifySupportedSeries", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// VerifySupportedSeries indicates an expected call of VerifySupportedSeries
func (mr *MockApplicationMockRecorder) VerifySupportedSeries(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VerifySupportedSeries", reflect.TypeOf((*MockApplication)(nil).VerifySupportedSeries), arg0, arg1)
}
