...
func (m *MockMachine) SetInstanceStatus(arg0 status.StatusInfo, arg1 status.StatusHistoryRecorder) error {
	m.ctrl.T.Helper()
...
func (mr *MockMachineMockRecorder) SetInstanceStatus(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetInstanceStatus", reflect.TypeOf((*MockMachine)(nil).SetInstanceStatus), arg0, arg1)
}
