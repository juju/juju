...
//
//	mockgen -package mocks -destination mocks/upgradebase_mock.go github.com/juju/juju/apiserver/facades/client/machinemanager Authorizer,UpgradeSeries,UpgradeSeriesState,UpgradeBaseValidator
//
