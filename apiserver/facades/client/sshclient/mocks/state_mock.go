...
func (mr *MockBackendMockRecorder) GetMachineForEntity(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBackendMockRecorder) GetSSHHostKeys(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
