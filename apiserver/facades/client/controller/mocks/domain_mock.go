...
// Source: github.com/juju/juju/apiserver/facades/client/controller (interfaces: ControllerConfigGetter)
...
func (m *MockControllerConfigGetter) UpdateControllerConfig(arg0 context.Context, arg1 controller.Config, arg2 []string) error {
	m.ctrl.T.Helper()
...
func (mr *MockControllerConfigGetterMockRecorder) UpdateControllerConfig(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateControllerConfig", reflect.TypeOf((*MockControllerConfigGetter)(nil).UpdateControllerConfig), arg0, arg1, arg2)
}
