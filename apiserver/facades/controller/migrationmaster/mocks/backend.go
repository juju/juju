...
// Source: github.com/juju/juju/apiserver/facades/controller/migrationmaster (interfaces: Backend,ControllerState,ModelExporter,UpgradeService,ControllerConfigService,CredentialService,ModelConfigService,ModelInfoService,ModelService,ApplicationService,StatusService,ModelAgentService)
//
// Generated by this command:
//
//	mockgen -typed -package mocks -destination mocks/backend.go github.com/juju/juju/apiserver/facades/controller/migrationmaster Backend,ControllerState,ModelExporter,UpgradeService,ControllerConfigService,CredentialService,ModelConfigService,ModelInfoService,ModelService,ApplicationService,StatusService,ModelAgentService
//
