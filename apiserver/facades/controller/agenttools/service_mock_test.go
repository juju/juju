...
// Source: github.com/juju/juju/apiserver/facades/controller/agenttools (interfaces: MachineService,ModelConfigService,ModelAgentService,ModelInfoService)
//
// Generated by this command:
//
//	mockgen -typed -package agenttools -destination service_mock_test.go github.com/juju/juju/apiserver/facades/controller/agenttools MachineService,ModelConfigService,ModelAgentService,ModelInfoService
//
...
func (m *MockModelInfoService) UpdateLatestAgentVersion(arg0 context.Context, arg1 semversion.Number) error {
	m.ctrl.T.Helper()
...
func (mr *MockModelInfoServiceMockRecorder) UpdateLatestAgentVersion(arg0, arg1 any) *MockModelInfoServiceUpdateLatestAgentVersionCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateLatestAgentVersion", reflect.TypeOf((*MockModelInfoService)(nil).UpdateLatestAgentVersion), arg0, arg1)
	return &MockModelInfoServiceUpdateLatestAgentVersionCall{Call: call}
}

// MockModelInfoServiceUpdateLatestAgentVersionCall wrap *gomock.Call
type MockModelInfoServiceUpdateLatestAgentVersionCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockModelInfoServiceUpdateLatestAgentVersionCall) Return(arg0 error) *MockModelInfoServiceUpdateLatestAgentVersionCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelInfoServiceUpdateLatestAgentVersionCall) Do(f func(context.Context, semversion.Number) error) *MockModelInfoServiceUpdateLatestAgentVersionCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelInfoServiceUpdateLatestAgentVersionCall) DoAndReturn(f func(context.Context, semversion.Number) error) *MockModelInfoServiceUpdateLatestAgentVersionCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
