...
// Source: github.com/juju/juju/apiserver/facades/controller/remoterelations (interfaces: RemoteRelationsState,ControllerConfigAPI,ECService)
...
func (m *MockECService) UpdateExternalController(arg0 context.Context, arg1 crossmodel0.ControllerInfo) error {
	m.ctrl.T.Helper()
