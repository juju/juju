...
//
//	mockgen -package secretbackendmanager -destination mock_service.go -source service.go BackendService
//
...
func (mr *MockBackendServiceMockRecorder) RotateBackendToken(ctx, backendID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RotateBackendToken", reflect.TypeOf((*MockBackendService)(nil).RotateBackendToken), ctx, backendID)
}
