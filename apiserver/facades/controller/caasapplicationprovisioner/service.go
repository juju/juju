...
type ApplicationService interface {
	SetScalingState(ctx context.Context, name string, scaleTarget int, scaling bool) error
	GetScalingState(ctx context.Context, name string) (service.ScalingState, error)
	GetScale(ctx context.Context, name string) (int, error)
}
