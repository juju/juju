...
//go:generate go run go.uber.org/mock/mockgen -typed -package caasapplicationprovisioner_test -destination objectstore_mock_test.go github.com/juju/juju/core/objectstore ObjectStore
