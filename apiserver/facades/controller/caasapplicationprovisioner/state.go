...
type Application interface {
	...
	AllUnits() ([]Unit, error)
	GetUnitAttachmentInfos([]status.Status) ([]state.UnitAttachmentInfo, error)
...
func (a *applicationShim) GetUnitAttachmentInfos(statuses []status.Status) ([]state.UnitAttachmentInfo, error) {
	return a.Application.GetUnitAttachmentInfos(statuses)
}
