...
//go:generate go run go.uber.org/mock/mockgen -typed -package crossmodelrelations -destination package_mock_test.go github.com/juju/juju/apiserver/facades/controller/crossmodelrelations CrossModelRelationService,SecretService,StatusService,RelationService,ApplicationService,RemovalService
