...
func (m *MockApplicationService) GetUnitNames(arg0 context.Context, arg1 []unit.UUID) ([]string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockApplicationServiceMockRecorder) GetUnitNames(arg0, arg1 any) *MockApplicationServiceGetUnitNamesCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUnitNames", reflect.TypeOf((*MockApplicationService)(nil).GetUnitNames), arg0, arg1)
	return &MockApplicationServiceGetUnitNamesCall{Call: call}
}

// MockApplicationServiceGetUnitNamesCall wrap *gomock.Call
type MockApplicationServiceGetUnitNamesCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockApplicationServiceGetUnitNamesCall) Return(arg0 []string, arg1 error) *MockApplicationServiceGetUnitNamesCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockApplicationServiceGetUnitNamesCall) Do(f func(context.Context, []unit.UUID) ([]string, error)) *MockApplicationServiceGetUnitNamesCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockApplicationServiceGetUnitNamesCall) DoAndReturn(f func(context.Context, []unit.UUID) ([]string, error)) *MockApplicationServiceGetUnitNamesCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockPortService) GetMachineOpenedPorts(arg0 context.Context, arg1 string) (map[unit.UUID]network.GroupedPortRanges, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockPortServiceGetMachineOpenedPortsCall) Return(arg0 map[unit.UUID]network.GroupedPortRanges, arg1 error) *MockPortServiceGetMachineOpenedPortsCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockPortServiceGetMachineOpenedPortsCall) Do(f func(context.Context, string) (map[unit.UUID]network.GroupedPortRanges, error)) *MockPortServiceGetMachineOpenedPortsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockPortServiceGetMachineOpenedPortsCall) DoAndReturn(f func(context.Context, string) (map[unit.UUID]network.GroupedPortRanges, error)) *MockPortServiceGetMachineOpenedPortsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
