...
// Source: github.com/juju/juju/apiserver/facades/controller/firewaller (interfaces: State,ControllerConfigAPI,SpaceService)
//
// Generated by this command:
//
//	mockgen -package firewaller_test -destination package_mock_test.go github.com/juju/juju/apiserver/facades/controller/firewaller State,ControllerConfigAPI,SpaceService
//
...
func (m *MockState) AllEndpointBindings(arg0 network.SpaceInfos) (map[string]map[string]string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) AllEndpointBindings(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AllEndpointBindings", reflect.TypeOf((*MockState)(nil).AllEndpointBindings), arg0)
}
