...
// Source: github.com/juju/juju/apiserver/facade (interfaces: Context,Resources,Presence,Authorizer)
//
// Generated by this command:
//
//	mockgen -package mocks -destination mocks/facade_mock.go github.com/juju/juju/apiserver/facade Context,Resources,Presence,Authorizer
//
...
// ModelPresence mocks base method.
func (m *MockPresence) ModelPresence(arg0 string) facade.ModelPresence {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ModelPresence", arg0)
	ret0, _ := ret[0].(facade.ModelPresence)
	return ret0
}

// ModelPresence indicates an expected call of ModelPresence.
func (mr *MockPresenceMockRecorder) ModelPresence(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ModelPresence", reflect.TypeOf((*MockPresence)(nil).ModelPresence), arg0)
}
