...
//
//	mockgen -typed -package apiserver -destination package_mock_test.go github.com/juju/juju/apiserver AgentBinaryStore,BlockChecker,ControllerConfigService,ModelAuthorizationInfo
//
...
func NewMockModelAuthorizationInfo(ctrl *gomock.Controller) *MockModelAuthorizationInfo {
	...
	mock.recorder = &MockModelAuthorizationInfoMockRecorder{mock}
	return mock
}
...
func (mr *MockModelAuthorizationInfoMockRecorder) IsAuthorizationForControllerModel(arg0 any) *MockModelAuthorizationInfoIsAuthorizationForControllerModelCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsAuthorizationForControllerModel", reflect.TypeOf((*MockModelAuthorizationInfo)(nil).IsAuthorizationForControllerModel), arg0)
	return &MockModelAuthorizationInfoIsAuthorizationForControllerModelCall{Call: call}
}

// MockModelAuthorizationInfoIsAuthorizationForControllerModelCall wrap *gomock.Call
type MockModelAuthorizationInfoIsAuthorizationForControllerModelCall struct {
	*gomock.Call
}
