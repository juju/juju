...
var storageRegistryGetter = func(ctx *facadeContext) func(context.Context) (storage.ProviderRegistry, error) {
	return func(stdCtx context.Context) (storage.ProviderRegistry, error) {
