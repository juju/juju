...
// Source: github.com/juju/juju/apiserver/internal/handlers/resource (interfaces: ResourceServiceGetter,ApplicationServiceGetter,ApplicationService,ResourceService,ResourceOpenerGetter,Downloader)
//
// Generated by this command:
//
//	mockgen -typed -package resource -destination service_mock_test.go github.com/juju/juju/apiserver/internal/handlers/resource ResourceServiceGetter,ApplicationServiceGetter,ApplicationService,ResourceService,ResourceOpenerGetter,Downloader
//
...
func (m *MockResourceService) GetResource(arg0 context.Context, arg1 resource0.UUID) (resource0.Resource, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockResourceServiceGetResourceCall) Do(f func(context.Context, resource0.UUID) (resource0.Resource, error)) *MockResourceServiceGetResourceCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockResourceServiceGetResourceCall) DoAndReturn(f func(context.Context, resource0.UUID) (resource0.Resource, error)) *MockResourceServiceGetResourceCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockResourceService) OpenResource(arg0 context.Context, arg1 resource0.UUID) (resource0.Resource, io.ReadCloser, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockResourceServiceOpenResourceCall) Do(f func(context.Context, resource0.UUID) (resource0.Resource, io.ReadCloser, error)) *MockResourceServiceOpenResourceCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockResourceServiceOpenResourceCall) DoAndReturn(f func(context.Context, resource0.UUID) (resource0.Resource, io.ReadCloser, error)) *MockResourceServiceOpenResourceCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockDownloader) Download(arg0 io.ReadCloser, arg1 string, arg2 int64) (io.ReadCloser, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockDownloaderDownloadCall) Do(f func(io.ReadCloser, string, int64) (io.ReadCloser, error)) *MockDownloaderDownloadCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockDownloaderDownloadCall) DoAndReturn(f func(io.ReadCloser, string, int64) (io.ReadCloser, error)) *MockDownloaderDownloadCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
