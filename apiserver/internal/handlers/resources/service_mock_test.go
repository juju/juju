...
func (m *MockResourceService) StoreResourceAndIncrementCharmModifiedVersion(arg0 context.Context, arg1 resource0.StoreResourceArgs) (resource.Resource, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockResourceServiceStoreResourceAndIncrementCharmModifiedVersionCall) Return(arg0 resource.Resource, arg1 error) *MockResourceServiceStoreResourceAndIncrementCharmModifiedVersionCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockResourceServiceStoreResourceAndIncrementCharmModifiedVersionCall) Do(f func(context.Context, resource0.StoreResourceArgs) (resource.Resource, error)) *MockResourceServiceStoreResourceAndIncrementCharmModifiedVersionCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockResourceServiceStoreResourceAndIncrementCharmModifiedVersionCall) DoAndReturn(f func(context.Context, resource0.StoreResourceArgs) (resource.Resource, error)) *MockResourceServiceStoreResourceAndIncrementCharmModifiedVersionCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
