...
//
//	mockgen -typed -package bakery -destination service_mock_test.go github.com/juju/juju/apiserver/internal/crossmodel/bakery BakeryStore,Oven,MacaroonChecker,HTTPClient
//
...
func NewMockMacaroonChecker(ctrl *gomock.Controller) *MockMacaroonChecker {
	...
	mock.recorder = &MockMacaroonCheckerMockRecorder{mock}
	return mock
}
...
func (m *MockMacaroonChecker) Auth(arg0 ...macaroon.Slice) *bakery.AuthChecker {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range arg0 {
		varargs = append(varargs, a)
...
func (mr *MockMacaroonCheckerMockRecorder) Auth(arg0 ...any) *MockMacaroonCheckerAuthCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Auth", reflect.TypeOf((*MockMacaroonChecker)(nil).Auth), arg0...)
	return &MockMacaroonCheckerAuthCall{Call: call}
}

// MockMacaroonCheckerAuthCall wrap *gomock.Call
type MockMacaroonCheckerAuthCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockMacaroonCheckerAuthCall) Return(arg0 *bakery.AuthChecker) *MockMacaroonCheckerAuthCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockMacaroonCheckerAuthCall) Do(f func(...macaroon.Slice) *bakery.AuthChecker) *MockMacaroonCheckerAuthCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockMacaroonCheckerAuthCall) DoAndReturn(f func(...macaroon.Slice) *bakery.AuthChecker) *MockMacaroonCheckerAuthCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
