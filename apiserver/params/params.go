...
type BundleData struct {
	// Application holds one entry for each application.
	Applications map[string]*BundleApplicationSpec `bson:"applications,omitempty" json:",omitempty" yaml:"applications,omitempty"`

	// MachineSpec hold one entry for each machine referred to by unit placements.
	Machines map[string]*BundleMachineSpec `bson:",omitempty" json:",omitempty" yaml:",omitempty"`

	// Series holds the default series to use when the bundle chooses the charm.
...
// BundleApplicationSpec
type BundleApplicationSpec struct {
	// Charm holds the charm URL.
	Charm string
...
// BundleMachineSpec represents a notional machine that will be mapped
// onto an actual machine at bundle deployment time.
type BundleMachineSpec struct {
