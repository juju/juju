...
// params.UnitInfo.Ports                   []network.Port
...
// params.MachineInfo.Addresses            []network.Address
...
func (s *MarshalSuite) TestNetworkEntities(c *gc.C) {
	...
	for i, test := range []struct {
		...
		input: []params.PortsResult{{
			Ports: allPortsCombos,
		}, {},
		},
	}, {
		about: "params.UnitInfo.Ports",
		input: []params.UnitInfo{{
			Ports: allPortsCombos,
		}, {},
		},
	}, {
		...
		about: "params.MachineInfo.Addresses",
		input: []params.MachineInfo{{
			Series:    "foo",
			Addresses: allAddressesCombos,
		}, {},
		},
