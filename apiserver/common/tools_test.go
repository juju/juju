...
func (s *getUrlSuite) TestToolsURLGetterNoAPIHostPorts(c *tc.C) {
	...
	s.apiHostPortsGetter.EXPECT().GetAllAPIAddressesWithScopeForAgents(gomock.Any()).Return(nil, nil)
...
func (s *getUrlSuite) TestToolsURLGetterAPIHostPortsError(c *tc.C) {
	...
	s.apiHostPortsGetter.EXPECT().GetAllAPIAddressesWithScopeForAgents(gomock.Any()).Return(nil, errors.New("oh noes"))
...
func (s *getUrlSuite) TestToolsURLGetter(c *tc.C) {
	...
	s.apiHostPortsGetter.EXPECT().GetAllAPIAddressesWithScopeForAgents(gomock.Any()).Return(addrs, nil)
