...
// networking features.
func NetworkingEnvironFromModelConfig(configGetter environs.EnvironConfigGetter, providerRegistry *environs.ProviderRegistry) (environs.NetworkingEnviron, error) {
