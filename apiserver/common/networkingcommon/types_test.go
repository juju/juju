...
var observedNetworkConfigs = []params.NetworkConfig{{
	...
	Address:       "127.0.0.1",
	MTU:           65536,
	ConfigMethod:  string(network.LoopbackAddress),
	...
	MTU:           1500,
	ConfigMethod:  string(network.StaticAddress),
	NetworkOrigin: params.NetworkOrigin(network.OriginMachine),
}, {
	DeviceIndex:   10,
	InterfaceName: "br-eth0",
	...
	MACAddress:          "aa:bb:cc:dd:ee:f0",
	MTU:                 1500,
	ConfigMethod:        string(network.ManualAddress),
	NetworkOrigin:       params.NetworkOrigin(network.OriginMachine),
}, {
	DeviceIndex:         13,
...
func (s *TypesSuite) TestAddressMatchingFromObservedConfig(c *gc.C) {
	cfg := []params.NetworkConfig{
		...
		{DeviceIndex: 12, MACAddress: "1e:d2:8f:c1:d2:f7", CIDR: "2001:41f0:86dd:1000::/64", MTU: 9214, ProviderId: "", ProviderNetworkId: "", ProviderSubnetId: "", ProviderSpaceId: "", ProviderAddressId: "", ProviderVLANId: "", VLANTag: 0, InterfaceName: "br-eno3", ParentInterfaceName: "", InterfaceType: "bridge", Disabled: false, NoAutoStart: false, ConfigMethod: "static", Address: "2001:41f0:86dd:1000:1cd2:8fff:fec1:d2f7", Addresses: []params.Address(nil), ShadowAddresses: []params.Address(nil), DNSServers: []string(nil), DNSSearchDomains: []string(nil), GatewayAddress: "10.0.4.1", Routes: []params.NetworkRoute(nil), IsDefaultGateway: true, NetworkOrigin: "machine"},
		{DeviceIndex: 12, MACAddress: "1e:d2:8f:c1:d2:f7", CIDR: "2001:41f0:86dd:1000::/64", MTU: 9214, ProviderId: "", ProviderNetworkId: "", ProviderSubnetId: "", ProviderSpaceId: "", ProviderAddressId: "", ProviderVLANId: "", VLANTag: 0, InterfaceName: "br-eno3", ParentInterfaceName: "", InterfaceType: "bridge", Disabled: false, NoAutoStart: false, ConfigMethod: "static", Address: "2001:41f0:86dd:1000::15", Addresses: []params.Address(nil), ShadowAddresses: []params.Address(nil), DNSServers: []string(nil), DNSSearchDomains: []string(nil), GatewayAddress: "10.0.4.1", Routes: []params.NetworkRoute(nil), IsDefaultGateway: true, NetworkOrigin: "machine"},
