...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/provider_mock.go github.com/juju/juju/secrets/provider SecretStoreProvider
