...
func (a *AuthContext) CheckOfferAccessCaveat(ctx context.Context, caveat string) (*offerPermissionCheck, error) {
	...
	authlogger.Debugf(ctx, "offer access caveat details: %+v", details)
...
func (a *authenticator) checkMacaroons(
	...
	declared := a.ctxt.offerBakery.InferDeclaredFromMacaroon(ctx, mac, requiredValues)
