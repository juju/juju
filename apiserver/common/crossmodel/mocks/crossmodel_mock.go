...
// Source: github.com/juju/juju/apiserver/common/crossmodel (interfaces: OfferBakeryInterface,Backend,BakeryConfigService,AccessService,ApplicationService,RelationNetworks,StatusService)
//
// Generated by this command:
//
//	mockgen -typed -package mocks -destination mocks/crossmodel_mock.go github.com/juju/juju/apiserver/common/crossmodel OfferBakeryInterface,Backend,BakeryConfigService,AccessService,ApplicationService,RelationNetworks,StatusService
//
...
func (m *MockBackend) IngressNetworks(arg0 string) (crossmodel.RelationNetworks, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockBackendIngressNetworksCall) Return(arg0 crossmodel.RelationNetworks, arg1 error) *MockBackendIngressNetworksCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockBackendIngressNetworksCall) Do(f func(string) (crossmodel.RelationNetworks, error)) *MockBackendIngressNetworksCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockBackendIngressNetworksCall) DoAndReturn(f func(string) (crossmodel.RelationNetworks, error)) *MockBackendIngressNetworksCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockBackend) SaveIngressNetworks(arg0 string, arg1 []string) (crossmodel.RelationNetworks, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockBackendSaveIngressNetworksCall) Return(arg0 crossmodel.RelationNetworks, arg1 error) *MockBackendSaveIngressNetworksCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockBackendSaveIngressNetworksCall) Do(f func(string, []string) (crossmodel.RelationNetworks, error)) *MockBackendSaveIngressNetworksCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockBackendSaveIngressNetworksCall) DoAndReturn(f func(string, []string) (crossmodel.RelationNetworks, error)) *MockBackendSaveIngressNetworksCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (mr *MockRelationNetworksMockRecorder) CIDRS() *MockRelationNetworksCIDRSCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CIDRS", reflect.TypeOf((*MockRelationNetworks)(nil).CIDRS))
	return &MockRelationNetworksCIDRSCall{Call: call}
}

// MockRelationNetworksCIDRSCall wrap *gomock.Call
type MockRelationNetworksCIDRSCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockRelationNetworksCIDRSCall) Return(arg0 []string) *MockRelationNetworksCIDRSCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRelationNetworksCIDRSCall) Do(f func() []string) *MockRelationNetworksCIDRSCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRelationNetworksCIDRSCall) DoAndReturn(f func() []string) *MockRelationNetworksCIDRSCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (mr *MockRelationNetworksMockRecorder) Id() *MockRelationNetworksIdCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Id", reflect.TypeOf((*MockRelationNetworks)(nil).Id))
	return &MockRelationNetworksIdCall{Call: call}
}

// MockRelationNetworksIdCall wrap *gomock.Call
type MockRelationNetworksIdCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockRelationNetworksIdCall) Return(arg0 string) *MockRelationNetworksIdCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRelationNetworksIdCall) Do(f func() string) *MockRelationNetworksIdCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRelationNetworksIdCall) DoAndReturn(f func() string) *MockRelationNetworksIdCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (mr *MockRelationNetworksMockRecorder) RelationKey() *MockRelationNetworksRelationKeyCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RelationKey", reflect.TypeOf((*MockRelationNetworks)(nil).RelationKey))
	return &MockRelationNetworksRelationKeyCall{Call: call}
}

// MockRelationNetworksRelationKeyCall wrap *gomock.Call
type MockRelationNetworksRelationKeyCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockRelationNetworksRelationKeyCall) Return(arg0 string) *MockRelationNetworksRelationKeyCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockRelationNetworksRelationKeyCall) Do(f func() string) *MockRelationNetworksRelationKeyCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockRelationNetworksRelationKeyCall) DoAndReturn(f func() string) *MockRelationNetworksRelationKeyCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
