...
// Source: github.com/juju/juju/apiserver/common (interfaces: BlockCommandService,CloudService,ControllerConfigService,ExternalControllerService,ModelService,ToolsFinder,ToolsURLGetter,APIHostPortsForAgentsGetter,ToolsStorageGetter,ModelAgentService,MachineRebootService,EnsureDeadMachineService,WatchableMachineService,UnitStateService,ApplicationService,MachineService,StatusService,LeadershipPinningBackend,LeadershipMachine,AgentPasswordService,AgentBinaryService)
//
// Generated by this command:
//
//	mockgen -typed -package mocks -destination mocks/common_mock.go github.com/juju/juju/apiserver/common BlockCommandService,CloudService,ControllerConfigService,ExternalControllerService,ModelService,ToolsFinder,ToolsURLGetter,APIHostPortsForAgentsGetter,ToolsStorageGetter,ModelAgentService,MachineRebootService,EnsureDeadMachineService,WatchableMachineService,UnitStateService,ApplicationService,MachineService,StatusService,LeadershipPinningBackend,LeadershipMachine,AgentPasswordService,AgentBinaryService
//
