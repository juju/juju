...
// Source: github.com/juju/juju/apiserver/common (interfaces: BlockCommandService,CloudService,ControllerConfigState,ControllerConfigService,ExternalControllerService,ToolsFinder,ToolsURLGetter,APIHostPortsForAgentsGetter,ModelAgentService,MachineRebootService,EnsureDeadMachineService,WatchableMachineService,UnitStateService,MachineService,StatusService,LeadershipPinningBackend,LeadershipMachine,PasswordService)
//
// Generated by this command:
//
//	mockgen -typed -package mocks -destination mocks/common_mock.go github.com/juju/juju/apiserver/common BlockCommandService,CloudService,ControllerConfigState,ControllerConfigService,ExternalControllerService,ToolsFinder,ToolsURLGetter,APIHostPortsForAgentsGetter,ModelAgentService,MachineRebootService,EnsureDeadMachineService,WatchableMachineService,UnitStateService,MachineService,StatusService,LeadershipPinningBackend,LeadershipMachine,PasswordService
//
...
// FindAgents mocks base method.
func (m *MockModelAgentService) FindAgents(arg0 context.Context, arg1 modelagent.FindAgentsParams) (tools.List, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindAgents", arg0, arg1)
	ret0, _ := ret[0].(tools.List)
	ret1, _ := ret[1].(error)
...
// FindAgents indicates an expected call of FindAgents.
func (mr *MockModelAgentServiceMockRecorder) FindAgents(arg0, arg1 any) *MockModelAgentServiceFindAgentsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAgents", reflect.TypeOf((*MockModelAgentService)(nil).FindAgents), arg0, arg1)
	return &MockModelAgentServiceFindAgentsCall{Call: call}
}

// MockModelAgentServiceFindAgentsCall wrap *gomock.Call
type MockModelAgentServiceFindAgentsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockModelAgentServiceFindAgentsCall) Return(arg0 tools.List, arg1 error) *MockModelAgentServiceFindAgentsCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelAgentServiceFindAgentsCall) Do(f func(context.Context, modelagent.FindAgentsParams) (tools.List, error)) *MockModelAgentServiceFindAgentsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelAgentServiceFindAgentsCall) DoAndReturn(f func(context.Context, modelagent.FindAgentsParams) (tools.List, error)) *MockModelAgentServiceFindAgentsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
