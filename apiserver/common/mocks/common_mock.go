...
// Source: github.com/juju/juju/apiserver/common (interfaces: BlockCommandService,CloudService,ControllerConfigState,ControllerConfigService,ExternalControllerService,ToolsFinder,ToolsFindEntity,ToolsURLGetter,APIHostPortsForAgentsGetter,ToolsStorageGetter,AgentTooler,ModelAgentService,MachineRebootService,EnsureDeadMachineService,WatchableMachineService,UnitStateService,MachineService,StatusService,LeadershipPinningBackend,LeadershipMachine,PasswordService)
//
// Generated by this command:
//
//	mockgen -typed -package mocks -destination mocks/common_mock.go github.com/juju/juju/apiserver/common BlockCommandService,CloudService,ControllerConfigState,ControllerConfigService,ExternalControllerService,ToolsFinder,ToolsFindEntity,ToolsURLGetter,APIHostPortsForAgentsGetter,ToolsStorageGetter,AgentTooler,ModelAgentService,MachineRebootService,EnsureDeadMachineService,WatchableMachineService,UnitStateService,MachineService,StatusService,LeadershipPinningBackend,LeadershipMachine,PasswordService
//
...
func (m *MockAgentTooler) SetAgentVersion(arg0 semversion.Binary) error {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockAgentToolerSetAgentVersionCall) Do(f func(semversion.Binary) error) *MockAgentToolerSetAgentVersionCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockAgentToolerSetAgentVersionCall) DoAndReturn(f func(semversion.Binary) error) *MockAgentToolerSetAgentVersionCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
