...
func (m *MockAgentBinaryService) FindAgentBinaryForVersion(arg0 context.Context, arg1 agentbinary0.Version) (agentbinary0.AgentBinary, error) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *MockAgentBinaryServiceFindAgentBinaryForVersionCall) Return(arg0 agentbinary0.AgentBinary, arg1 error) *MockAgentBinaryServiceFindAgentBinaryForVersionCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockAgentBinaryServiceFindAgentBinaryForVersionCall) Do(f func(context.Context, agentbinary0.Version) (agentbinary0.AgentBinary, error)) *MockAgentBinaryServiceFindAgentBinaryForVersionCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockAgentBinaryServiceFindAgentBinaryForVersionCall) DoAndReturn(f func(context.Context, agentbinary0.Version) (agentbinary0.AgentBinary, error)) *MockAgentBinaryServiceFindAgentBinaryForVersionCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
