...
func (m *MockAPIHostPortsForAgentsGetter) GetAllAPIAddressesWithScopeForAgents(arg0 context.Context) (controllernode.APIAddresses, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAPIHostPortsForAgentsGetterMockRecorder) GetAllAPIAddressesWithScopeForAgents(arg0 any) *MockAPIHostPortsForAgentsGetterGetAllAPIAddressesWithScopeForAgentsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllAPIAddressesWithScopeForAgents", reflect.TypeOf((*MockAPIHostPortsForAgentsGetter)(nil).GetAllAPIAddressesWithScopeForAgents), arg0)
	return &MockAPIHostPortsForAgentsGetterGetAllAPIAddressesWithScopeForAgentsCall{Call: call}
}

// MockAPIHostPortsForAgentsGetterGetAllAPIAddressesWithScopeForAgentsCall wrap *gomock.Call
type MockAPIHostPortsForAgentsGetterGetAllAPIAddressesWithScopeForAgentsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockAPIHostPortsForAgentsGetterGetAllAPIAddressesWithScopeForAgentsCall) Return(arg0 controllernode.APIAddresses, arg1 error) *MockAPIHostPortsForAgentsGetterGetAllAPIAddressesWithScopeForAgentsCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockAPIHostPortsForAgentsGetterGetAllAPIAddressesWithScopeForAgentsCall) Do(f func(context.Context) (controllernode.APIAddresses, error)) *MockAPIHostPortsForAgentsGetterGetAllAPIAddressesWithScopeForAgentsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockAPIHostPortsForAgentsGetterGetAllAPIAddressesWithScopeForAgentsCall) DoAndReturn(f func(context.Context) (controllernode.APIAddresses, error)) *MockAPIHostPortsForAgentsGetterGetAllAPIAddressesWithScopeForAgentsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
