...
func (mr *MockEnvironConfigGetterMockRecorder) CloudSpec(arg0 any) *gomock.Call {
...
func (mr *MockEnvironConfigGetterMockRecorder) ModelConfig(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
