...
// Source: github.com/juju/juju/apiserver/common (interfaces: ModelConfigService)
//
// Generated by this command:
//
//	mockgen -typed -package mocks -destination mocks/modelconfig_mock.go github.com/juju/juju/apiserver/common ModelConfigService
//
