...
//go:generate go run github.com/canonical/gomock/mockgen -package common -destination package_mocks_test.go github.com/juju/juju/apiserver/common APIAddressAccessor
...
//go:generate go run github.com/canonical/gomock/mockgen -package mocks -destination mocks/facade_mock.go github.com/juju/juju/apiserver/facade WatcherRegistry
