...
//go:generate go run github.com/canonical/gomock/mockgen -package common -destination package_mock.go github.com/juju/juju/apiserver/common APIAddressAccessor
