...
func registerWatchers(registry *facade.Registry) {
	...
	registry.MustRegister("VolumeAttachmentsWatcher", 2, newMachineStorageIdsWatcher, reflect.TypeOf((*srvMachineStorageIdsWatcher)(nil)))
	registry.MustRegister("VolumeAttachmentPlansWatcher", 1, newMachineStorageIdsWatcher, reflect.TypeOf((*srvMachineStorageIdsWatcher)(nil)))
	registry.MustRegister("FilesystemAttachmentsWatcher", 2, newMachineStorageIdsWatcher, reflect.TypeOf((*srvMachineStorageIdsWatcher)(nil)))
