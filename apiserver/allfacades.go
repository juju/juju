...
import (
	...
	"github.com/juju/juju/v3/apiserver/facades/agent/caasadmission"
	...
	"github.com/juju/juju/v3/apiserver/facades/agent/diskmanager"
	"github.com/juju/juju/v3/apiserver/facades/agent/fanconfigurer"
	"github.com/juju/juju/v3/apiserver/facades/agent/hostkeyreporter"
	...
	loggerapi "github.com/juju/juju/v3/apiserver/facades/agent/logger"
	"github.com/juju/juju/v3/apiserver/facades/agent/machine"
	...
	"github.com/juju/juju/v3/apiserver/facades/agent/payloadshookcontext"
	...
	"github.com/juju/juju/v3/apiserver/facades/agent/resourceshookcontext"
	"github.com/juju/juju/v3/apiserver/facades/agent/retrystrategy"
	"github.com/juju/juju/v3/apiserver/facades/agent/secretsmanager"
	"github.com/juju/juju/v3/apiserver/facades/agent/storageprovisioner"
	"github.com/juju/juju/v3/apiserver/facades/agent/unitassigner"
	...
	"github.com/juju/juju/v3/apiserver/facades/agent/upgradesteps"
	"github.com/juju/juju/v3/apiserver/facades/client/action"
	"github.com/juju/juju/v3/apiserver/facades/client/annotations" // ModelUser Write
	...
	"github.com/juju/juju/v3/apiserver/facades/client/backups" // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/block"   // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/bundle"
	"github.com/juju/juju/v3/apiserver/facades/client/charms"     // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/client"     // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/cloud"      // ModelUser Read
	"github.com/juju/juju/v3/apiserver/facades/client/controller" // ModelUser Admin (although some methods check for read only)
	"github.com/juju/juju/v3/apiserver/facades/client/credentialmanager"
	"github.com/juju/juju/v3/apiserver/facades/client/firewallrules"
	"github.com/juju/juju/v3/apiserver/facades/client/highavailability" // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/imagemanager"     // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/imagemetadatamanager"
	"github.com/juju/juju/v3/apiserver/facades/client/keymanager"     // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/machinemanager" // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/metricsdebug"   // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/modelconfig"    // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/modelgeneration"
	"github.com/juju/juju/v3/apiserver/facades/client/modelmanager" // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/payloads"
	"github.com/juju/juju/v3/apiserver/facades/client/resources"
	"github.com/juju/juju/v3/apiserver/facades/client/secrets"
	"github.com/juju/juju/v3/apiserver/facades/client/spaces"    // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/sshclient" // ModelUser Write
	"github.com/juju/juju/v3/apiserver/facades/client/storage"
	"github.com/juju/juju/v3/apiserver/facades/client/subnets"
	...
	"github.com/juju/juju/v3/apiserver/facades/controller/agenttools"
	"github.com/juju/juju/v3/apiserver/facades/controller/applicationscaler"
	...
	"github.com/juju/juju/v3/apiserver/facades/controller/charmdownloader"
	"github.com/juju/juju/v3/apiserver/facades/controller/charmrevisionupdater"
	"github.com/juju/juju/v3/apiserver/facades/controller/cleaner"
	...
	"github.com/juju/juju/v3/apiserver/facades/controller/environupgrader"
	"github.com/juju/juju/v3/apiserver/facades/controller/externalcontrollerupdater"
	...
	"github.com/juju/juju/v3/apiserver/facades/controller/lifeflag"
	...
	"github.com/juju/juju/v3/apiserver/facades/controller/migrationtarget"
	"github.com/juju/juju/v3/apiserver/facades/controller/raftlease"
	"github.com/juju/juju/v3/apiserver/facades/controller/remoterelations"
	"github.com/juju/juju/v3/apiserver/facades/controller/resumer"
	"github.com/juju/juju/v3/apiserver/facades/controller/singular"
