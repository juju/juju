...
//go:generate go run go.uber.org/mock/mockgen -typed -package apiserver -destination service_mock_test.go github.com/juju/juju/apiserver StatusService,RelationService
//go:generate go run go.uber.org/mock/mockgen -typed -package apiserver -destination offer_watcher_mock_test.go github.com/juju/juju/apiserver/facades/controller/crossmodelrelations OfferWatcher,RelationChangesWatcher
