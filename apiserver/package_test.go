...
//go:generate go run github.com/canonical/gomock/mockgen -package apiserver -destination service_mock_test.go github.com/juju/juju/apiserver RelationService,StatusService,ModelRedirectService,MigrationLogModelService,MigrationLogModeService
