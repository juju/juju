...
//go:generate go run go.uber.org/mock/mockgen -typed -package apiserver_test -destination resource_opener_mock_test.go github.com/juju/juju/core/resource Opener
//go:generate go run go.uber.org/mock/mockgen -typed -package apiserver -destination application_service_mock_test.go github.com/juju/juju/apiserver ApplicationServiceGetter,ApplicationService,StateGetter,ModelState,Model
//go:generate go run go.uber.org/mock/mockgen -typed -package apiserver -destination resource_service_mock_test.go github.com/juju/juju/apiserver ResourceServiceGetter,ResourceService
