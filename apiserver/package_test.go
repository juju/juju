...
//go:generate go run go.uber.org/mock/mockgen -typed -package apiserver -destination service_mock_test.go github.com/juju/juju/apiserver ApplicationServiceGetter,ApplicationService,StateGetter,ModelState,Model,ResourceServiceGetter,ResourceService
