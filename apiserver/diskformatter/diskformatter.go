...
// specified volumes.
func (a *DiskFormatterAPI) VolumePreparationInfo(args params.MachineAttachmentIds) (params.VolumePreparationInfoResults, error) {
	...
	one := func(id params.MachineAttachmentId) (params.VolumePreparationInfo, error) {
