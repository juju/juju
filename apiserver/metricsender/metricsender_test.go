...
// TestSendMetricsLimits creates 7 unsent metrics and
// checks that after a call 2 metrics remain unsent.
func (s *MetricSenderSuite) TestSendMetricsLimits(c *gc.C) {
	var sender testing.MockSender
	now := time.Now()
