...
// Source: github.com/juju/juju/apiserver/stateauthenticator (interfaces: ControllerConfigService,AccessService,MacaroonService,AgentAuthenticatorGetter,AgentPasswordServiceGetter,MachineService,MachineServiceGetter)
//
// Generated by this command:
//
//	mockgen -typed -package stateauthenticator -destination services_mock_test.go github.com/juju/juju/apiserver/stateauthenticator ControllerConfigService,AccessService,MacaroonService,AgentAuthenticatorGetter,AgentPasswordServiceGetter,MachineService,MachineServiceGetter
//
...
// MockMachineServiceGetter is a mock of MachineServiceGetter interface.
type MockMachineServiceGetter struct {
	ctrl     *gomock.Controller
	recorder *MockMachineServiceGetterMockRecorder
}

// MockMachineServiceGetterMockRecorder is the mock recorder for MockMachineServiceGetter.
type MockMachineServiceGetterMockRecorder struct {
	mock *MockMachineServiceGetter
}

// NewMockMachineServiceGetter creates a new mock instance.
func NewMockMachineServiceGetter(ctrl *gomock.Controller) *MockMachineServiceGetter {
	mock := &MockMachineServiceGetter{ctrl: ctrl}
	mock.recorder = &MockMachineServiceGetterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockMachineServiceGetter) EXPECT() *MockMachineServiceGetterMockRecorder {
	return m.recorder
}

// GetMachineServiceForModel mocks base method.
func (m *MockMachineServiceGetter) GetMachineServiceForModel(arg0 context.Context, arg1 model.UUID) (MachineService, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMachineServiceForModel", arg0, arg1)
	ret0, _ := ret[0].(MachineService)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetMachineServiceForModel indicates an expected call of GetMachineServiceForModel.
func (mr *MockMachineServiceGetterMockRecorder) GetMachineServiceForModel(arg0, arg1 any) *MockMachineServiceGetterGetMachineServiceForModelCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMachineServiceForModel", reflect.TypeOf((*MockMachineServiceGetter)(nil).GetMachineServiceForModel), arg0, arg1)
	return &MockMachineServiceGetterGetMachineServiceForModelCall{Call: call}
}

// MockMachineServiceGetterGetMachineServiceForModelCall wrap *gomock.Call
type MockMachineServiceGetterGetMachineServiceForModelCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockMachineServiceGetterGetMachineServiceForModelCall) Return(arg0 MachineService, arg1 error) *MockMachineServiceGetterGetMachineServiceForModelCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockMachineServiceGetterGetMachineServiceForModelCall) Do(f func(context.Context, model.UUID) (MachineService, error)) *MockMachineServiceGetterGetMachineServiceForModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockMachineServiceGetterGetMachineServiceForModelCall) DoAndReturn(f func(context.Context, model.UUID) (MachineService, error)) *MockMachineServiceGetterGetMachineServiceForModelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
