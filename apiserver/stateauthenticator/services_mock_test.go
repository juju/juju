...
// Source: github.com/juju/juju/apiserver/stateauthenticator (interfaces: ControllerConfigService,AccessService,MacaroonService,AgentAuthenticatorGetter,PasswordServiceGetter)
//
// Generated by this command:
//
//	mockgen -typed -package stateauthenticator -destination services_mock_test.go github.com/juju/juju/apiserver/stateauthenticator ControllerConfigService,AccessService,MacaroonService,AgentAuthenticatorGetter,PasswordServiceGetter
//
...
func (m *MockAgentAuthenticatorGetter) AuthenticatorForModel(arg0 authentication.PasswordService, arg1 *state.State) authentication.EntityAuthenticator {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockAgentAuthenticatorGetterAuthenticatorForModelCall) Do(f func(authentication.PasswordService, *state.State) authentication.EntityAuthenticator) *MockAgentAuthenticatorGetterAuthenticatorForModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockAgentAuthenticatorGetterAuthenticatorForModelCall) DoAndReturn(f func(authentication.PasswordService, *state.State) authentication.EntityAuthenticator) *MockAgentAuthenticatorGetterAuthenticatorForModelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// MockPasswordServiceGetter is a mock of PasswordServiceGetter interface.
type MockPasswordServiceGetter struct {
	ctrl     *gomock.Controller
	recorder *MockPasswordServiceGetterMockRecorder
}

// MockPasswordServiceGetterMockRecorder is the mock recorder for MockPasswordServiceGetter.
type MockPasswordServiceGetterMockRecorder struct {
	mock *MockPasswordServiceGetter
}

// NewMockPasswordServiceGetter creates a new mock instance.
func NewMockPasswordServiceGetter(ctrl *gomock.Controller) *MockPasswordServiceGetter {
	mock := &MockPasswordServiceGetter{ctrl: ctrl}
	mock.recorder = &MockPasswordServiceGetterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPasswordServiceGetter) EXPECT() *MockPasswordServiceGetterMockRecorder {
	return m.recorder
}

// GetPasswordServiceForModel mocks base method.
func (m *MockPasswordServiceGetter) GetPasswordServiceForModel(arg0 context.Context, arg1 model.UUID) (authentication.PasswordService, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPasswordServiceForModel", arg0, arg1)
	ret0, _ := ret[0].(authentication.PasswordService)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetPasswordServiceForModel indicates an expected call of GetPasswordServiceForModel.
func (mr *MockPasswordServiceGetterMockRecorder) GetPasswordServiceForModel(arg0, arg1 any) *MockPasswordServiceGetterGetPasswordServiceForModelCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPasswordServiceForModel", reflect.TypeOf((*MockPasswordServiceGetter)(nil).GetPasswordServiceForModel), arg0, arg1)
	return &MockPasswordServiceGetterGetPasswordServiceForModelCall{Call: call}
}

// MockPasswordServiceGetterGetPasswordServiceForModelCall wrap *gomock.Call
type MockPasswordServiceGetterGetPasswordServiceForModelCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockPasswordServiceGetterGetPasswordServiceForModelCall) Return(arg0 authentication.PasswordService, arg1 error) *MockPasswordServiceGetterGetPasswordServiceForModelCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockPasswordServiceGetterGetPasswordServiceForModelCall) Do(f func(context.Context, model.UUID) (authentication.PasswordService, error)) *MockPasswordServiceGetterGetPasswordServiceForModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockPasswordServiceGetterGetPasswordServiceForModelCall) DoAndReturn(f func(context.Context, model.UUID) (authentication.PasswordService, error)) *MockPasswordServiceGetterGetPasswordServiceForModelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
