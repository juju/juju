...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/respositories_mock.go github.com/juju/juju/resource/respositories ResourceGetter
