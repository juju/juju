...
// Source: github.com/juju/juju/resource (interfaces: EntityRepository,ResourceGetter)
...
import (
	...
	resource1 "github.com/juju/juju/resource"
...
// GetResource mocks base method.
func (m *MockResourceGetter) GetResource(arg0 resource1.ResourceRequest) (resource1.ResourceData, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetResource", arg0)
	ret0, _ := ret[0].(resource1.ResourceData)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
