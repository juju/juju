...
import (
	...
	caasfirewallerapi "github.com/juju/juju/v3/api/controller/caasfirewaller"
	caasunitprovisionerapi "github.com/juju/juju/v3/api/controller/caasunitprovisioner"
	...
	"github.com/juju/juju/v3/worker/actionpruner"
	"github.com/juju/juju/v3/worker/agent"
	...
	"github.com/juju/juju/v3/worker/caasapplicationprovisioner"
	"github.com/juju/juju/v3/worker/caasbroker"
	"github.com/juju/juju/v3/worker/caasenvironupgrader"
	"github.com/juju/juju/v3/worker/caasfirewaller"
	"github.com/juju/juju/v3/worker/caasfirewallersidecar"
	"github.com/juju/juju/v3/worker/caasmodelconfigmanager"
	"github.com/juju/juju/v3/worker/caasmodeloperator"
	"github.com/juju/juju/v3/worker/caasoperatorprovisioner"
	"github.com/juju/juju/v3/worker/caasunitprovisioner"
	"github.com/juju/juju/v3/worker/charmdownloader"
	"github.com/juju/juju/v3/worker/charmrevision"
	"github.com/juju/juju/v3/worker/cleaner"
	"github.com/juju/juju/v3/worker/common"
	"github.com/juju/juju/v3/worker/credentialvalidator"
	"github.com/juju/juju/v3/worker/environ"
	"github.com/juju/juju/v3/worker/environupgrader"
	...
	"github.com/juju/juju/v3/worker/instancepoller"
	"github.com/juju/juju/v3/worker/lifeflag"
	"github.com/juju/juju/v3/worker/logforwarder"
	"github.com/juju/juju/v3/worker/logforwarder/sinks"
	"github.com/juju/juju/v3/worker/logger"
	"github.com/juju/juju/v3/worker/machineundertaker"
	"github.com/juju/juju/v3/worker/metricworker"
	"github.com/juju/juju/v3/worker/migrationflag"
	"github.com/juju/juju/v3/worker/migrationmaster"
	"github.com/juju/juju/v3/worker/provisioner"
	"github.com/juju/juju/v3/worker/pruner"
	"github.com/juju/juju/v3/worker/remoterelations"
	...
	"github.com/juju/juju/v3/worker/unitassigner"
)
