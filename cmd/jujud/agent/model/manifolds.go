...
import (
	...
	caasfirewallerapi "github.com/juju/juju/v2/api/controller/caasfirewaller"
	caasunitprovisionerapi "github.com/juju/juju/v2/api/controller/caasunitprovisioner"
	...
	"github.com/juju/juju/v2/worker/actionpruner"
	"github.com/juju/juju/v2/worker/agent"
	"github.com/juju/juju/v2/worker/apicaller"
	"github.com/juju/juju/v2/worker/apiconfigwatcher"
	"github.com/juju/juju/v2/worker/applicationscaler"
	"github.com/juju/juju/v2/worker/caasapplicationprovisioner"
	"github.com/juju/juju/v2/worker/caasbroker"
	"github.com/juju/juju/v2/worker/caasenvironupgrader"
	"github.com/juju/juju/v2/worker/caasfirewaller"
	"github.com/juju/juju/v2/worker/caasfirewallersidecar"
	"github.com/juju/juju/v2/worker/caasmodelconfigmanager"
	"github.com/juju/juju/v2/worker/caasmodeloperator"
	"github.com/juju/juju/v2/worker/caasoperatorprovisioner"
	"github.com/juju/juju/v2/worker/caasunitprovisioner"
	"github.com/juju/juju/v2/worker/charmdownloader"
	"github.com/juju/juju/v2/worker/charmrevision"
	"github.com/juju/juju/v2/worker/cleaner"
	"github.com/juju/juju/v2/worker/common"
	"github.com/juju/juju/v2/worker/credentialvalidator"
	"github.com/juju/juju/v2/worker/environ"
	"github.com/juju/juju/v2/worker/environupgrader"
	"github.com/juju/juju/v2/worker/firewaller"
	"github.com/juju/juju/v2/worker/fortress"
	"github.com/juju/juju/v2/worker/gate"
	"github.com/juju/juju/v2/worker/instancemutater"
	"github.com/juju/juju/v2/worker/instancepoller"
	"github.com/juju/juju/v2/worker/lifeflag"
	"github.com/juju/juju/v2/worker/logforwarder"
	"github.com/juju/juju/v2/worker/logforwarder/sinks"
	"github.com/juju/juju/v2/worker/logger"
	"github.com/juju/juju/v2/worker/machineundertaker"
	"github.com/juju/juju/v2/worker/metricworker"
	"github.com/juju/juju/v2/worker/migrationflag"
	"github.com/juju/juju/v2/worker/migrationmaster"
	"github.com/juju/juju/v2/worker/provisioner"
	"github.com/juju/juju/v2/worker/pruner"
	"github.com/juju/juju/v2/worker/remoterelations"
	"github.com/juju/juju/v2/worker/singular"
	"github.com/juju/juju/v2/worker/statushistorypruner"
	"github.com/juju/juju/v2/worker/storageprovisioner"
	"github.com/juju/juju/v2/worker/undertaker"
	"github.com/juju/juju/v2/worker/unitassigner"
)
