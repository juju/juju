...
func (c *AddCloudCommand) SetFlags(f *gnuflag.FlagSet) {
	...
	f.BoolVar(&c.Force, "force", false, "Specifies whether to forcibly add cloud to the controller.")
	...
	f.StringVar(&c.credentialName, "credential", "", "Specifies the credential to use for new cloud.")
