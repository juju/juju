...
//
//	mockgen -package mocks -destination cmd/juju/charmhub/mocks/fsys_mock.go github.com/juju/juju/cmd/modelcmd Filesystem,ReadSeekCloser
//
...
type MockReadSeekCloserMockRecorder struct {
	...
	seekExpects  []*gomock.Call2_2[int64, int, int64, error]
}
...
func NewMockReadSeekCloser(ctrl *gomock.Controller) *MockReadSeekCloser {
	...
	mock.recorder = &MockReadSeekCloserMockRecorder{mock: mock}
	return mock
}
...
// MockReadSeekCloserCloseCall is the typed call wrapper for Close.
type MockReadSeekCloserCloseCall = gomock.Call0_1[error]
...
// MockReadSeekCloserReadCall is the typed call wrapper for Read.
type MockReadSeekCloserReadCall = gomock.Call1_2[[]byte, int, error]

// Seek mocks base method.
func (m *MockReadSeekCloser) Seek(offset int64, whence int) (int64, error) {
	m.ctrl.T.Helper()
	return gomock.Dispatch2_2(&m.recorder.seekExpects, m.ctrl, m, "Seek", offset, whence)
}

// Seek indicates an expected call of Seek.
func (mr *MockReadSeekCloserMockRecorder) Seek(offset, whence any) *MockReadSeekCloserSeekCall {
	mr.mock.ctrl.T.Helper()
	call := gomock.NewCall2_2[int64, int, int64, error](mr.mock.ctrl.T, mr.mock, "Seek", gomock.EnsureMatcher(offset), gomock.EnsureMatcher(whence))
	mr.seekExpects = append(mr.seekExpects, call)
	mr.mock.ctrl.Track(call.Call)
	return call
}

// MockReadSeekCloserSeekCall is the typed call wrapper for Seek.
type MockReadSeekCloserSeekCall = gomock.Call2_2[int64, int, int64, error]
