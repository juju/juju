...
type ListSuite struct {
	...
	services  []model.ListOffersResult
...
func (s *ListSuite) SetUpTest(c *gc.C) {
	...
	s.services = []model.ListOffersResult{
		{Result: s.createServiceItem("hosted-db2", "local", 0)},
	}

	s.mockAPI = &mockListAPI{
		list: func(filters ...model.ListOffersFilter) ([]model.ListOffersResult, error) {
...
func (s *ListSuite) TestListError(c *gc.C) {
	...
	s.mockAPI.list = func(filters ...model.ListOffersFilter) ([]model.ListOffersResult, error) {
...
func (s *ListSuite) TestListFormatError(c *gc.C) {
	s.services = append(s.services, model.ListOffersResult{Result: s.createServiceItem("zdi^%", "different_store", 33)})
...
func (s *ListSuite) TestListDirectories(c *gc.C) {
	...
	s.services = append(s.services, model.ListOffersResult{Result: s.createServiceItem("zdiff-db2", "differentstore", 33)})
	s.services = append(s.services, model.ListOffersResult{Result: s.createServiceItem("adiff-db2", "vendor", 23)})
...
func (s *ListSuite) TestListWithErrors(c *gc.C) {
	...
	s.services = append(s.services, model.ListOffersResult{Error: errors.New(msg)})
...
func (s mockListAPI) ListOffers(filters ...model.ListOffersFilter) ([]model.ListOffersResult, error) {
