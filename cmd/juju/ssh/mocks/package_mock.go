...
//
//	mockgen -package mocks -destination mocks/package_mock.go github.com/juju/juju/cmd/juju/ssh Context,LeaderAPI,SSHClientAPI,SSHAPIJump,SSHControllerAPI,CloudCredentialAPI,ApplicationAPI,CharmsAPI,ModelCommand
//
...
// Close indicates an expected call of Close.
func (mr *MockSSHAPIJumpMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockSSHAPIJump)(nil).Close))
}
...
func (mr *MockSSHAPIJumpMockRecorder) PublicHostKeyForTarget(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PublicHostKeyForTarget", reflect.TypeOf((*MockSSHAPIJump)(nil).PublicHostKeyForTarget), arg0)
}
...
func (mr *MockSSHAPIJumpMockRecorder) VirtualHostname(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VirtualHostname", reflect.TypeOf((*MockSSHAPIJump)(nil).VirtualHostname), arg0, arg1)
}
