...
// Source: github.com/juju/juju/cmd/juju/ssh (interfaces: Context,LeaderAPI,SSHClientAPI,SSHAPIClientJump,SSHControllerAPI,CloudCredentialAPI,ApplicationAPI,CharmsAPI,ModelCommand)
//
// Generated by this command:
//
//	mockgen -package mocks -destination mocks/package_mock.go github.com/juju/juju/cmd/juju/ssh Context,LeaderAPI,SSHClientAPI,SSHAPIClientJump,SSHControllerAPI,CloudCredentialAPI,ApplicationAPI,CharmsAPI,ModelCommand
//
...
// MockSSHAPIClientJump is a mock of SSHAPIClientJump interface.
type MockSSHAPIClientJump struct {
	ctrl     *gomock.Controller
	recorder *MockSSHAPIClientJumpMockRecorder
}

// MockSSHAPIClientJumpMockRecorder is the mock recorder for MockSSHAPIClientJump.
type MockSSHAPIClientJumpMockRecorder struct {
	mock *MockSSHAPIClientJump
}

// NewMockSSHAPIClientJump creates a new mock instance.
func NewMockSSHAPIClientJump(ctrl *gomock.Controller) *MockSSHAPIClientJump {
	mock := &MockSSHAPIClientJump{ctrl: ctrl}
	mock.recorder = &MockSSHAPIClientJumpMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSSHAPIClientJump) EXPECT() *MockSSHAPIClientJumpMockRecorder {
	return m.recorder
}

// Close mocks base method.
func (m *MockSSHAPIClientJump) Close() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Close")
	ret0, _ := ret[0].(error)
	return ret0
...
// Close indicates an expected call of Close.
func (mr *MockSSHAPIClientJumpMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockSSHAPIClientJump)(nil).Close))
}

// PublicHostKeyForTarget mocks base method.
func (m *MockSSHAPIClientJump) PublicHostKeyForTarget(arg0 string) (params.PublicSSHHostKeyResult, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSSHAPIClientJumpMockRecorder) PublicHostKeyForTarget(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PublicHostKeyForTarget", reflect.TypeOf((*MockSSHAPIClientJump)(nil).PublicHostKeyForTarget), arg0)
}

// VirtualHostname mocks base method.
func (m *MockSSHAPIClientJump) VirtualHostname(arg0 string, arg1 *string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSSHAPIClientJumpMockRecorder) VirtualHostname(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VirtualHostname", reflect.TypeOf((*MockSSHAPIClientJump)(nil).VirtualHostname), arg0, arg1)
}
