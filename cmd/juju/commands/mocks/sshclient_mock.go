...
//
//	mockgen -package mocks -destination mocks/sshclient_mock.go github.com/juju/juju/cmd/juju/commands SSHClientAPI
//
...
func (mr *MockSSHClientAPIMockRecorder) Leader(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
