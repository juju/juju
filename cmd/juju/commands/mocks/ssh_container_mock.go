...
//
//	mockgen -package mocks -destination mocks/ssh_container_mock.go github.com/juju/juju/cmd/juju/commands CloudCredentialAPI,ApplicationAPI,ModelAPI,CharmsAPI,ModelCommand,SSHControllerAPI
//
...
func (mr *MockModelAPIMockRecorder) ModelInfo(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
