...
// Source: github.com/juju/juju/cmd/juju/commands (interfaces: APIServer,Registry)
...
func (mr *MockAPIServerMockRecorder) Close() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockAPIServer)(nil).Close))
}
