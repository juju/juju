...
var upgradeJujuTests = []upgradeTest{{
	...
	expectUploaded: []string{"2.2.0.1-ubuntu-amd64", "2.2.0.1-ubuntu-amd64", "2.2.0.1-xenial-amd64"},
}, {
	...
	expectUploaded: []string{"2.7.3.1-ubuntu-amd64", "2.7.3.1-ubuntu-amd64", "2.7.3.1-xenial-amd64"},
}, {
	...
	expectUploaded: []string{"2.1.0.1-ubuntu-amd64", "2.1.0.1-ubuntu-amd64", "2.1.0.1-xenial-amd64"},
}, {
	...
	expectUploaded: []string{"2.4.6.1-ubuntu-amd64", "2.4.6.1-ubuntu-amd64", "2.4.6.1-xenial-amd64"},
}, {
	about:          "upload re-bumps version when necessary",
	available:      []string{"2.4.6-ubuntu-amd64", "2.4.6.2-saucy-i386", "2.4.8-ubuntu-amd64"},
	currentVersion: "2.4.6-ubuntu-amd64",
	agentVersion:   "2.4.6.2",
	args:           []string{"--build-agent"},
	expectVersion:  "2.4.6.3",
	expectUploaded: []string{"2.4.6.3-ubuntu-amd64", "2.4.6.3-ubuntu-amd64", "2.4.6.3-xenial-amd64"},
}, {
	...
	expectUploaded: []string{"2.7.3.2-ubuntu-amd64", "2.7.3.2-ubuntu-amd64", "2.7.3.2-xenial-amd64"},
}, {
...
func (s *UpgradeBaseSuite) TestFormatVersions(c *gc.C) {
	...
	for i, t := range []struct {
		...
		},
		{
			...
			versions: []string{"1.21.3-ubuntu-amd64", "1.21.3-xenial-amd64"},
			expected: "    1.21.3",
		},
		{
