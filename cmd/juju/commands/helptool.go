...
type dummyHookContext struct{ hooks.Context }
...
func (dummyHookContext) HookRelation() (hooks.ContextRelation, error) {
...
func (dummyHookContext) Relation(id int) (hooks.ContextRelation, error) {
...
func (dummyHookContext) RequestReboot(prio hooks.RebootPriority) error {
	return nil
}
...
func (dummyHookContext) HookStorage() (hooks.ContextStorageAttachment, error) {
...
func (dummyHookContext) UnitStatus() (*hooks.StatusInfo, error) {
	return &hooks.StatusInfo{}, nil
}

func (dummyHookContext) SetStatus(hooks.StatusInfo) error {
	return nil
}

func (dummyHookContext) Component(name string) (hooks.ContextComponent, error) {
	return nil, nil
}
