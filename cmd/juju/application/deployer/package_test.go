...
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination mocks/store_mock.go github.com/juju/juju/cmd/juju/application/store CharmrepoForDeploy,MacaroonGetter
