...
//
//	mockgen -typed -package mocks -destination mocks/deployer_mock.go github.com/juju/juju/cmd/juju/application/deployer ModelCommand,ConsumeDetails,ModelConfigGetter
//
...
func (mr *MockModelConfigGetterMockRecorder) ModelGet() *MockModelConfigGetterModelGetCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ModelGet", reflect.TypeOf((*MockModelConfigGetter)(nil).ModelGet))
	return &MockModelConfigGetterModelGetCall{Call: call}
}

// MockModelConfigGetterModelGetCall wrap *gomock.Call
type MockModelConfigGetterModelGetCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockModelConfigGetterModelGetCall) Return(arg0 map[string]any, arg1 error) *MockModelConfigGetterModelGetCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockModelConfigGetterModelGetCall) Do(f func() (map[string]any, error)) *MockModelConfigGetterModelGetCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockModelConfigGetterModelGetCall) DoAndReturn(f func() (map[string]any, error)) *MockModelConfigGetterModelGetCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
