...
func (sa *StubAPI) MoveToSpace(name string, subnetIds []string, force bool) ([]network.MovedSpace, error) {
	sa.MethodCall(sa, "MoveToSpace", name, subnetIds)
	return nil, sa.NextErr()
}
