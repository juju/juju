...
//go:generate go run github.com/canonical/gomock/mockgen -package common -destination credentialstore_mock_test.go github.com/juju/juju/api/jujuclient CredentialStore
...
//go:generate go run github.com/canonical/gomock/mockgen -package common -destination cloudprovider_mock_test.go github.com/juju/juju/cmd/juju/common TestCloudProvider
