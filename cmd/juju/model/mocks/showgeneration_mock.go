...
func (m *MockShowGenerationCommandAPI) GenerationInfo(arg0, arg1 string, arg2 func(time.Time) string) (map[string]model.Generation, error) {
...
func (mr *MockShowGenerationCommandAPIMockRecorder) GenerationInfo(arg0, arg1, arg2 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenerationInfo", reflect.TypeOf((*MockShowGenerationCommandAPI)(nil).GenerationInfo), arg0, arg1, arg2)
}
