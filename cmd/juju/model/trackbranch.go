...
//
//go:generate go run go.uber.org/mock/mockgen -typed -package mocks -destination ./mocks/trackbranch_mock.go github.com/juju/juju/cmd/juju/model TrackBranchCommandAPI
