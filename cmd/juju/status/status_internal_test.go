			...
			output: M{
				...
				"applications": M{
					...
					"varnish": M{
						...
						"endpoint-bindings": M{
							"":         network.DefaultSpaceName,
							"webcache": network.DefaultSpaceName,
						},
						"relations": M{
							"webcache": L{"project"},
						},
			...
			output: M{
				...
				"applications": M{
					"riak": M{
						...
						"endpoint-bindings": M{
							"":         network.DefaultSpaceName,
							"admin":    network.DefaultSpaceName,
							"endpoint": network.DefaultSpaceName,
							"ring":     network.DefaultSpaceName,
						},
						"relations": M{
							"ring": L{"riak"},
						},
			...
			output: M{
				...
				"applications": M{
					"lxd-profile": lxdProfileCharm(M{
						...
						"endpoint-bindings": M{
							"":        network.DefaultSpaceName,
							"another": network.DefaultSpaceName,
							"ubuntu":  network.DefaultSpaceName,
						},
					}),
				},
				"storage": M{},
