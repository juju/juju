...
// Source: github.com/juju/juju/cmd/juju/secretbackends (interfaces: ListSecretBackendsAPI,AddSecretBackendsAPI,RemoveSecretBackendsAPI)
...
func (m *MockAddSecretBackendsAPI) AddSecretBackend(arg0 secretbackends.SecretBackend) error {
	m.ctrl.T.Helper()
