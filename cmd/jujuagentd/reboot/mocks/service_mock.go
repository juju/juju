...
//
//	mockgen -typed -package mocks -destination mocks/service_mock.go github.com/juju/juju/cmd/jujuagentd/reboot AgentConfig,Manager,Model,RebootWaiter,Service
//
