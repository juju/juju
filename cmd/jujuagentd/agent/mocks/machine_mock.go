...
// Source: github.com/juju/juju/cmd/jujuagentd/agent (interfaces: CommandRunner)
//
// Generated by this command:
//
//	mockgen -typed -package mocks -destination mocks/machine_mock.go github.com/juju/juju/cmd/jujuagentd/agent CommandRunner
//
