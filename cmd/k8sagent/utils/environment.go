...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/environment_mock.go github.com/juju/juju/cmd/k8sagent/utils Environment
