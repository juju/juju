...
generate-tools creates simplestreams agents metadata.

This command works by scanning a directory for agents tarballs from which to generate
simplestreams agents metadata. The working directory is specified using the -d argument
...
containing agents tarballs, and is where the resulting metadata is written.
...
metadata for agents in the "released" stream is generated by scanning for agent tarballs
in the "releases" directory. By specifying a stream explcitly, agents tarballs are
...
func (c *toolsMetadataCommand) Info() *cmd.Info {
	return &cmd.Info{
		Name:    "generate-tools",
		Purpose: "generate simplestreams agents metadata",
