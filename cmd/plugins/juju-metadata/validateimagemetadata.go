...
the usual way from either $JUJU_DATA/environments.yaml or if it is not defined it 
will try $XDG_DATA_HOME/juju/environments.yaml or if that is not defined either
