...
func (m *MockTestCloudProvider) DetectCredentials() (*cloud.CloudCredential, error) {
...
func (mr *MockTestCloudProviderMockRecorder) DetectCredentials() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DetectCredentials", reflect.TypeOf((*MockTestCloudProvider)(nil).DetectCredentials))
}
