...
func (a *MachineAgent) Run(ctx *cmd.Context) (err error) {
	...
	if err := introspection.WriteProfileFunctions(ctx, introspection.ProfileDir); err != nil {
...
func (a *MachineAgent) startModelWorkers(ctx context.Context, cfg modelworkermanager.NewModelConfig) (worker.Worker, error) {
