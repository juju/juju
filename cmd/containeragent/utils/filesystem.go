...
//go:generate go run github.com/canonical/gomock/mockgen -package mocks -destination mocks/file_mock.go github.com/juju/juju/cmd/containeragent/utils FileReaderWriter
