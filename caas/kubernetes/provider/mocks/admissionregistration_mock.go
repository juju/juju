...
func (m *MockMutatingWebhookConfigurationInterface) Create(arg0 *v1.MutatingWebhookConfiguration) (*v1.MutatingWebhookConfiguration, error) {
...
func (m *MockMutatingWebhookConfigurationInterface) Delete(arg0 string, arg1 *v10.DeleteOptions) error {
...
func (m *MockMutatingWebhookConfigurationInterface) DeleteCollection(arg0 *v10.DeleteOptions, arg1 v10.ListOptions) error {
...
func (m *MockMutatingWebhookConfigurationInterface) Get(arg0 string, arg1 v10.GetOptions) (*v1.MutatingWebhookConfiguration, error) {
...
func (m *MockMutatingWebhookConfigurationInterface) List(arg0 v10.ListOptions) (*v1.MutatingWebhookConfigurationList, error) {
...
func (m *MockMutatingWebhookConfigurationInterface) Patch(arg0 string, arg1 types.PatchType, arg2 []byte, arg3 ...string) (*v1.MutatingWebhookConfiguration, error) {
...
func (m *MockMutatingWebhookConfigurationInterface) Update(arg0 *v1.MutatingWebhookConfiguration) (*v1.MutatingWebhookConfiguration, error) {
...
func (m *MockMutatingWebhookConfigurationInterface) Watch(arg0 v10.ListOptions) (watch.Interface, error) {
...
// Create mocks base method
func (m *MockValidatingWebhookConfigurationInterface) Create(arg0 *v1.ValidatingWebhookConfiguration) (*v1.ValidatingWebhookConfiguration, error) {
	ret := m.ctrl.Call(m, "Create", arg0)
...
// Delete mocks base method
func (m *MockValidatingWebhookConfigurationInterface) Delete(arg0 string, arg1 *v10.DeleteOptions) error {
	ret := m.ctrl.Call(m, "Delete", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// DeleteCollection mocks base method
func (m *MockValidatingWebhookConfigurationInterface) DeleteCollection(arg0 *v10.DeleteOptions, arg1 v10.ListOptions) error {
	ret := m.ctrl.Call(m, "DeleteCollection", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}
...
// Get mocks base method
func (m *MockValidatingWebhookConfigurationInterface) Get(arg0 string, arg1 v10.GetOptions) (*v1.ValidatingWebhookConfiguration, error) {
	ret := m.ctrl.Call(m, "Get", arg0, arg1)
	ret0, _ := ret[0].(*v1.ValidatingWebhookConfiguration)
	ret1, _ := ret[1].(error)
	return ret0, ret1
...
// List mocks base method
func (m *MockValidatingWebhookConfigurationInterface) List(arg0 v10.ListOptions) (*v1.ValidatingWebhookConfigurationList, error) {
	ret := m.ctrl.Call(m, "List", arg0)
...
// Patch mocks base method
func (m *MockValidatingWebhookConfigurationInterface) Patch(arg0 string, arg1 types.PatchType, arg2 []byte, arg3 ...string) (*v1.ValidatingWebhookConfiguration, error) {
	varargs := []interface{}{arg0, arg1, arg2}
	for _, a := range arg3 {
		varargs = append(varargs, a)
	}
...
// Update mocks base method
func (m *MockValidatingWebhookConfigurationInterface) Update(arg0 *v1.ValidatingWebhookConfiguration) (*v1.ValidatingWebhookConfiguration, error) {
	ret := m.ctrl.Call(m, "Update", arg0)
	ret0, _ := ret[0].(*v1.ValidatingWebhookConfiguration)
	ret1, _ := ret[1].(error)
	return ret0, ret1
...
// Watch mocks base method
func (m *MockValidatingWebhookConfigurationInterface) Watch(arg0 v10.ListOptions) (watch.Interface, error) {
	ret := m.ctrl.Call(m, "Watch", arg0)
	ret0, _ := ret[0].(watch.Interface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
