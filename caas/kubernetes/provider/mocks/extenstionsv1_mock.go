...
// Source: k8s.io/client-go/kubernetes/typed/extensions/v1beta1 (interfaces: ExtensionsV1beta1Interface,DeploymentInterface,IngressInterface)
...
func (m *MockDeploymentInterface) Create(arg0 *v1beta1.Deployment) (*v1beta1.Deployment, error) {
...
func (m *MockDeploymentInterface) Delete(arg0 string, arg1 *v1.DeleteOptions) error {
...
func (m *MockDeploymentInterface) DeleteCollection(arg0 *v1.DeleteOptions, arg1 v1.ListOptions) error {
...
func (m *MockDeploymentInterface) Get(arg0 string, arg1 v1.GetOptions) (*v1beta1.Deployment, error) {
...
func (m *MockDeploymentInterface) GetScale(arg0 string, arg1 v1.GetOptions) (*v1beta1.Scale, error) {
	ret := m.ctrl.Call(m, "GetScale", arg0, arg1)
	ret0, _ := ret[0].(*v1beta1.Scale)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDeploymentInterface) List(arg0 v1.ListOptions) (*v1beta1.DeploymentList, error) {
...
func (m *MockDeploymentInterface) Patch(arg0 string, arg1 types.PatchType, arg2 []byte, arg3 ...string) (*v1beta1.Deployment, error) {
...
func (m *MockDeploymentInterface) Rollback(arg0 *v1beta1.DeploymentRollback) error {
...
func (mr *MockDeploymentInterfaceMockRecorder) Rollback(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Rollback", reflect.TypeOf((*MockDeploymentInterface)(nil).Rollback), arg0)
}

// Update mocks base method
func (m *MockDeploymentInterface) Update(arg0 *v1beta1.Deployment) (*v1beta1.Deployment, error) {
...
func (m *MockDeploymentInterface) UpdateScale(arg0 string, arg1 *v1beta1.Scale) (*v1beta1.Scale, error) {
...
func (m *MockDeploymentInterface) UpdateStatus(arg0 *v1beta1.Deployment) (*v1beta1.Deployment, error) {
...
func (m *MockDeploymentInterface) Watch(arg0 v1.ListOptions) (watch.Interface, error) {
